...
thumbnail: 'http://www.kfzimg.com/sw/kfzimg/2646/022d3a5f5ed60572d5_n.jpg'
---
...
<div class="base-info">
            ...
            <!--标题-->
            <div class="title-box">
              <h1 class="title" itemprop="name" itemname="晚窗偷读：大家文库--良友书坊">
                                晚窗偷读：大家文库--良友书坊              </h1>
              
            </div>

            <!--重要描述-->
                          <p class="describe" itemprop="reviewBody">没有划线</p>
            
            <!--锁定著录项-->
                          <p class="keywords-lock" itemprop="author">
                流沙河 / 青岛出版社 / 2009-07 / 精装              </p>
        ...
        <p class="now-price clearfix">
            ...
            <span class="now-price-text-cont clearfix" itemprop="price" price="46.00">
        ...
        <!-- 价格 -->
                ...
                <span class="origin-price-text clearfix  ">￥42.00 </span>
            </p>
...
<div class="price-group2 br-t1">
    <p class="promotion">
        ...
        <a class="exp-discount-txt" href="http://book.kongfz.com/238901/2589268421/undefined"></a>
        </span>
    </p>
</div>
...
<div class="carry" id="carry-box">
    ...
    <ul>
        ...
        <li class="vacation-reason"></li>
                              ...
                              <img src="http://www.kfzimg.com/sw/kfzimg/2646/022d3a5f5ed60572d5_n.jpg" referrerpolicy="no-referrer">  
</div>
