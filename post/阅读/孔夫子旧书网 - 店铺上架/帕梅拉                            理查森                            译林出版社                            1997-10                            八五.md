...
thumbnail: 'http://www.kfzimg.com/sw/kfzimg/1195/daf52a5a9c7aa35c_n.jpg'
---
...
<div class="base-info">
            ...
            <!--标题-->
            <div class="title-box">
              <h1 class="title" itemprop="name" itemname="帕梅拉">
                                帕梅拉              </h1>
              
            </div>

            <!--重要描述-->
                          <p class="describe" itemprop="reviewBody">内页干净</p>
            
            <!--锁定著录项-->
                          <p class="keywords-lock" itemprop="author">
                理查森 / 译林出版社 / 1997-10 / 平装              </p>
        ...
        <p class="now-price clearfix">
            ...
            <span class="now-price-text-cont clearfix" itemprop="price" price="3.00">
                    ...
                    3.00                </i>
                                            <i class="now-price-discount">2.1折</i>
                                </span>
        </p>
        ...
        <!-- 价格 -->
                ...
                <span class="origin-price-text clearfix  ">￥14.50 </span>
            </p>
...
<div class="price-group2 br-t1">
    <p class="promotion">
        ...
        <a class="exp-discount-txt" href="http://book.kongfz.com/238901/1884734500/undefined"></a>
        </span>
    </p>
</div>
...
<div class="carry" id="carry-box">
    ...
    <ul>
        ...
        <li class="vacation-reason"></li>
                              ...
                              <img src="http://www.kfzimg.com/sw/kfzimg/1195/daf52a5a9c7aa35c_n.jpg" referrerpolicy="no-referrer">  
</div>
