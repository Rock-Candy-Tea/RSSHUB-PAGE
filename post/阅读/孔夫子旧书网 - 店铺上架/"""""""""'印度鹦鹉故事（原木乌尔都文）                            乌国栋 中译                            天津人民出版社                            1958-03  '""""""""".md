...
thumbnail: 'http://www.kfzimg.com/G07/M00/1E/02/q4YBAFxTvj2AYBSKAALd4-BRqfQ252_n.jpg'
---
...
<div class="base-info">
            ...
            <!--标题-->
            <div class="title-box">
              <h1 class="title" itemprop="name" itemname="印度鹦鹉故事（原木乌尔都文）">
                                印度鹦鹉故事（原木乌尔都文）              </h1>
              
            </div>

            <!--重要描述-->
                          <p class="describe" itemprop="reviewBody">大缺本 品相好</p>
    ...
    <div class="keywords-define keywords-define-1000 clear-fix">
                        ...
                        <span class="keywords-define-txt" itemprop="author"> 乌国栋 中译</span>
                    </li>
                                    <li>
                        <span class="keywords-define-title">出版社: </span>
                        <span class="keywords-define-txt" itemprop="publisher"> 天津人民出版社</span>
                    </li>
                            </ul>
                        ...
                        <span class="keywords-define-txt" itemprop="datePublished"> 1958-03</span>
                    </li>
                                    <li>
                        <span class="keywords-define-title">装帧: </span>
                        <span class="keywords-define-txt" itempro="bookFormat"> 平装</span>
                    </li>
                            </ul>
            </div>
    ...
    <div class="keywords-define keywords-define-1200  clear-fix">
        ...
        <p class="now-price clearfix">
            ...
            <span class="now-price-text-cont clearfix" itemprop="price" price="380.00">
...
<div class="price-group2 br-t1">
    <p class="promotion">
        ...
        <a class="exp-discount-txt" href="http://book.kongfz.com/238901/1885926133/undefined"></a>
        </span>
    </p>
</div>
...
<div class="carry" id="carry-box">
    ...
    <ul>
        ...
        <li class="vacation-reason"></li>
                              ...
                              <img src="http://www.kfzimg.com/G07/M00/1E/02/q4YBAFxTvj2AYBSKAALd4-BRqfQ252_n.jpg" referrerpolicy="no-referrer">  
</div>
