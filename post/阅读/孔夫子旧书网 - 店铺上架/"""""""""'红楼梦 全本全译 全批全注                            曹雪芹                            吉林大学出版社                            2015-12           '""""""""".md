...
thumbnail: 'http://www.kfzimg.com/sw/kfzimg/1833/01673b560afb5d6774_n.jpg'
---
...
<div class="base-info">
            ...
            <!--标题-->
            <div class="title-box">
              <h1 class="title" itemprop="name" itemname="红楼梦 全本全译 全批全注">
                                红楼梦 全本全译 全批全注              </h1>
    ...
    <div class="keywords-define keywords-define-1000 clear-fix">
                        ...
                        <span class="keywords-define-txt" itemprop="author"> 曹雪芹</span>
                    </li>
                                    <li>
                        <span class="keywords-define-title">出版社: </span>
                        <span class="keywords-define-txt" itemprop="publisher"> 吉林大学出版社</span>
                    </li>
                            </ul>
                        ...
                        <span class="keywords-define-txt" itemprop="datePublished"> 2015-12</span>
                    </li>
                                    <li>
                        <span class="keywords-define-title">装帧: </span>
                        <span class="keywords-define-txt" itempro="bookFormat"> 软精装</span>
                    </li>
                            </ul>
            </div>
    ...
    <div class="keywords-define keywords-define-1200  clear-fix">
        ...
        <p class="now-price clearfix">
            ...
            <span class="now-price-text-cont clearfix" itemprop="price" price="150.00">
...
<div class="price-group2 br-t1">
    <p class="promotion">
        ...
        <a class="exp-discount-txt" href="http://book.kongfz.com/238901/2322118318/undefined"></a>
        </span>
    </p>
</div>
...
<div class="carry" id="carry-box">
    ...
    <div class="carry-cont">
        ...
        <div class="express-wrapper"></div>
            ...
            <!--上书时间-->
            <p class="up-book-date-onsale"><span class="up-book-date-title">上书时间</span><span class="up-book-date-time">2020-08-28</span> </p>
    ...
    <ul>
        ...
        <li class="vacation-reason"></li>
                              ...
                              <img src="http://www.kfzimg.com/sw/kfzimg/1833/01673b560afb5d6774_n.jpg" referrerpolicy="no-referrer">  
</div>
