...
thumbnail: 'http://www.kfzimg.com/sw/kfzimg/3002/028b92e5122c91a2b0_n.jpg'
---
...
<div class="base-info">
            ...
            <!--标题-->
            <div class="title-box">
              <h1 class="title" itemprop="name" itemname="艳阳天 全三卷">
                                艳阳天 全三卷              </h1>
    ...
    <div class="keywords-define keywords-define-1000 clear-fix">
                        ...
                        <span class="keywords-define-txt" itemprop="author"> 浩然</span>
                    </li>
                                    <li>
                        <span class="keywords-define-title">出版社: </span>
                        <span class="keywords-define-txt" itemprop="publisher"> 人民文学出版社</span>
                    </li>
                            </ul>
                        ...
                        <span class="keywords-define-txt" itemprop="datePublished"> 1974-06</span>
                    </li>
                                    <li>
    ...
    <div class="keywords-define keywords-define-1200  clear-fix">
        ...
        <p class="now-price clearfix">
            ...
            <span class="now-price-text-cont clearfix" itemprop="price" price="140.00">
...
<div class="price-group2 br-t1">
    <p class="promotion">
        ...
        <a class="exp-discount-txt" href="http://book.kongfz.com/238901/2803900275/undefined"></a>
        </span>
    </p>
</div>
...
<div class="carry" id="carry-box">
    ...
    <div class="carry-cont">
        ...
        <div class="express-wrapper"></div>
            ...
            <!--上书时间-->
            <p class="up-book-date-onsale"><span class="up-book-date-title">上书时间</span><span class="up-book-date-time">2021-02-25</span> </p>
    ...
    <ul>
        ...
        <li class="vacation-reason"></li>
                              ...
                              <img src="http://www.kfzimg.com/sw/kfzimg/3002/028b92e5122c91a2b0_n.jpg" referrerpolicy="no-referrer">  
</div>
