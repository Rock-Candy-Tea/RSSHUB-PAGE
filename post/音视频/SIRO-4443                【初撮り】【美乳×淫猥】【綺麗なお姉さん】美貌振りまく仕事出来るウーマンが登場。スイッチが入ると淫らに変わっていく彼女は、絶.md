...
<div class="panel-block">
  ...
  <div class="panel-block">
    <strong>評分:</strong>
     <span class="value"><span class="score-stars"><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star gray"></i><i class="icon-star gray"></i></span> 3.67分, 由8人評價</span>
  </div>
  <div class="panel-block">
    <strong>類別:</strong>
