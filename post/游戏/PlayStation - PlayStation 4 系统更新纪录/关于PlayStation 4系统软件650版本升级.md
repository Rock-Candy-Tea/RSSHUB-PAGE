...
---
title: '关于PlayStation 4系统软件6.50版本升级'
categories: 
    - 游戏
...
<span class="font12 sub-text-grey">2019年03月07日</span>
...
<div><p>自2019年3月7日起，将开始提供系统软件6.50版本的升级。</p>
...
<div><ul>
<li>您现在可以在iOS设备上享受遥控操作。您可以使用 <img src="https://asia.playstation.com/content/dam/pscom/regional-assets/regional-elements/region-icons/system-update/remote-play.png" style="margin-top: 0px;" alt=" " referrerpolicy="no-referrer"> (PS4 Remote Play)将智能手机与平板电脑等连接至您的PS4主机。在App Store中下载 <img src="https://asia.playstation.com/content/dam/pscom/regional-assets/regional-elements/region-icons/system-update/remote-play.png" alt=" " style="margin-top: 0px;" referrerpolicy="no-referrer"> (PS4 Remote Play)。</li>
</ul>
</div>
...
<div><ul>
<li>您现在可以通过变更按键配置，从 <img src="https://asia.playstation.com/content/dam/pscom/regional-assets/regional-elements/region-icons/system-update/circle.png" style="margin-top: 0px;" alt="圆圈" referrerpolicy="no-referrer"> 键改为使用 <img src="https://asia.playstation.com/content/dam/pscom/regional-assets/regional-elements/region-icons/system-update/cross.png" style="margin-top: 0px;" alt="交叉" referrerpolicy="no-referrer"> 键进行“确认”操作。请选择 <img src="https://asia.playstation.com/content/dam/pscom/regional-assets/regional-elements/region-icons/system-update/settings.png" style="margin-top: 0px;" alt=" " referrerpolicy="no-referrer">（设定）> [系统]，再勾选[将 <img src="https://asia.playstation.com/content/dam/pscom/regional-assets/regional-elements/region-icons/system-update/cross.png" style="margin-top: 0px;" alt="交叉" referrerpolicy="no-referrer"> 键用于确定]。此选项仅限某些国家和地区使用。</li>
</ul>
</div>
...
<div class="mrg1-top ">
    ...
    <div class="parsys styleParsys"><div class="baseComponent plain_text section">
...
<span class="font12">IOS是Cisco在美国及其他国家/地区的商标或注册商标，在授权下使用。App Store、iPad和iPhone是Apple Inc.在美国及其他国家/地区的商标或注册商标。</span>
