...
comments: false
date: Sun, 14 Mar 2021 08:03:27 GMT
thumbnail: ''
---
...
-->
<pre><code class="language-routes">/verfghbw/press
/verfghbw/press/landtag
</code></pre>
...
-->
<p>Now using dayjs to correctly parse pubDate, and providing a description field to show the full-length title.</p>
