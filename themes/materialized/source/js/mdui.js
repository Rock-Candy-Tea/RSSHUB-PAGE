...
;(function(global, factory) {
  ...
  $(function () {
    ...
    $('.link_active').on('click focus', function (e) {
      if(document.getElementsByClassName('sider_active')[0]){
        document.getElementsByClassName('sider_active')[0].setAttribute("class", "link_active")
      }
      this.setAttribute("class", "sider_active")
    });
