...
---
title: '_Unclassified_&nbsp;《魔獸世界：巨龍崛起》製作總監：雅立史卓莎將有重要戲份 非常重視其服裝造型'
categories: 
 - 游戏
 - 巴哈姆特
 - GNN 新聞
...
 </div>
<div>
　　Pat Dawson 今日在新資料片正式揭露後，透過線上視訊方式，接受巴哈姆特 GNN 等臺灣、香港媒體訪問，以下為訪談摘要整理：</div>
<div>
 </div>
<div>
<ul class="bh-grids-img">
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>講到龍，我們覺得這是一個把龍當作主題的好機會。當大家在暗影之境歷險回來，回到熟悉的艾澤拉斯是理所當然的發展，我們希望把有艾澤拉斯感覺的主題呈現出來。當然在新資料片中，部分過去有關的故事線會回來，但在《巨龍崛起》裡，很多的故事與場景都是全新的，我們希望給玩家新鮮的體驗，還有些《暗影之境》故事線會延續到《巨龍崛起》 但絕大故事都是嶄新的。</div>
<div>
 </div>
<div>
<ul class="bh-grids-img">
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>怒西昂想要找巨龍群島已經很久了，當他知道巨龍群島現身，想知道玩家學到了什麼。從新資料片的前導影片中，我們可以看出怒西昂不是我們回到巨龍群島的主因，這次巨龍呼喚是全面性的。當然怒西昂是重要的角色，但他不是我們回到巨龍群島的原因。原因是更深層的，怒西昂會跟玩家一起去瞭解、為何此時巨龍群島會現身，有什麼需要玩家的地方。</div>
<div>
 </div>
<div>
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>卡雷苟斯大概會是在新資料片第三個區域、蒼藍高地時，玩家有機會跟他互動，在這個有高地、有冰凍瀑布的地區，將是以與卡雷苟斯互動為主，這個地區劇情主要會是由他所呈現，那細節未來就由玩家自己來探索。</div>
<div>
 </div>
<div>
<ul class="bh-grids-img">
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>喔，鴨子。對，我們終於在此次新資料片把鴨子加入，可以說是水到渠成。</div>
<div>
 </div>
<div>
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>飛龍騎術會是玩家踏入巨龍群島擁有的新能力。隨著新資料片的故事演進，飛龍騎術能力會強化與解鎖。雖說這個飛龍騎術會看似跟過去飛行類似，但其實有些不一樣，玩家有了飛龍騎術後，並不是行動完全沒有任何限制，而是可以騎著飛龍俯衝、騰空而起，甚至有些新技能可以到達過去到不了的地方，比較像是升級後的飛行感覺。</div>
<div>
 </div>
<div>
　　飛龍騎術也可以提供客製化能力，讓玩家可以改變造型如頭部、鱗片、顏色、尾巴、裝甲等，讓玩家打造自己喜愛的飛龍坐騎。</div>
<div>
 </div>
<div>
<ul class="bh-grids-img">
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>飛龍騎術是玩家進到巨龍群島後，馬上取得的技能。飛龍騎術是全新的空中移動方式，跟原本的飛行不太一樣。玩家只有運用在新資料片中推出的巨龍坐騎才能夠使用飛龍騎術，目前既有的飛行坐騎無法使用飛龍騎術。</div>
<div>
 </div>
<div>
　　飛龍騎術跟過去飛行不一樣的地方就在於有俯衝、騰空而起等，是完全不同的系統，並非單純的飛行。舉例來說，在地圖某些地點要俯衝加速才能到達 ，或是懸轉翻身才能擠過小地方，有些是一般飛行到不了的地方，所以會需要用到飛龍騎術。</div>
<div>
 </div>
<div>
　　既有的飛行仍可使用，飛行是依照過去慣例，將隨著玩家在資料片中提升等級而開啟，並非資料片一開放即可使用。飛行將於什麼時候解鎖，目前尚未決定。</div>
<div>
 </div>
<div>
...
<iframe allowfullscreen="allowfullscreen" frameborder="0" height="auto" class="lazyload" data-sizes="auto" src="https://www.youtube.com/embed/0YJO0mZ2JjI?wmode=transparent" width="100%"></iframe></div>
</div>
<div>
 </div>
<div>
　　玩家還可以把天賦配點儲存起來，需要的時候再叫出來，例如打 PVP、打地下城有不同配點方式，你可以先儲存好、需要改變天賦配點時叫出來，可以更順利體驗到配點不同的角色差異性。</div>
<div>
 </div>
<div>
...
 </div>
<div>
Pat Dawson：半龍人喚能師機制跟現在狼人類似，大部分戰鬥都是以龍型態的外型戰鬥，很多技能會需要翅膀或是突襲技能，那會在龍型態時展現。至於人型態通常會是在走動、使用飛龍騎術，目前遊戲設計是玩家一進入戰鬥模式、施展攻擊技能就會切換龍型態。</div>
<div>
 </div>
<div>
<div class="video-container">
<iframe allowfullscreen="allowfullscreen" frameborder="0" height="auto" class="lazyload" data-sizes="auto" src="https://www.youtube.com/embed/iQkwYB5B3Es?wmode=transparent" width="100%"></iframe></div>
</div>
<div>
 </div>
<div>
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>我不確定我們是否有決定只限制在創造或是打造的專業技能上，這是我們還在內部討論的事情。</div>
<div>
 </div>
<div>
　　就我知道的部分是，當玩家學到把不同材料結合、打造出新物品時，一定會用上訂單系統。那如果像是採集系的專業技能，以目前遊戲有拍賣場來說，應該是足夠的，玩家想要交易草藥、礦物、皮革，應該拍賣場機制就已經足夠。</div>
<div>
 </div>
<div>
<ul class="bh-grids-img">
...
<div>
<div class="video-container">
<iframe allowfullscreen="allowfullscreen" frameborder="0" height="auto" class="lazyload" data-sizes="auto" src="https://www.youtube.com/embed/zEIwhN68O3Q?wmode=transparent" width="100%"></iframe></div>
</div>
<div>
 </div>
<div>
　　我覺得這是好問題。訂單系統主要是設計給產品品質會有差異的專業技能，那如果是採集系的也不用擔心，遊戲會藉由角色專精等方式，讓採集系有體會新的遊戲方式。</div>
<div>
 </div>
<div>
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>目前我們沒有加入傷害計數器。提到介面更新，比較會是外觀配置上，玩家透過自己想要的方式來客製化使用者介面，不管是大螢幕、小螢幕，玩家都可以調整自己使用者介面配置，那擴充功能也都可以使用。</div>
<div>
 </div>
<div>
...
 </div>
<div>
<span style="color:blue;">Pat Dawson：</span>當然，我們希望玩家不管在哪種螢幕上，玩家都可以透過使用者介面很清楚、容易使用，所以在更新使用者介面時，都有考量到這部分。</div>
<div>
 </div>
<div>
...
 </div>
<div>
　　我們知道經典版將要進入《巫妖王之怒》，在那個版本中龍族也是重要角色，玩家到到北裂境會碰到龍后與龍族，也會有劇情故事，雖然是不同故事階段，但玩家在《巨龍崛起》時會不會發現葛拉克朗的骨骸，或是發生什麼事情並不好說，也許在《巨龍崛起》中發現當初後續發展是什麼、或許可能是當時《巫妖王之怒》留下來的尾線，讓玩家在《巨龍崛起》才意識到原來當初後續發展是什麼。</div>
<div>
 </div>
<div>
