...
<br>
<div class="blockcode"><div id="code_F80"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_F80'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_x8U"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_x8U'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_LW7"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_LW7'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_trU'));">复制代码</em></div><br>
