...
<br>
<div class="blockcode"><div id="code_AVz"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_AVz'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_cQi"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_cQi'));">复制代码</em></div><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_W4B'));">复制代码</em></div><br>
