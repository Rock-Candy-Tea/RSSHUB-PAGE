...
<br>
<div class="blockcode"><div id="code_S9h"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_S9h'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Z9K"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Z9K'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_kuL"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_kuL'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_O16'));">复制代码</em></div><br>
