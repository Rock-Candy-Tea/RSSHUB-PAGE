...
<br>
<div class="blockcode"><div id="code_nK4"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nK4'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_RjC"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_RjC'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_tSs"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_tSs'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_UO2'));">复制代码</em></div><br>
