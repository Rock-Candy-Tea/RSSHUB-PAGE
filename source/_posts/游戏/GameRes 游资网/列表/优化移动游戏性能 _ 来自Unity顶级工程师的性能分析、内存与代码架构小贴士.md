...
<br>
<div class="blockcode"><div id="code_pbE"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_pbE'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dZC"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_dZC'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_PS1"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PS1'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_IA1'));">复制代码</em></div><br>
