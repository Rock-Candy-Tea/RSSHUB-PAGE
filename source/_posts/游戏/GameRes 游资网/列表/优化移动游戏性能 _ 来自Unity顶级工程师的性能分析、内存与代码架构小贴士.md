...
<br>
<div class="blockcode"><div id="code_jqU"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_jqU'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_zk7"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_zk7'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_OKg"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_OKg'));">复制代码</em></div><br>
<div align="center">
...
<br>
<div class="blockcode"><div id="code_KpR"><ol><li>void Update()<br>
</li><li>&#123;<br>
</li><li>    Renderer myRenderer = GetComponent<Renderer>();<br>
</li><li>    ExampleFunction(myRenderer);<br>
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_KpR'));">复制代码</em></div><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_F8W'));">复制代码</em></div><br>
