...
<br>
<div class="blockcode"><div id="code_dFO"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dFO'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dBH"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_dBH'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_t9M"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_t9M'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_hDX'));">复制代码</em></div><br>
