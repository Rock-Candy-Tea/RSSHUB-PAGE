...
<br>
<div class="blockcode"><div id="code_rAw"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_rAw'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_VAy"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_VAy'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Grl"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Grl'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_brJ'));">复制代码</em></div><br>
