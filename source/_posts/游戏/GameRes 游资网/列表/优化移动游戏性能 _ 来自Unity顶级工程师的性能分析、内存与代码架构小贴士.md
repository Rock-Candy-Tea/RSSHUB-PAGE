...
<br>
<div class="blockcode"><div id="code_qfy"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_qfy'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_hY1"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_hY1'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Trf"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Trf'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_o5E'));">复制代码</em></div><br>
