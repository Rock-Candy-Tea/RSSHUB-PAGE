...
<br>
<div class="blockcode"><div id="code_log"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_log'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_DLg"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_DLg'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_SGk"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_SGk'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_FDb'));">复制代码</em></div><br>
