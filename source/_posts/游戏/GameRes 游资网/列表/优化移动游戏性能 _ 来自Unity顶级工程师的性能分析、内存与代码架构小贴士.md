...
<br>
<div class="blockcode"><div id="code_Sfk"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Sfk'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_E64"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_E64'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_X8d"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_X8d'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dA4'));">复制代码</em></div><br>
