...
<br>
<div class="blockcode"><div id="code_k66"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_k66'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_EO0"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_EO0'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_OTz"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_OTz'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Kx7'));">复制代码</em></div><br>
