...
<br>
<div class="blockcode"><div id="code_o01"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_o01'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dbZ"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_dbZ'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ZUM"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ZUM'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_rMO'));">复制代码</em></div><br>
