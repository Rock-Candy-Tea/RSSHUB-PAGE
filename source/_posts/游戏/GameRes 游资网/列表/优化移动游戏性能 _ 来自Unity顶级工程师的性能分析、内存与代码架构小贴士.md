...
<br>
<div class="blockcode"><div id="code_xeI"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xeI'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dRH"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_dRH'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_k26"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_k26'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_wiq'));">复制代码</em></div><br>
