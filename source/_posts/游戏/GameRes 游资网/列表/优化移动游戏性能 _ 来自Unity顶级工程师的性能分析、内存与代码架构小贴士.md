...
<br>
<div class="blockcode"><div id="code_O79"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_O79'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_qFZ"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_qFZ'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_rBc"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_rBc'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_vfK'));">复制代码</em></div><br>
