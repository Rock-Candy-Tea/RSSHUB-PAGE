...
<br>
<div class="blockcode"><div id="code_XkQ"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_XkQ'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dMK"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_dMK'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_anV"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_anV'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Nmq'));">复制代码</em></div><br>
