...
<br>
<div class="blockcode"><div id="code_f5N"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_f5N'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_xU1"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xU1'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_OtM'));">复制代码</em></div><br>
