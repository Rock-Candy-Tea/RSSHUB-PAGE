...
<br>
<div class="blockcode"><div id="code_kpo"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_kpo'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ybl"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_ybl'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_APr"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_APr'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Eg7'));">复制代码</em></div><br>
