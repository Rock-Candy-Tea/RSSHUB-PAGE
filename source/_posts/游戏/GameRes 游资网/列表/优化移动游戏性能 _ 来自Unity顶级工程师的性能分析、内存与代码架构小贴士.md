...
<br>
<div class="blockcode"><div id="code_vKC"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_vKC'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_NXh"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_NXh'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ai9"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ai9'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_v3h'));">复制代码</em></div><br>
