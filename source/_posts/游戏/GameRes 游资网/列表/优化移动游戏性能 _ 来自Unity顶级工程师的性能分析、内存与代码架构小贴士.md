...
<br>
<div class="blockcode"><div id="code_h95"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_h95'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_CYC"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_CYC'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_f2Z"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_f2Z'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ivF'));">复制代码</em></div><br>
