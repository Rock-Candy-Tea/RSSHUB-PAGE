...
<br>
<div class="blockcode"><div id="code_BzM"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_BzM'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_wxw"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_wxw'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dWQ"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dWQ'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_JR5'));">复制代码</em></div><br>
