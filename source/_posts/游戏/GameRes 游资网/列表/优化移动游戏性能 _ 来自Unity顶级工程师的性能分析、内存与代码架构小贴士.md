...
<br>
<div class="blockcode"><div id="code_jKm"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_jKm'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_pnl"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_pnl'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_A3r"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_A3r'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_XnZ'));">复制代码</em></div><br>
