...
<br>
<div class="blockcode"><div id="code_lw6"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_lw6'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_vnV"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_vnV'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_jC4"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_jC4'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dNn'));">复制代码</em></div><br>
