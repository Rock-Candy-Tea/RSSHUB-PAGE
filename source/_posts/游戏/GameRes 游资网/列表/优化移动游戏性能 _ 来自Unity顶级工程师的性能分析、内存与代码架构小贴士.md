...
<br>
<div class="blockcode"><div id="code_f84"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_f84'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_w48"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_w48'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_COx"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_COx'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xzm'));">复制代码</em></div><br>
