...
<br>
<div class="blockcode"><div id="code_F8l"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_F8l'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_AKf"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_AKf'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Iz0"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Iz0'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_s2T'));">复制代码</em></div><br>
