...
<br>
<div class="blockcode"><div id="code_K78"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_K78'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_WL8"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_WL8'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_EKV"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_EKV'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PaW'));">复制代码</em></div><br>
