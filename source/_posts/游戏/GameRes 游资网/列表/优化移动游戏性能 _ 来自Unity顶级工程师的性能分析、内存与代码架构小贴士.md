...
<br>
<div class="blockcode"><div id="code_ASc"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ASc'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_nQ6"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_nQ6'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_kRR"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_kRR'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_zR9'));">复制代码</em></div><br>
