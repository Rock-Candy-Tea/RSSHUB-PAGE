...
<br>
<div class="blockcode"><div id="code_xb3"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xb3'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_UC3"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_UC3'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Eay"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Eay'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_SgN'));">复制代码</em></div><br>
