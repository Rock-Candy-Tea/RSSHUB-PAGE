...
<br>
<div class="blockcode"><div id="code_dUa"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dUa'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_J0S"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_J0S'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_lf0"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_lf0'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_lN6'));">复制代码</em></div><br>
