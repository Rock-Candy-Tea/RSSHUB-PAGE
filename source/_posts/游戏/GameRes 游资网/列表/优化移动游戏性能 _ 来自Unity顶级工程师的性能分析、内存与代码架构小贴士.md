...
<br>
<div class="blockcode"><div id="code_fkr"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_fkr'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_jMT"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_jMT'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_LET"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_LET'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_S9i'));">复制代码</em></div><br>
