...
<br>
<div class="blockcode"><div id="code_Bji"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Bji'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Ze9"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Ze9'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Npc"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Npc'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Fp0'));">复制代码</em></div><br>
