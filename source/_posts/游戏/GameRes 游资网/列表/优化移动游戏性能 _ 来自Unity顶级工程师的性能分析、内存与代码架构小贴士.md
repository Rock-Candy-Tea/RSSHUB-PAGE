...
<br>
<div class="blockcode"><div id="code_k1U"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_k1U'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_BMR"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_BMR'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_F0R"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_F0R'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PM0'));">复制代码</em></div><br>
