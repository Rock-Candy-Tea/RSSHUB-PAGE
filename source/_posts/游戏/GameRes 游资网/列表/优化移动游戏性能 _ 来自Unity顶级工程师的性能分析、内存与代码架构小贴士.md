...
<br>
<div class="blockcode"><div id="code_Mh4"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Mh4'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_f4d"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_f4d'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_A9p"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_A9p'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_l9d'));">复制代码</em></div><br>
