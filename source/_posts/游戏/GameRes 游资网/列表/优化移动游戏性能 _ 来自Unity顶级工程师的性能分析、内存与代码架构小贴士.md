...
<br>
<div class="blockcode"><div id="code_Yxk"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Yxk'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_qFf"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_qFf'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_HAc"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_HAc'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_oAc'));">复制代码</em></div><br>
