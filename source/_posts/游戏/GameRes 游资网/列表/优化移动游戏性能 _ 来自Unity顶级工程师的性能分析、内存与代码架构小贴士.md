...
<br>
<div class="blockcode"><div id="code_TNA"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_TNA'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_bBM"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_bBM'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_VAq"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_VAq'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Gj4'));">复制代码</em></div><br>
