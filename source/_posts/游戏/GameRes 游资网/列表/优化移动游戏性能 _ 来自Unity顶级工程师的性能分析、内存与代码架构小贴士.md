...
<br>
<div class="blockcode"><div id="code_K5j"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_K5j'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_vRj"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_vRj'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_B4x"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_B4x'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_EZE'));">复制代码</em></div><br>
