...
<br>
<div class="blockcode"><div id="code_eTi"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_eTi'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ZmW"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_ZmW'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_B95"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_B95'));">复制代码</em></div><br>
<div align="center">
...
<br>
<div class="blockcode"><div id="code_ftW"><ol><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ftW'));">复制代码</em></div><br>
