...
<br>
<div class="blockcode"><div id="code_zX3"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_zX3'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_f3Z"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_f3Z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_svn"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_svn'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_RLj'));">复制代码</em></div><br>
