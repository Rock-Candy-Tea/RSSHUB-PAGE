...
<br>
<div class="blockcode"><div id="code_u5s"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_u5s'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_W5s"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_W5s'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dPx"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dPx'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_q0X'));">复制代码</em></div><br>
