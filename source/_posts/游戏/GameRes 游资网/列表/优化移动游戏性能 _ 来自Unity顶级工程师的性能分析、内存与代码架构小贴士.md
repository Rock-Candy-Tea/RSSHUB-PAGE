...
<br>
<div class="blockcode"><div id="code_ymB"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ymB'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_DII"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_DII'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_y77"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_y77'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_yft'));">复制代码</em></div><br>
