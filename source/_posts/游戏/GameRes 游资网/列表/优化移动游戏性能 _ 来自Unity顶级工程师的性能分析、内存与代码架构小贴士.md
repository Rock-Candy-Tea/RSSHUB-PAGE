...
<br>
<div class="blockcode"><div id="code_r9d"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_r9d'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_mgE"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_mgE'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ZCl"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ZCl'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_F4e'));">复制代码</em></div><br>
