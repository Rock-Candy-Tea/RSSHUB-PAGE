...
<br>
<div class="blockcode"><div id="code_mKv"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_mKv'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Nes"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Nes'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_rxs"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_rxs'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_KET'));">复制代码</em></div><br>
