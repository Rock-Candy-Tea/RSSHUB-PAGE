...
<br>
<div class="blockcode"><div id="code_l6z"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_l6z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_g9Z"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_g9Z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_bCD"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bCD'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_tmN'));">复制代码</em></div><br>
