...
<br>
<div class="blockcode"><div id="code_Fwp"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Fwp'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Vgb"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Vgb'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_NAw"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_NAw'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_YE3'));">复制代码</em></div><br>
