...
<br>
<div class="blockcode"><div id="code_PGp"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PGp'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_M6X"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_M6X'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_R5r"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_R5r'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_WXB'));">复制代码</em></div><br>
