...
<br>
<div class="blockcode"><div id="code_a7D"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_a7D'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_J7d"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_J7d'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_v72'));">复制代码</em></div><br>
