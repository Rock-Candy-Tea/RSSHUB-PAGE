...
<br>
<div class="blockcode"><div id="code_P77"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_P77'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_i6W"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_i6W'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_gfj"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_gfj'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_VzM'));">复制代码</em></div><br>
