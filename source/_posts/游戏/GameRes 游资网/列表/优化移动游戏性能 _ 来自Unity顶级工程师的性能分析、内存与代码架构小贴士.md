...
<br>
<div class="blockcode"><div id="code_jn7"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_jn7'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_X3v"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_X3v'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_KzP"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_KzP'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dzw'));">复制代码</em></div><br>
