...
<br>
<div class="blockcode"><div id="code_NI6"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_NI6'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_RfO"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_RfO'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dS5"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dS5'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Nee'));">复制代码</em></div><br>
