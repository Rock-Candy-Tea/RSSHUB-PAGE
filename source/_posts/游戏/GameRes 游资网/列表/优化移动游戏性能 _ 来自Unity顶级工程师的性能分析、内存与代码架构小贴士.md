...
<br>
<div class="blockcode"><div id="code_jL9"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_jL9'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_lNl"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_lNl'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_tcK"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_tcK'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dhO'));">复制代码</em></div><br>
