...
<br>
<div class="blockcode"><div id="code_q5X"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_q5X'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_y4R"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_y4R'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_W4i"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_W4i'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_pxE'));">复制代码</em></div><br>
