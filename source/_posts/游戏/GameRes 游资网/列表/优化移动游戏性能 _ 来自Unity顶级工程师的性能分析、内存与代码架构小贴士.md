...
<br>
<div class="blockcode"><div id="code_nuy"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nuy'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_nR4"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_nR4'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_HQ4"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_HQ4'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_t0P'));">复制代码</em></div><br>
