...
<br>
<div class="blockcode"><div id="code_U4V"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_U4V'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_es8"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_es8'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_z5d"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_z5d'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bKj'));">复制代码</em></div><br>
