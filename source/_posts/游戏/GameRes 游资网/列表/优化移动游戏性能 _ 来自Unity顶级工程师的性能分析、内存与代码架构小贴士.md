...
<br>
<div class="blockcode"><div id="code_t6r"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_t6r'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_U6v"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_U6v'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ksc'));">复制代码</em></div><br>
