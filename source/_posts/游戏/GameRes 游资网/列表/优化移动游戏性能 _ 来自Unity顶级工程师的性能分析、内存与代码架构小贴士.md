...
<br>
<div class="blockcode"><div id="code_FR3"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_FR3'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_k90"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_k90'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_CQr"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_CQr'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_BKK'));">复制代码</em></div><br>
