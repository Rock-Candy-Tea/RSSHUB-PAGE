...
<br>
<div class="blockcode"><div id="code_Clg"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Clg'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_NWc"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_NWc'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_eqe'));">复制代码</em></div><br>
