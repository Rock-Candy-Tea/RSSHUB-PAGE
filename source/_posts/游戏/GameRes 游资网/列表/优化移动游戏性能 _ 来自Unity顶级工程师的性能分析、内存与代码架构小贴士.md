...
<br>
<div class="blockcode"><div id="code_Ctt"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Ctt'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_IAT"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_IAT'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Jma"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Jma'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_fp7'));">复制代码</em></div><br>
