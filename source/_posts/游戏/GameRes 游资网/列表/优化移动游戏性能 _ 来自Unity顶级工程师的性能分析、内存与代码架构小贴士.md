...
<br>
<div class="blockcode"><div id="code_R1Z"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_R1Z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Zzn"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Zzn'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_b3s"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_b3s'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_qaT'));">复制代码</em></div><br>
