...
<br>
<div class="blockcode"><div id="code_sKk"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_sKk'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_v0F"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_v0F'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_RI9"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_RI9'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_vk3'));">复制代码</em></div><br>
