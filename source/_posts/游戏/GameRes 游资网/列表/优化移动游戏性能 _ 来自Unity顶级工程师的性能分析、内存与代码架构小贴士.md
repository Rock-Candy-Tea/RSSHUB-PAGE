...
<br>
<div class="blockcode"><div id="code_ACS"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ACS'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_R5Z"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_R5Z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_bW5"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bW5'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_hJm'));">复制代码</em></div><br>
