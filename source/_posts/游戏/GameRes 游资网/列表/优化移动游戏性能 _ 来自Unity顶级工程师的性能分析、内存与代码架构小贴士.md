...
<br>
<div class="blockcode"><div id="code_X8s"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_X8s'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_i4A"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_i4A'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_aWq"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_aWq'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bBo'));">复制代码</em></div><br>
