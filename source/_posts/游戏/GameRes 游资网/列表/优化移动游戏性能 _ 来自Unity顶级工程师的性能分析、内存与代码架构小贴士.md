...
<br>
<div class="blockcode"><div id="code_W00"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_W00'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_lfS"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_lfS'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_sih"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_sih'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_giE'));">复制代码</em></div><br>
