...
<br>
<div class="blockcode"><div id="code_h8Y"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_h8Y'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_q7l"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_q7l'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_pAI"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_pAI'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_mI3'));">复制代码</em></div><br>
