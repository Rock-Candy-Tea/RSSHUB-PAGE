...
<br>
<div class="blockcode"><div id="code_ttS"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ttS'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_gyB"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_gyB'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ykt"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ykt'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_C0z'));">复制代码</em></div><br>
