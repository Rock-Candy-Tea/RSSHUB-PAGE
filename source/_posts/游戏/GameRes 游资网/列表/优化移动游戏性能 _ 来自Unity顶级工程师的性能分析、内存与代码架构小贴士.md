...
<br>
<div class="blockcode"><div id="code_lzA"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_lzA'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_KP3"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_KP3'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_g3Q"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_g3Q'));">复制代码</em></div><br>
<div align="center">
...
<br>
<div class="blockcode"><div id="code_bAQ"><ol><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bAQ'));">复制代码</em></div><br>
