...
<br>
<div class="blockcode"><div id="code_J55"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_J55'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_yQh"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_yQh'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_QIk"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_QIk'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_t37'));">复制代码</em></div><br>
