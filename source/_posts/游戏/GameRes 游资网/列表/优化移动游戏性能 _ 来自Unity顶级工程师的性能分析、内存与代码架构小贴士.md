...
<br>
<div class="blockcode"><div id="code_UYX"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_UYX'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Iny"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Iny'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_kIy"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_kIy'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_tjS'));">复制代码</em></div><br>
