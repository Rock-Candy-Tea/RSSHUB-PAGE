...
<br>
<div class="blockcode"><div id="code_xc3"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xc3'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Ks1"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Ks1'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_PS2"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PS2'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xsS'));">复制代码</em></div><br>
