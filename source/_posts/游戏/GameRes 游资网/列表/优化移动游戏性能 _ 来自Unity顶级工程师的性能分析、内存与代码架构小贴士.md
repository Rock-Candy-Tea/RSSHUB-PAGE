...
<br>
<div class="blockcode"><div id="code_v8X"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_v8X'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Yy9"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Yy9'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_NWv"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_NWv'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Wxc'));">复制代码</em></div><br>
