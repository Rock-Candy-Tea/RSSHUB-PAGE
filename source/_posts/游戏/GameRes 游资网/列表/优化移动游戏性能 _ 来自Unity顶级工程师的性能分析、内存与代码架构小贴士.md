...
<br>
<div class="blockcode"><div id="code_k8U"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_k8U'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_QUv"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_QUv'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_rVs"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_rVs'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_cxB'));">复制代码</em></div><br>
