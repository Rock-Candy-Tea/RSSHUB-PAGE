...
<br>
<div class="blockcode"><div id="code_reW"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_reW'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_epf"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_epf'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_rH1"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_rH1'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_L0N'));">复制代码</em></div><br>
