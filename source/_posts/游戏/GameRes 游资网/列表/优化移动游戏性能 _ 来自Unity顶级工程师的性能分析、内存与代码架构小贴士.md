...
<br>
<div class="blockcode"><div id="code_f2l"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_f2l'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_LD8"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_LD8'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_FHW"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_FHW'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_L3Z'));">复制代码</em></div><br>
