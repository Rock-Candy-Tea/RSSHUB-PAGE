...
<br>
<div class="blockcode"><div id="code_xDj"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xDj'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_BqJ"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_BqJ'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_MA7"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_MA7'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_cjM'));">复制代码</em></div><br>
