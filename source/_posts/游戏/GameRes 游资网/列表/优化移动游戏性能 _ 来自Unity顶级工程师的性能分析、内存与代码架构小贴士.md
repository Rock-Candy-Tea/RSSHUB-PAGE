...
<br>
<div class="blockcode"><div id="code_Uar"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Uar'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_kBO"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_kBO'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_j2Q"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_j2Q'));">复制代码</em></div><br>
<div align="center">
...
<br>
<div class="blockcode"><div id="code_zgW"><ol><li>void Update()<br>
</li><li>&#123;<br>
</li><li>    Renderer myRenderer = GetComponent<Renderer>();<br>
</li><li>    ExampleFunction(myRenderer);<br>
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_zgW'));">复制代码</em></div><br>
