...
<br>
<div class="blockcode"><div id="code_wa4"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_wa4'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_TQ5"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_TQ5'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_uHg"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_uHg'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_k0v'));">复制代码</em></div><br>
