...
<br>
<div class="blockcode"><div id="code_Vb0"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Vb0'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_OY6"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_OY6'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_G60"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_G60'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_YDa'));">复制代码</em></div><br>
