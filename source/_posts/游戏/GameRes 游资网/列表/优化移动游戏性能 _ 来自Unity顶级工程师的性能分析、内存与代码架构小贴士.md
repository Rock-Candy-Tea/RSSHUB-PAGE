...
<br>
<div class="blockcode"><div id="code_i2b"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_i2b'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_gFA"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_gFA'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_gau"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_gau'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Rz1'));">复制代码</em></div><br>
