...
<br>
<div class="blockcode"><div id="code_sj9"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_sj9'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_W9W"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_W9W'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Sov"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Sov'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_mok'));">复制代码</em></div><br>
