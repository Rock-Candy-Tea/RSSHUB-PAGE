...
<br>
<div class="blockcode"><div id="code_zlw"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_zlw'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_mZZ"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_mZZ'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_we7"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_we7'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_pNL'));">复制代码</em></div><br>
