...
<br>
<div class="blockcode"><div id="code_RrA"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_RrA'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_n95"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_n95'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_LcE"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_LcE'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_u4B'));">复制代码</em></div><br>
