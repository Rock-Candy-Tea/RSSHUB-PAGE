...
<br>
<div class="blockcode"><div id="code_pfd"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_pfd'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_xFi"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_xFi'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_P6J"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_P6J'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_X1t'));">复制代码</em></div><br>
