...
<br>
<div class="blockcode"><div id="code_IJn"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_IJn'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_RSw"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_RSw'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_uXQ"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_uXQ'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nQ0'));">复制代码</em></div><br>
