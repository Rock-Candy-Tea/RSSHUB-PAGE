...
<br>
<div class="blockcode"><div id="code_PDs"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PDs'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_r4t"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_r4t'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ltA"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ltA'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_JlK'));">复制代码</em></div><br>
