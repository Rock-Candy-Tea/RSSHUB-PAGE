...
<br>
<div class="blockcode"><div id="code_iCz"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_iCz'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_fql"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_fql'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dqX"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dqX'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nQE'));">复制代码</em></div><br>
