...
<br>
<div class="blockcode"><div id="code_dP0"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dP0'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_HPT"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_HPT'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_PkY"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PkY'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_R4x'));">复制代码</em></div><br>
