...
<br>
<div class="blockcode"><div id="code_KnN"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_KnN'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_j6C"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_j6C'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_RCV"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_RCV'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_C4E'));">复制代码</em></div><br>
