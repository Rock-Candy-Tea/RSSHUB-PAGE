...
<br>
<div class="blockcode"><div id="code_wID"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_wID'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_s1Z"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_s1Z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_g8g"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_g8g'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Xs3'));">复制代码</em></div><br>
