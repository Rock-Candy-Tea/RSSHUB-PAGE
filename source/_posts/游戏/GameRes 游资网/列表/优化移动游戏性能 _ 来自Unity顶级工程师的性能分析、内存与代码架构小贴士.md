...
<br>
<div class="blockcode"><div id="code_p3e"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_p3e'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_lWj"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_lWj'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_inb"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_inb'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Vh6'));">复制代码</em></div><br>
