...
<br>
<div class="blockcode"><div id="code_rvM"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_rvM'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_z1A"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_z1A'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_bTt"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bTt'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Lgm'));">复制代码</em></div><br>
