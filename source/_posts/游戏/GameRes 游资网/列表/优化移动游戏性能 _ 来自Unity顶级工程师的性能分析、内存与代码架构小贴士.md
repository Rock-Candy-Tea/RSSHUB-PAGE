...
<br>
<div class="blockcode"><div id="code_cOk"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_cOk'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_HdE"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_HdE'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Llo"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Llo'));">复制代码</em></div><br>
<div align="center">
...
<br>
<div class="blockcode"><div id="code_Ln5"><ol><li>void Update()<br>
</li><li>&#123;<br>
</li><li>    Renderer myRenderer = GetComponent<Renderer>();<br>
</li><li>    ExampleFunction(myRenderer);<br>
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Ln5'));">复制代码</em></div><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Uqk'));">复制代码</em></div><br>
