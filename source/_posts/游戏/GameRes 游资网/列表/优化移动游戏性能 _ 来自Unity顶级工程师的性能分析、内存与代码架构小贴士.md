...
<br>
<div class="blockcode"><div id="code_RE5"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_RE5'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_G90"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_G90'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_mF5"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_mF5'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_d5d'));">复制代码</em></div><br>
