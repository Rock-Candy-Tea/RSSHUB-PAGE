...
<br>
<div class="blockcode"><div id="code_gS5"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_gS5'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_c5c"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_c5c'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_q0e"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_q0e'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_GcB'));">复制代码</em></div><br>
