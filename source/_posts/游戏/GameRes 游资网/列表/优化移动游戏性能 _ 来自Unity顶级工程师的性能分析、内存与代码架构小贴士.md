...
<br>
<div class="blockcode"><div id="code_Ytp"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Ytp'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_j1b"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_j1b'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_D81"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_D81'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_DJ8'));">复制代码</em></div><br>
