...
<br>
<div class="blockcode"><div id="code_r3P"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_r3P'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Xag"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Xag'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_tHA"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_tHA'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_rwh'));">复制代码</em></div><br>
