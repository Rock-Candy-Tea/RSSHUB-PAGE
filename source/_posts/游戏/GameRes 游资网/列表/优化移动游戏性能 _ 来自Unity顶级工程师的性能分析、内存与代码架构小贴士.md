...
<br>
<div class="blockcode"><div id="code_ZD8"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ZD8'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Xlv"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Xlv'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Y1S"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Y1S'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_s0Q'));">复制代码</em></div><br>
