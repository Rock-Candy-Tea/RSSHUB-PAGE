...
<br>
<div class="blockcode"><div id="code_zuZ"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_zuZ'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_YUq"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_YUq'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_OEA"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_OEA'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_btv'));">复制代码</em></div><br>
