...
<br>
<div class="blockcode"><div id="code_g3Y"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_g3Y'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_W3y"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_W3y'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_GzG"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_GzG'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ul4'));">复制代码</em></div><br>
