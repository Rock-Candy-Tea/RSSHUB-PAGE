...
<br>
<div class="blockcode"><div id="code_r3l"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_r3l'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_aJ3"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_aJ3'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_DEh"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_DEh'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ixh'));">复制代码</em></div><br>
