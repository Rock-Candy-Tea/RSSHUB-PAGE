...
<br>
<div class="blockcode"><div id="code_oR2"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_oR2'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_p7y"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_p7y'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_osD"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_osD'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ibd'));">复制代码</em></div><br>
