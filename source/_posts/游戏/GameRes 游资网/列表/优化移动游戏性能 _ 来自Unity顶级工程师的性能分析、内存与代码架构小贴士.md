...
<br>
<div class="blockcode"><div id="code_AAt"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_AAt'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_tzX"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_tzX'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_N1v"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_N1v'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_O5r'));">复制代码</em></div><br>
