...
<br>
<div class="blockcode"><div id="code_wx2"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_wx2'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_pH4"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_pH4'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_CAi"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_CAi'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_d4h'));">复制代码</em></div><br>
