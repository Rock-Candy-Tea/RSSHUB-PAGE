...
<br>
<div class="blockcode"><div id="code_bpr"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bpr'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_NDf"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_NDf'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_d2j"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_d2j'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_lom'));">复制代码</em></div><br>
