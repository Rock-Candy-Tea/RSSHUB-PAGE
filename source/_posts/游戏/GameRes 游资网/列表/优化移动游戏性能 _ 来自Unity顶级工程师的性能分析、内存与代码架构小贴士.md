...
<br>
<div class="blockcode"><div id="code_en9"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_en9'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Uwv"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Uwv'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_JOn"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_JOn'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_oa5'));">复制代码</em></div><br>
