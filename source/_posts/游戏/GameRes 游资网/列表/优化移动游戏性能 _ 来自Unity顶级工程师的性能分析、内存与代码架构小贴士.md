...
<br>
<div class="blockcode"><div id="code_ibu"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ibu'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_B2J"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_B2J'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Db4"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Db4'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_EgG'));">复制代码</em></div><br>
