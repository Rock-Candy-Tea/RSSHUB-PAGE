...
<br>
<div class="blockcode"><div id="code_gI7"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_gI7'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Z3j"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Z3j'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_dSY"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dSY'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_IY2'));">复制代码</em></div><br>
