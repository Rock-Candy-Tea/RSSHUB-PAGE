...
<br>
<div class="blockcode"><div id="code_UPD"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_UPD'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_VwG"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_VwG'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_iFW"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_iFW'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_o0C'));">复制代码</em></div><br>
