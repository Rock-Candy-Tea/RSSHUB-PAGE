...
<br>
<div class="blockcode"><div id="code_TGu"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_TGu'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_nMU"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_nMU'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ZBu"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ZBu'));">复制代码</em></div><br>
<div align="center">
...
<br>
<div class="blockcode"><div id="code_RxX"><ol><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_RxX'));">复制代码</em></div><br>
