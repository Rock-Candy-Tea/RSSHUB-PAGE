...
<br>
<div class="blockcode"><div id="code_nSC"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nSC'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_l78"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_l78'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_BC4"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_BC4'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_tb5'));">复制代码</em></div><br>
