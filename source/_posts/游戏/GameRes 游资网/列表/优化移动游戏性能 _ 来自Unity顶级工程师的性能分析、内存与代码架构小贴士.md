...
<br>
<div class="blockcode"><div id="code_j84"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_j84'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_XMm"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_XMm'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_cQD"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_cQD'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_out'));">复制代码</em></div><br>
