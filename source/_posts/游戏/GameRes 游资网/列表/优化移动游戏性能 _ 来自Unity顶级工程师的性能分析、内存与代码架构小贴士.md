...
<br>
<div class="blockcode"><div id="code_gmk"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_gmk'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_cCL"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_cCL'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_AKR"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_AKR'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PnN'));">复制代码</em></div><br>
