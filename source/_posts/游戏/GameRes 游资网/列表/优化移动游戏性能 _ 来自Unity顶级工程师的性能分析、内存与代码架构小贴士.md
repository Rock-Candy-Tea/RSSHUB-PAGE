...
<br>
<div class="blockcode"><div id="code_h3n"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_h3n'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_KA1"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_KA1'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Bfu"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Bfu'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_b4o'));">复制代码</em></div><br>
