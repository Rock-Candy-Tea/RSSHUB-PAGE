...
<br>
<div class="blockcode"><div id="code_dj0"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dj0'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_IL3"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_IL3'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_b5Q'));">复制代码</em></div><br>
