...
<br>
<div class="blockcode"><div id="code_FCc"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_FCc'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_U79"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_U79'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_GOQ"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_GOQ'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_icC'));">复制代码</em></div><br>
