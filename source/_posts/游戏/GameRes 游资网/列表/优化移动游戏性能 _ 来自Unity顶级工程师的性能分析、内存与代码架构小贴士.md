...
<br>
<div class="blockcode"><div id="code_bw8"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bw8'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_PKl"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_PKl'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_v4L"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_v4L'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_EK3'));">复制代码</em></div><br>
