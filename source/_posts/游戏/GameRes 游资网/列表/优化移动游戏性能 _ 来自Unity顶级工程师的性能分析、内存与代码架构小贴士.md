...
<br>
<div class="blockcode"><div id="code_b4M"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_b4M'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_urw"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_urw'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_oyT"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_oyT'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_M38'));">复制代码</em></div><br>
