...
<br>
<div class="blockcode"><div id="code_eBg"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_eBg'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_S2b"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_S2b'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_EF7"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_EF7'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_FfP'));">复制代码</em></div><br>
