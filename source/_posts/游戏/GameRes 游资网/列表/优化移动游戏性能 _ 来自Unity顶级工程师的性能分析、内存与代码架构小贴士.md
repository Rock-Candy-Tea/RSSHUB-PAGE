...
<br>
<div class="blockcode"><div id="code_Ofa"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Ofa'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ckt"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_ckt'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_NT7"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_NT7'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_q1G'));">复制代码</em></div><br>
