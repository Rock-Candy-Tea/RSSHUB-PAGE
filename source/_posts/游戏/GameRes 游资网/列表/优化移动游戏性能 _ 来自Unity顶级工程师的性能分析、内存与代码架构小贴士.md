...
<br>
<div class="blockcode"><div id="code_bQ0"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bQ0'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_v2z"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_v2z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_g2K"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_g2K'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_cZy'));">复制代码</em></div><br>
