...
<br>
<div class="blockcode"><div id="code_tWp"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_tWp'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Wtn"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Wtn'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_K9E"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_K9E'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_RP8'));">复制代码</em></div><br>
