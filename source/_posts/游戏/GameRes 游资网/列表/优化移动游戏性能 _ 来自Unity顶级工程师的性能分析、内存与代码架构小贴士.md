...
<br>
<div class="blockcode"><div id="code_GeK"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_GeK'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_AA5"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_AA5'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_auX"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_auX'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_fQb'));">复制代码</em></div><br>
