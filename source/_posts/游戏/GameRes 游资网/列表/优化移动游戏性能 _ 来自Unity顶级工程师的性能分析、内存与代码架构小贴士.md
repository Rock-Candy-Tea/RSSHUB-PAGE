...
<br>
<div class="blockcode"><div id="code_wec"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_wec'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_GkN"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_GkN'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ScZ"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ScZ'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nnR'));">复制代码</em></div><br>
