...
<br>
<div class="blockcode"><div id="code_T5m"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_T5m'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_c5U"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_c5U'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_T30"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_T30'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_MCZ'));">复制代码</em></div><br>
