...
<br>
<div class="blockcode"><div id="code_jCB"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_jCB'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_yka"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_yka'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Snk"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Snk'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_k6b'));">复制代码</em></div><br>
