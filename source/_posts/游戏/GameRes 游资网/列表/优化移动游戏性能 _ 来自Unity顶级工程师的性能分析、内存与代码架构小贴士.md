...
<br>
<div class="blockcode"><div id="code_Spt"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Spt'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_z12"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_z12'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_wRA"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_wRA'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_yr6'));">复制代码</em></div><br>
