...
<br>
<div class="blockcode"><div id="code_Uyi"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Uyi'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_eqp"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_eqp'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_gIb"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_gIb'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_u9j'));">复制代码</em></div><br>
