...
<br>
<div class="blockcode"><div id="code_MQY"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_MQY'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_E4v"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_E4v'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_odL"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_odL'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Wz2'));">复制代码</em></div><br>
