...
<br>
<div class="blockcode"><div id="code_Doo"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Doo'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_hch"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_hch'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Qbq"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Qbq'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_qoc'));">复制代码</em></div><br>
