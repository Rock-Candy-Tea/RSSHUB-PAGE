...
<br>
<div class="blockcode"><div id="code_qWE"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_qWE'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ui1"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_ui1'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_JP7"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_JP7'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_GAd'));">复制代码</em></div><br>
