...
<br>
<div class="blockcode"><div id="code_hyL"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_hyL'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ZuY"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_ZuY'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_x0o"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_x0o'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_MjY'));">复制代码</em></div><br>
