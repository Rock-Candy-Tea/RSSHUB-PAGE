...
<br>
<div class="blockcode"><div id="code_PwJ"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PwJ'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_gWj"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_gWj'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_czW"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_czW'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dDN'));">复制代码</em></div><br>
