...
<br>
<div class="blockcode"><div id="code_MAc"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_MAc'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_HYZ"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_HYZ'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_MzZ"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_MzZ'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_a04'));">复制代码</em></div><br>
