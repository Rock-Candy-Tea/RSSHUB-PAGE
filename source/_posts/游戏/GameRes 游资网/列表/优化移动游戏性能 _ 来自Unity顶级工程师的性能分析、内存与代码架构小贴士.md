...
<br>
<div class="blockcode"><div id="code_jR4"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_jR4'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_AO1"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_AO1'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_hgg"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_hgg'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_u6g'));">复制代码</em></div><br>
