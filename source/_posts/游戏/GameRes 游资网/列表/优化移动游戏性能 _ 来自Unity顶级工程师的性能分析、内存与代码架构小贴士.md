...
<br>
<div class="blockcode"><div id="code_HOP"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_HOP'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_pK8"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_pK8'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Vtu"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Vtu'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_IE0'));">复制代码</em></div><br>
