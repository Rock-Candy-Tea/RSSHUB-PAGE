...
<br>
<div class="blockcode"><div id="code_Ep3"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Ep3'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_UGk"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_UGk'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_wr1"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_wr1'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_sI7'));">复制代码</em></div><br>
