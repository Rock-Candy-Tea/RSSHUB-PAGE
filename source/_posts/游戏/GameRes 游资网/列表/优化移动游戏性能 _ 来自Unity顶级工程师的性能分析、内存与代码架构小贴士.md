...
<br>
<div class="blockcode"><div id="code_p5Q"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_p5Q'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_EFF"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_EFF'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Mhz"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Mhz'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Ku2'));">复制代码</em></div><br>
