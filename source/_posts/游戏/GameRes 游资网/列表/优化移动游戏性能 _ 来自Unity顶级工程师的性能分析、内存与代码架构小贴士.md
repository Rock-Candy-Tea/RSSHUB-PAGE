...
<br>
<div class="blockcode"><div id="code_woD"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_woD'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Sbi"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Sbi'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Y2q"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Y2q'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ZdZ'));">复制代码</em></div><br>
