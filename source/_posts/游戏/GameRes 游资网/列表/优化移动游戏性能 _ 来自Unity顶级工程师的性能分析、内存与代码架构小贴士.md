...
<br>
<div class="blockcode"><div id="code_wLe"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_wLe'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_REu"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_REu'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_gB0"><ol><li>void Update()<br>
</li><li>&#123;<br>
</li><li>    Renderer myRenderer = GetComponent<Renderer>();<br>
</li><li>    ExampleFunction(myRenderer);<br>
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_gB0'));">复制代码</em></div><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_gcc'));">复制代码</em></div><br>
