...
<br>
<div class="blockcode"><div id="code_DO4"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_DO4'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Pao"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Pao'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_p1z"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_p1z'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_JoD'));">复制代码</em></div><br>
