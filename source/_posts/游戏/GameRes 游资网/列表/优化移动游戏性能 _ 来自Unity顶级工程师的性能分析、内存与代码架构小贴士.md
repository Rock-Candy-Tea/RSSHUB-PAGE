...
<br>
<div class="blockcode"><div id="code_ndf"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ndf'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_EUd"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_EUd'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_ApD"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ApD'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_TQd'));">复制代码</em></div><br>
