...
<br>
<div class="blockcode"><div id="code_El2"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_El2'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_jN5"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_jN5'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_PDJ"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_PDJ'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_iEY'));">复制代码</em></div><br>
