...
<br>
<div class="blockcode"><div id="code_RGH"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_RGH'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_EUb"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_EUb'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_b8G"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_b8G'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ec4'));">复制代码</em></div><br>
