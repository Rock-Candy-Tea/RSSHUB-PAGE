...
<br>
<div class="blockcode"><div id="code_a8b"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_a8b'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_JSB"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_JSB'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_B0b"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_B0b'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_yY9'));">复制代码</em></div><br>
