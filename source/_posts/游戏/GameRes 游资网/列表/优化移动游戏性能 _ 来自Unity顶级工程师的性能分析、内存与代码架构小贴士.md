...
<br>
<div class="blockcode"><div id="code_B7P"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_B7P'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_a3P"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_a3P'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Gff"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Gff'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_fUL'));">复制代码</em></div><br>
