...
<br>
<div class="blockcode"><div id="code_dzI"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_dzI'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_oIf"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_oIf'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_DbY"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_DbY'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_CTC'));">复制代码</em></div><br>
