...
<br>
<div class="blockcode"><div id="code_eRh"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_eRh'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_NPp"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_NPp'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Eas"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Eas'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_h7n'));">复制代码</em></div><br>
