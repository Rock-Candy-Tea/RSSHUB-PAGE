...
<br>
<div class="blockcode"><div id="code_u9Z"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_u9Z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_B82"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_B82'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_nZk"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nZk'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_y2v'));">复制代码</em></div><br>
