...
<br>
<div class="blockcode"><div id="code_E2w"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_E2w'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_AZW"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_AZW'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_z36"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_z36'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_g22'));">复制代码</em></div><br>
