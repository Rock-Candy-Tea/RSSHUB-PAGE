...
<br>
<div class="blockcode"><div id="code_pQd"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_pQd'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_xkk"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xkk'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_m2W'));">复制代码</em></div><br>
