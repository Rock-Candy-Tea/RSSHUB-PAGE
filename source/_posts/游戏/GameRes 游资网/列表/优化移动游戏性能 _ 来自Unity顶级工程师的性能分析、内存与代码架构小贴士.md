...
<br>
<div class="blockcode"><div id="code_C7a"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_C7a'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_pxw"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_pxw'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Cl2"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Cl2'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_tJL'));">复制代码</em></div><br>
