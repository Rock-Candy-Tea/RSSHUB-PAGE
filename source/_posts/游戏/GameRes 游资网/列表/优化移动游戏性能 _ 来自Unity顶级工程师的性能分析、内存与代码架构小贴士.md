...
<br>
<div class="blockcode"><div id="code_MDc"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_MDc'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Io9"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Io9'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_C14"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_C14'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Opj'));">复制代码</em></div><br>
