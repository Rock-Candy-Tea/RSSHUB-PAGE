...
<br>
<div class="blockcode"><div id="code_eJ1"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_eJ1'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_N3Q"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_N3Q'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_nT3"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nT3'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_vFy'));">复制代码</em></div><br>
