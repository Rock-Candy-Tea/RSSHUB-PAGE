...
<br>
<div class="blockcode"><div id="code_D1s"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_D1s'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_y8P"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_y8P'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_s8u"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_s8u'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Nua'));">复制代码</em></div><br>
