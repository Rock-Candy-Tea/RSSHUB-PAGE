...
<br>
<div class="blockcode"><div id="code_yZz"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_yZz'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_MX8"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_MX8'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_bzn"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bzn'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_ttJ'));">复制代码</em></div><br>
