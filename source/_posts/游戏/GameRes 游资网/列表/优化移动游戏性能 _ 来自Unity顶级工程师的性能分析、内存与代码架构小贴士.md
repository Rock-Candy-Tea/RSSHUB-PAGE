...
<br>
<div class="blockcode"><div id="code_bNB"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_bNB'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_N2i"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_N2i'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_L1q"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_L1q'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Ad6'));">复制代码</em></div><br>
