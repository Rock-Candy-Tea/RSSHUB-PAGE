...
<br>
<div class="blockcode"><div id="code_w7Z"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_w7Z'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_oGl"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_oGl'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_nxR"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_nxR'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Oqf'));">复制代码</em></div><br>
