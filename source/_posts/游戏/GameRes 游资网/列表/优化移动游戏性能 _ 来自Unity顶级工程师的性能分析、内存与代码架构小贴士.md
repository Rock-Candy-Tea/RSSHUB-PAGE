...
<br>
<div class="blockcode"><div id="code_l0q"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_l0q'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_B7Q"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_B7Q'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Kcu"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Kcu'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_GVq'));">复制代码</em></div><br>
