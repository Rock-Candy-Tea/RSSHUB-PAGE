...
<br>
<div class="blockcode"><div id="code_n5m"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_n5m'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Bug"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_Bug'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_Ri0"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_Ri0'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_xI4'));">复制代码</em></div><br>
