...
<p><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/83113be9ae644641b60b3d5264f562b2~tplv-k3u1fbpfcp-watermark.image" alt="image.png" loading="lazy" referrerpolicy="no-referrer"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5a9779fb3f734673969bc67ca8cb95a5~tplv-k3u1fbpfcp-watermark.image" alt="image.png" loading="lazy" referrerpolicy="no-referrer"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b66bd46864e7467da20e48faba21fbb4~tplv-k3u1fbpfcp-zoom-1.image" alt="图片" loading="lazy" referrerpolicy="no-referrer"></p>
...
<p>1.为什么要拆分？假设我们的query数量量级为<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/43257e797b194f92a4fe313d2e65c865~tplv-k3u1fbpfcp-zoom-1.image" alt="图片" loading="lazy" referrerpolicy="no-referrer">，那么最差情况下，我们需要进⾏<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b6057636a04648839c1eb101109e34eb~tplv-k3u1fbpfcp-zoom-1.image" alt="图片" loading="lazy" referrerpolicy="no-referrer">次相似度计算，才能完成⽂本聚类；然⽽，如果我们将数据进⾏拆分，并且以较⾼的概率保证拆分互斥，<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8269a1f0ebfe4a13bd7b0951edc4907f~tplv-k3u1fbpfcp-zoom-1.image" alt="图片" loading="lazy" referrerpolicy="no-referrer">，那么只需要进⾏<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0288e2acb6a8400e878e19dc1936d7f9~tplv-k3u1fbpfcp-zoom-1.image" alt="图片" loading="lazy" referrerpolicy="no-referrer">次相似度计算，量级是远⼩于的<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/47fab14264514c77858abad3a943d9a7~tplv-k3u1fbpfcp-zoom-1.image" alt="图片" loading="lazy" referrerpolicy="no-referrer">；</p>
...
<p><img src="https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/98263a522bfd4b5b91d08e9b191775cd~tplv-k3u1fbpfcp-watermark.image" alt="image.png" loading="lazy" referrerpolicy="no-referrer"></p>
