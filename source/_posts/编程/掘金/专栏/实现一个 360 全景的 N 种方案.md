...
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/91454c1c84fe4feeaba1fc185a9476f5~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
...
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a013f30cc1fd456498dd0d0d41e2a8d4~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
...
&#125;
<span class="copy-code-btn">复制代码</span></code></pre>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1912dd89a8ed459fa7049d867b0d5976~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
<li>
<p>旋转各面，使“三对”面互相垂直，达到如下效果</p>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b624060a4a744efea03ef03cc51356ed~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p>结果如下图</p>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5184abd27ac34d80b6b48e5f549b688f~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
<li>
<p>貌似看不出怎么变换的？我们将以上重合的两个面的旋转角度稍微调整下，就可以更直观地看出效果：</p>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/64a9bb571b6f40078c46b9cab6cc0236~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
<li>
<p>各面继续向两侧位移</p>
<pre><code class="hljs language-css copyable" lang="css"><span class="hljs-selector-class">.cube__face--front</span> &#123;
...
&#125;
<span class="copy-code-btn">复制代码</span></code></pre>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/92bb7c0946d046a39fc8bf3a22fedd69~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
<p>整个过程可用下图表示：</p>
<p><img alt="1.gif" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6f38794287b249af96e8ee99f5dd9a33~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
<p>最终效果：</p>
<p><img alt="3.gif" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/404b79d0218c4144bf17375cff666cfe~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
<li>
<p>通过调整容器样式的 perspective 属性值，将视角放置在立方体中。将每个面的尺寸放大，添加上全景图切出的 6 面图，添加上鼠标事件，便可实现 360 全景效果。</p>
<p><img alt="4.gif" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6485c0ac311b4b1cb7c6c9148d0c40ee~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
<p>扫码看效果：</p>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/92c2b9eee5e64666bedbb18ea4ab62f3~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
</ol>
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p><img alt="444.gif" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/18999202550a4f0c94825eb4f559e041~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
<li>
<p>将立方体的纹理颜色换成图片纹理：</p>
...
<span class="hljs-keyword">const</span> skyBox = <span class="hljs-keyword">new</span> THREE.Mesh(geometry, material);
<span class="copy-code-btn">复制代码</span></code></pre>
<p><img alt="555.gif" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bc68a0a20dac49579c4260a9eae53edf~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
<li>
...
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bf55b26cf8834fc98da100f3b4a02e02~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
<pre><code class="hljs language-javascript copyable" lang="javascript"><span class="hljs-keyword">const</span> geometry = <span class="hljs-keyword">new</span> THREE.BoxBufferGeometry(<span class="hljs-number">1</span>, <span class="hljs-number">1</span>, <span class="hljs-number">1</span>);
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p><img alt="666.gif" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/86fd9f55e720481bb46d61bb16ba6ff1~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
<li>
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p><img alt="3333.gif" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9ac2621386b249a99ef6a8b8c549fb2a~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
<li>
<p>进一步优化体验：</p>
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p>扫码看效果：</p>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2e6052b1b1b84ea6a3812e06fb3c666a~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
</li>
</ol>
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p>扫码看效果：</p>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ac98fb129eec46c9962e11cb12c1b092~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p>扫码看效果：</p>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f1565f2b708645ab9564d946464835ca~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
<h3 data-id="heading-4">球型投影</h3>
<p>以上的实现全部是利用立方体实现的，除此之外，我们还可以使用圆柱体投影的方式，three.js 和 pannellum 都支持这种方式。
<img alt="O1CN01djW9bE1h1QprTMP5d_!!6000000004217-0-hotel.jpeg" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a3269ed76f084abebf4c634d1d6b5db6~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer">
three.js 中：</p>
...
&#125;);
<span class="copy-code-btn">复制代码</span></code></pre>
<p><img alt="5.gif" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/59493fc617bd4e358cd077f8d7e1c95b~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p>扫码看效果：</p>
<p><img alt="image.png" class="lazyload" src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/52406890e2ec4a938d8c0cca37324093~tplv-k3u1fbpfcp-zoom-1.image" data-width="800" data-height="600" referrerpolicy="no-referrer"></p>
