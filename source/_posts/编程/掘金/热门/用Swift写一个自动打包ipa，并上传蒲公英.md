...
<pre><code class="hljs language-swift copyable" lang="swift"> <span class="hljs-comment">// pod install</span>
    ...
    &#125;
<span class="copy-code-btn">复制代码</span></code></pre>
<h3 data-id="heading-10">最后附上 <a href="https://github.com/aaaaa893215155/SwiftCommandLineTool.git" target="_blank" rel="nofollow noopener noreferrer">项目地址</a></h3></div>  
</div>
