...
<p>这次轮播图我使用了第三方库——<a href="https://github.com/WenchaoD/FSPagerView" target="_blank" rel="nofollow noopener noreferrer">FSPagerView</a>。如果有人使用过FSCalendar，应该应该就有印象了，没错就是那位写日历大佬写的轮播组件。</p>
