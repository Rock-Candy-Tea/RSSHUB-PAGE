...
---
title: '2021-07-08 Webpack集成React和TypeScript的两种方案'
categories: 
 - 编程
 - 掘金
 - 分类
...
author: 掘金
comments: false
date: Thu, 08 Jul 2021 04:16:55 GMT
...
<p>由于Webpack只支持解析js和json文件，对于React中JSX和ts文件不支持，这时候就要用到loader整个强大的转换器功能了，这里有两种方法一种是使用ts-loader将ts和tsx解析成js文件；另外一种是使用babel-loader+@babel/preset-typesrcipt</p>
</blockquote>
<h3 data-id="heading-0">初始化项目</h3>
<pre><code class="hljs language-bash copyable" lang="bash">mkdir webpack-react-ts
<span class="hljs-built_in">cd</span> webpack-react-ts

yarn init -y
<span class="copy-code-btn">复制代码</span></code></pre>
<h3 data-id="heading-1">安装依赖</h3>
<p>这里的依赖主要有react、react-dom以及他们对应的@types/react、@types/react-dom等还有webpack相关的依赖</p>
<pre><code class="hljs language-bash copyable" lang="bash">yarn add react @types/react react-dom @types/react-dom
yarn add webpack@4.43.0 webpack-cli@3.3.12 webpack-dev-server@3.11.0 -D
<span class="copy-code-btn">复制代码</span></code></pre>
<h3 data-id="heading-2">配置webpack.config.js文件</h3>
<p>测试文件：</p>
<pre><code class="hljs language-js copyable" lang="js"><span class="hljs-comment">// index.tsx</span>

<span class="hljs-keyword">import</span> ReactDOM <span class="hljs-keyword">from</span> <span class="hljs-string">"react-dom"</span>;
<span class="hljs-keyword">import</span> React <span class="hljs-keyword">from</span> <span class="hljs-string">"react"</span>; <span class="hljs-comment">// 这个地方有区别下文提到</span>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">App</span>(<span class="hljs-params"></span>) </span>&#123;
  <span class="hljs-keyword">return</span> (
    <span class="xml"><span class="hljs-tag"><<span class="hljs-name">div</span>></span>
      ...
      <span class="hljs-tag"><<span class="hljs-name">Hello</span> <span class="hljs-attr">name</span>=<span class="hljs-string">"小徐"</span> <span class="hljs-attr">age</span>=<span class="hljs-string">&#123;26&#125;</span> /></span>
    <span class="hljs-tag"></<span class="hljs-name">div</span>></span></span>
  );
&#125;
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> App;

<span class="hljs-comment">// Hello.tsx</span>
...
interface HelloProps &#123;
  ...
  age: number;
&#125;
<span class="hljs-keyword">const</span> Hello: React.FC<HelloProps> = <span class="hljs-function">(<span class="hljs-params">props: HelloProps</span>) =></span> &#123;
  useEffect(<span class="hljs-function">() =></span> &#123;&#125;, []);
  <span class="hljs-keyword">const</span> changeName = <span class="hljs-function">() =></span> &#123;
    <span class="hljs-built_in">console</span>.log(props.name);
  &#125;;
  <span class="hljs-keyword">return</span> (
    <span class="xml"><span class="hljs-tag"><<span class="hljs-name">div</span>></span>
      <span class="hljs-tag"><<span class="hljs-name">p</span>></span>姓名：&#123;props.name&#125;<span class="hljs-tag"></<span class="hljs-name">p</span>></span>
      <span class="hljs-tag"><<span class="hljs-name">p</span>></span>年龄：&#123;props.age&#125;<span class="hljs-tag"></<span class="hljs-name">p</span>></span>
      <span class="hljs-tag"><<span class="hljs-name">button</span> <span class="hljs-attr">onClick</span>=<span class="hljs-string">&#123;changeName&#125;</span>></span>改变姓名<span class="hljs-tag"></<span class="hljs-name">button</span>></span>
    <span class="hljs-tag"></<span class="hljs-name">div</span>></span></span>
  );
&#125;;
...
<span class="hljs-keyword">const</span> &#123; HotModuleReplacementPlugin &#125; = <span class="hljs-built_in">require</span>(<span class="hljs-string">"webpack"</span>);
...
<span class="copy-code-btn">复制代码</span></code></pre>
<h3 data-id="heading-3">方法一：使用ts-loader解析ts和tsx文件</h3>
<p>安装ts-loader要注意和webpack的版本，这里webpack4对应的ts-loader@8，不用安装与babel相关的loader了</p>
<pre><code class="hljs language-bash copyable" lang="bash">yarn add ts-loader@8 -D 
<span class="copy-code-btn">复制代码</span></code></pre>
<p>这里不需要在引入<code>import React from "react"</code></p>
<p>webpack.config.js配置文件里修改loader</p>
...
&#125;
<span class="copy-code-btn">复制代码</span></code></pre>
<h3 data-id="heading-4">方法二：继续使用babel-loader+预设@babel/preset-typescript</h3>
<p>配置<code>.babelrc</code>文件如下：</p>
<pre><code class="hljs language-js copyable" lang="js">&#123;
...
<span class="copy-code-btn">复制代码</span></code></pre>
<p>安装babel相关loader</p>
<pre><code class="hljs language-bash copyable" lang="bash">yarn add @babel/core @babel/preset-env babel-loader @babel/preset-react @babel/preset-typescript -D
<span class="copy-code-btn">复制代码</span></code></pre>
<p>需要在引入<code>import React from "react"</code></p>
<p>webpack.config.js配置文件里修改loader</p>
<pre><code class="hljs language-js copyable" lang="js"><span class="hljs-built_in">module</span>: &#123;
    <span class="hljs-attr">rules</span>: [
      &#123;
  ...
  &#125;,
<span class="copy-code-btn">复制代码</span></code></pre>
<p>启动<code>npx webpack-dev-server</code>就可以看到页面了</p></div>  
</div>
