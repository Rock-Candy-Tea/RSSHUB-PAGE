...
<span class="copy-code-btn">复制代码</span></code></pre>
<h2 data-id="heading-1">自定义属性版 推荐指数 ****</h2>
<pre><code class="copyable"><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<span class="copy-code-btn">复制代码</span></code></pre>
<h2 data-id="heading-2">利用闭包的机制去解决【自执行函数】  推荐指数 **</h2>
...
<script>
<span class="copy-code-btn">复制代码</span></code></pre>
<h2 data-id="heading-3">利用闭包的机制去解决【return函数】  推荐指数 **</h2>
<p>每次for循环，就给li绑定一个点击事件，并且点击的事件的值是return里面的小函数，形成了不销毁的上下文
当我们点击li的时候，里面的小函数就会执行，变量i就是自执行函数里面的私有变量i</p>
<pre><code class="copyable"><script>
   var tabList = document.querySelectorAll(".tabox .tab>li"),
       conList = document.querySelectorAll(".tabox .content>div");
   var prevIndex = 0;
...
<script>
<span class="copy-code-btn">复制代码</span></code></pre>
<h2 data-id="heading-4">利用闭包的机制去解决【forEach】  推荐指数 **</h2>
<pre><code class="copyable"><script>   
        var tabList = document.querySelectorAll(".tabox .tab>li"),
        conList = document.querySelectorAll(".tabox .content>div");
        var prevIndex = 0;
...
<script>
<span class="copy-code-btn">复制代码</span></code></pre>
<h2 data-id="heading-5">利用【let】去解决  推荐指数 ***</h2>
<pre><code class="copyable">let 出现在&#123;&#125;中会生成一个父级块级私有上下文和 每轮循环生成一个块级私有上下文
<script>
    var tabList = document.querySelectorAll(".tabox .tab>li"),
        conList = document.querySelectorAll(".tabox .content>div");
        let prevIndex = 0;
