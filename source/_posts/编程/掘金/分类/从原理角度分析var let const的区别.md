...
<span class="copy-code-btn">复制代码</span></code></pre>
<p>2.2 严格来讲，使用let声明变量时也会发生变量提升的现象，但由于存在“暂时性死区”，不能在声明之前使用let变量。因此，从写JavaScript的角度说，let的提升和var的提升是不一样的。</p>
</li>
<li>
<p>const常量声明</p>
