...
categories: 
 ...
 - 掘金
 - 分类
headimg: 'https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e678fa3f0007421e9daaa7d5fbb20cac~tplv-k3u1fbpfcp-watermark.image'
author: 掘金
comments: false
date: Sat, 24 Apr 2021 18:53:40 GMT
thumbnail: 'https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e678fa3f0007421e9daaa7d5fbb20cac~tplv-k3u1fbpfcp-watermark.image'
---
...
<span class="hljs-keyword">export</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">callHook</span> (<span class="hljs-params">vm: Component, hook: string</span>) </span>&#123;
  <span class="hljs-comment">// 在执行生命周期钩子函数期间禁止依赖收集</span>
...
<h1 data-id="heading-13">学习交流群</h1>
<p>刚建了一个微信学习交流群，大家感兴趣的可以扫码加入，供平时学习、交流讨论。</p>
<img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e678fa3f0007421e9daaa7d5fbb20cac~tplv-k3u1fbpfcp-watermark.image" width="200px" loading="lazy" referrerpolicy="no-referrer"></div>  
</div>
