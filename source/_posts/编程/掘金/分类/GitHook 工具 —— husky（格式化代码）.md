...
<ol>
<li>团队开发，每个人编辑器不同，编码方式不同，导致代码格式不同，代码难看，难以维护</li>
...
<p>代码规范能够很好地提升编码效率，提升团队的代码维护性，并且对后续代码扩展有着良好效果。因此，在编码过程中需要考虑代码扩展性和维护性，代码规范是不可缺少的。</p></div> <div class="image-viewer-box" data-v-78c9b824><!----></div>  
</div>
