...
---
title: 'LeetCode 18 4Sum (Tag_Array Difficulty_Medium)'
categories: 
 - 编程
 - 掘金
 - 分类
...
输出：[[-2,-1,1,2],[-2,0,0,2],[-1,0,0,1]]</p>
<p>示例 2：<br>
输入：nums = [], target = 0<br>
输出：[]</p>
<p>链接：<a href="https://link.juejin.cn/?target=https%3A%2F%2Fleetcode-cn.com%2Fproblems%2F4sum" target="_blank" rel="nofollow noopener noreferrer" title="https://leetcode-cn.com/problems/4sum" ref="nofollow noopener noreferrer">leetcode-cn.com/problems/4s…</a></p>
<h2 data-id="heading-2">题解</h2>
<ol>
<li>暴力解法，四层循环，并去重，时间复杂度为 O(n4)</li>
<li>双层循环后加双指针减少时间复杂度，同时事先排序，用于去重，见代码，时间复杂度 O(n³)</li>
</ol>
...
<span class="hljs-keyword">var</span> fourSum = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">nums, target</span>) </span>&#123;
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span> ; i < n - <span class="hljs-number">3</span>; ++i) &#123;
      <span class="hljs-keyword">if</span> (i > <span class="hljs-number">0</span> && nums[i] === nums[i-<span class="hljs-number">1</span>]) <span class="hljs-keyword">continue</span>  <span class="hljs-comment">// 去重</span>
      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> j = i + <span class="hljs-number">1</span>; j < n - <span class="hljs-number">2</span>; ++j) &#123;
        <span class="hljs-keyword">if</span> (j > i + <span class="hljs-number">1</span> && nums[j] === nums[j-<span class="hljs-number">1</span>]) <span class="hljs-keyword">continue</span> <span class="hljs-comment">// 去重</span>
        <span class="hljs-keyword">let</span> l = j + <span class="hljs-number">1</span>
        <span class="hljs-keyword">let</span> r = n - <span class="hljs-number">1</span>
        <span class="hljs-keyword">const</span> leave = target - nums[i] - nums[j]
        <span class="hljs-keyword">while</span> (l < r) &#123;
          <span class="hljs-keyword">if</span> (nums[l] + nums[r] === leave) &#123;
            res.push([nums[i], nums[j], nums[l], nums[r]])
            <span class="hljs-keyword">while</span> (l < r && nums[l] === nums[l+<span class="hljs-number">1</span>]) ++l <span class="hljs-comment">// 去重</span>
            <span class="hljs-keyword">while</span> (l < r && nums[r] === nums[r-<span class="hljs-number">1</span>]) --r <span class="hljs-comment">// 去重</span>
            ++l
            --r
          &#125; <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (nums[l] + nums[r] > leave) &#123;
            --r
