...
---
title: 'Komodor 想让每个工程师都成为 Kubernetes 专家'
categories: 
 - 编程
 - Dockone
 - 周报
...
<br>Komodor 的首席执行官 Ben Ofiri 说：“一旦企业开始采用 Kubernetes，他们都面临着相同的挑战和问题。Kubernetes 是一个非常复杂的，分散的系统，由数千个不同的组件共同构成的系统。” 。<br>
<br>当事故发生时，工程师团队将面临很大的压力，需要尽快找出问题的原因并解决问题。但问题在于，大多数工程师都没有接受过处理此类问题的充分培训。<br>
<br>Komodor 希望通过软件来帮助更多的工程师解决 Kubernetes 故障。Ofiri 解释说：“ Komodor 所做的是将企业中只有少数人掌握的 Kubernetes 的操作和故障排除方面的专业知识，展示给企业中其他 95% 的人”<br>
<br>这包括检测、调查和补救。"我们在 Komodor 所做的是利用不同的数据驱动方法和基于规则引擎的模型，以便识别不同的问题，找到问题的根本原因，然后给出解决方案。”<br>
