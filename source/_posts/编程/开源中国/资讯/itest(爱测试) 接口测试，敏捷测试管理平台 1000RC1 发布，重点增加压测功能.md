...
---
title: 'itest(爱测试) 接口测试，敏捷测试管理平台 10.0.0RC1 发布，重点增加压测功能'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 17 Jun 2021 07:59:00 GMT
...
<div class="content">
 ...
 <p><strong>v10.0.0 RC1下载地址 </strong>：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2F120.78.0.137%2Frsf%2Fsite%2Fitest%2Fdownload%2Findex.html" target="_blank">itest下载</a></p> 
 <p><strong>二：10.0.0 RC1 更新说明</strong></p> 
 <p>10.0.0 RC1  相经 9.5.0 <strong>GA</strong>_u4<strong>  共 47个更新</strong>，<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fwww.itest.work%2Fitest%2Fversion%2FversionUpdate" target="_blank">查看版本更新历史</a>  <strong>户的持续反馈是我们不断更新的动力。</strong></p> 
 <p><strong>10.0.0RC1,主要增加压测功能，接口测试场景，支持数据驱动，接口测试修复几个重要BUG。</strong></p> 
 <p><strong><strong>10.0.0 RC1 相对于10.0.0  M1 更新如下:</strong></strong></p> 
 <div>
  <strong>9个增强：</strong>
 </div> 
 <strong>1：</strong>压测功能，节点管理优化。
 <br> 
 <strong>2：</strong>压测结果 CSV可web 查看。
 <br> 
 <strong>3: </strong> 压测，在线生成JMX 优化。
 <br> 
 <strong>4: </strong> 压测，slave 执行JMX 优线。
 <br> 
 <strong>5：</strong>接口场景窗口自适应高。
</div> 
<div>
 <strong>6：</strong>建测试需求项时，可有一和父节点同名的子节点 。
</div> 
<div>
 <strong>7：</strong>bug处理及用例管理，增加session 保持9小时，只要页面不关闭，自动保持session 9小时。
</div> 
<div>
 <strong>8：</strong>接口测试场景，增加数据驱动支持。
</div> 
<div>
 <strong>9：</strong>手动写断言时，不再和之前最后一次请求且断言通过的响应数据做比对校验语法。 
 <div> 
  <p><strong>7个bug修复:</strong></p> 
  <p><strong>1：</strong>接口测试场景中，测试完成后，接口被执行了，但是场景中显示为未测试。</p> 
  <p><strong>2：</strong>接口测试场景，下载定时执行日志在容器中路径不对，导致报错。</p> 
  <p><strong>3：</strong>接口测试场景，日志列表无日志，实际是有日志的。</p> 
  <p><strong>4：</strong>接口测试双击接口名称，弹出两个接口的窗口。</p> 
  <p><strong>5：</strong>接口测试，有时第2次及时进入接口拖拽设置断言时，左边的树不显示响应内容。</p> 
  <p><strong>6：</strong>接口测试，拖拽生成断言时，如响应数据中有数组，拖拽后生成的jsonpath 不对。</p> 
  <p><strong>7：</strong>在产品用例库拖拉节点后，再导入到项目中时，用例所属节点错乱。</p> 
  ...
  <p> </p> 
  <p> </p> 
  <p><strong><img alt src="https://img2020.cnblogs.com/blog/261867/202106/261867-20210616230019281-310767195.png" referrerpolicy="no-referrer"></strong></p> 
  <p> </p> 
  <p> </p> 
