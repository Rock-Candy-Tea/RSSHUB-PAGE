...
---
title: '云办公系统 skyeye v3.7.19 发布，CRM 模块以及手机端'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sat, 09 Jul 2022 03:24:00 GMT
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><span style="color:#333333">云办公系统 skyeye v3.7.19</span><span style="color:#333333"><span> </span>发布</span><span style="color:#333333"> ，</span>更新内容如下：</p> 
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【CRM】删除客户分类功能，迁移至系统数据字典</strong></pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【CRM】删除跟单分类功能，迁移至系统数据字典</strong></pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【CRM】删除客户所属行业功能，迁移至系统数据字典</strong></pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【CRM】删除商机来源功能，迁移至系统数据字典</strong></pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【CRM】删除客户分组功能，迁移至系统数据字典</strong></pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【CRM】删除客户来源功能，迁移至系统数据字典</strong></pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【EHR】删除员工信息数据字典功能</strong>
</pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【前台框架】ajax工具调整，删除全局冗余代码</strong></pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【工作计划】功能调整，删除无用代码</strong></pre> </li> 
 <li> <pre style="margin-left:0; margin-right:0"><strong>【手机端】手机端开始研发，完成工作台以及架构搭建</strong></pre> </li> 
</ul> 
