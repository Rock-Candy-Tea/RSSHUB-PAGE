...
---
title: '国产异步非阻塞通信框架 smart-socket 1.5.18 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 13 Jun 2022 09:23:00 GMT
...
<ol style="list-style-type:decimal; margin-left:0; margin-right:0"> 
 <li> <p style="margin-left:0; margin-right:0">修复读写IO递归并发回调场景下可能引发的空指针问题。</p> </li> 
 <li> <p style="margin-left:0; margin-right:0">移除示例程序中的fastjson依赖</p> </li> 
 <li> <p style="margin-left:0; margin-right:0">升级 slf4j 版本至 1.7.36</p> </li> 
</ol> 
