...
---
title: 'EasyGoAdmin 敏捷开发框架 Iris+Layui 版本 v1.0.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
headimg: 'https://oscimg.oschina.net/oscnet/up-1532444e88a33a6c206adf466dcb479bade.png'
author: 开源中国
comments: false
date: Mon, 09 May 2022 08:50:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-1532444e88a33a6c206adf466dcb479bade.png'
---
...
<h2>📚 项目介绍</h2> 
<p>一款 Go 语言基于Iris、Layui、MySQL等框架精心打造的一款模块化、高性能、企业级的敏捷开发框架，本着简化开发、提升开发效率的初衷触发，框架自研了一套个性化的组件，实现了可插拔的组件式开发方式：单图上传、多图上传、下拉选择、开关按钮、单选按钮、多选按钮、图片裁剪等等一系列个性化、轻量级的组件，是一款真正意义上实现组件化开发的敏捷开发框架。</p> 
<h2>🍻 项目特点</h2> 
<ul> 
 <li>模块化、松耦合</li> 
 <li>模块丰富、开箱即用</li> 
...
<ul> 
 ...
 <li>文档网址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fdocs.iris.layui.easygoadmin.vip" target="_blank">文档地址</a></li> 
</ul> 
<h2>🎨 系统演示</h2> 
<ul> 
 <li>演示地址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fmanage.iris.layui.easygoadmin.vip" target="_blank">点击查看演示环境</a></li> 
</ul> 
<table> 
 <thead> 
  <tr> 
...
<h2>🔧 模块展示</h2> 
<p><img alt height="1048" src="https://oscimg.oschina.net/oscnet/up-1532444e88a33a6c206adf466dcb479bade.png" width="1920" referrerpolicy="no-referrer"></p> 
<p><img alt height="1080" src="https://oscimg.oschina.net/oscnet/up-e262de6ccc7959fb249d9f8fb8ad5975c48.png" width="1920" referrerpolicy="no-referrer"></p>
                                        </div>
