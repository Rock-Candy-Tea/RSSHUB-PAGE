...
---
title: 'DBShop 商城系统 V3.1 Release 211202 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">新增 七牛云存储插件</li> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">修正 后台优惠促销帮助按钮的链接</li> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">优化 数据库连接模式</li> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">优化 后台商品列表加入商品数量显示</li> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">优化 提示信息</li> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">优化 更换帮助地址</li> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">优化 后台选择规格图片，只能选择切换类型的图片</li> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">优化 商品详情规格切换变为ajax局部刷新</li> 
 <li style="color: rgb(51, 51, 51); margin-left: 0px; margin-right: 0px; text-align: start;">优化 后台商品规格生成提示</li> 
</ul> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:start"><strong>下载地址：<a href="https://www.oschina.net/action/GoToLink?url=%20https://download.loongdom.com.cn/dbshop/V3.1/DBShopV3.1_Release211202.tar.gz" target="_blank"><span> </span>https://download.loongdom.com.cn/dbshop/V3.1/DBShopV3.1_Release211202.tar.gz</a></strong></p> 
<p> </p>
                                        </div>
