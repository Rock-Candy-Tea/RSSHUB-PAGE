...
---
title: 'smart-doc 2.4.3 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 18 Apr 2022 12:01:00 GMT
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left">1. 支持生成openapi时不生成请求和返回用例，#233。<br> 2. 优化对map返回结构的解析，#223。<br> 3. 修复生成openapi的时候对contentType的处理转义，#232。<br> 4. 修改分组归档处理bug, #226。</p> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"> smart-doc 可基于以前的版本平滑升级，本次对map返回文档做了一些优化，建议升级。</p> 
