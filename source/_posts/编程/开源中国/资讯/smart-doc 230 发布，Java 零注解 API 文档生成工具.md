...
---
title: 'smart-doc 2.3.0 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 09 Nov 2021 01:56:00 GMT
...
<ul> 
 <li> 修复创建html文档丢失search.js文件问题。</li> 
 <li> 修复packageFilters配置多个包时只有第一个生效的问题。</li> 
 <li> 修复debug调试页面的curl指令错误。</li> 
 <li> 修复设置了下载文件接口加download标记后，数据并未生效的bug。</li> 
 <li> 优化一些部分常见字段的随机值生成。</li> 
</ul> 
