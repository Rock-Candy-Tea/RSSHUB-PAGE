...
---
title: 'JavaWeb 敏捷开发框架 Layui 版本 v1.0.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
headimg: 'https://oscimg.oschina.net/oscnet/up-047cc3b8f91a974dcf08153de9d985fc85a.png'
author: 开源中国
comments: false
date: Thu, 19 May 2022 09:14:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-047cc3b8f91a974dcf08153de9d985fc85a.png'
---

<div>   
<div class="content">
                                                                    
                                                        <p>v1.0.0更新内容：<br> 1、基于SpringBoot2.x、Layui搭建核心框架；<br> 2、编写框架核心组件，包括图片上传、日期、开关、选择单选、复选框、单选按钮、图片裁剪、富文本等等核心组件；<br> 3、编写基于权限RBAC架构的核心代码；<br> 4、抒写权限架构相关基础模块；</p> 
<h2>项目介绍</h2> 
...
<h2>开发者信息</h2> 
<ul> 
 <li>系统名称：JavaWeb敏捷开发框架Layui版本</li> 
 <li>软件作者：@鲲鹏</li> 
 ...
 <li>文档网址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fdocs.javaweb.vip" target="_blank">文档地址</a></li> 
</ul> 
<h2>系统演示</h2> 
<p>演示地址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fmanage.layui.javaweb.vip" target="_blank">点击查看演示环境</a></p> 
<table> 
 <thead> 
  <tr> 
   <th>账号</th> 
...
<h2>模块UI</h2> 
<p><img alt height="1080" src="https://oscimg.oschina.net/oscnet/up-047cc3b8f91a974dcf08153de9d985fc85a.png" width="1920" referrerpolicy="no-referrer"></p>
                                        </div>
