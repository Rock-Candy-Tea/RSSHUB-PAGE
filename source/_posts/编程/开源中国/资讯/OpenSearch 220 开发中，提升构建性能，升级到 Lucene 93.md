...
---
title: 'OpenSearch 2.2.0 开发中，提升构建性能，升级到 Lucene 9.3'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div>   
<div class="content">
                                                                                            <p>AWS OpenSearch 2.2.0 已经在开发中，<span style="background-color:#ffffff; color:#333333">OpenSearch 是 AWS 自 Elasticsearch 7.10.2 的开源搜索和分析引擎。</span></p> 
<p>该版本改进内容包括：</p> 
