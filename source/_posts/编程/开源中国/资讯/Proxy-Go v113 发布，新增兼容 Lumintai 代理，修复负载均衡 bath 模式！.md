...
---
title: 'Proxy-Go v11.3 发布，新增兼容 Lumintai 代理，修复负载均衡 bath 模式！'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 29 Nov 2021 06:35:00 GMT
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><span style="background-color:#ffffff; color:#24292f">1.增加了对Luminati的特殊转换支持，现在可以把Luminati的http代理转成http(s)+socks5代理对外二次控制咯。</span><br> <span style="background-color:#ffffff; color:#24292f">2.修复一处错误信息格式不对的问题。</span><br> <span style="background-color:#ffffff; color:#24292f">3.修复了负载均衡bath模式的一些问题</span></p> 
<p style="color:#333333; margin-left:0; margin-right:0; text-align:start">更新：<br> v10.7及以后版本，执行：<code>proxy update</code>，即可完成快速更新到最新版。</p> 
