...
---
title: 'RXThinkCMF_AVTP6 v2.0.0 旗舰版发布，元旦新版本重构'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div>   
<div class="content">
                                                                                            <p>v2.0.0 更新内容：<br> 1、后端服务采用ThinkPhp6.x，架构做全新升级，新版本采用多应用架构设计模式；<br> 2、后端服务器整体架构做了重构和升级，增强了稳定性和扩展性；<br> 3、代码生成器做了重构升级，支持生成常规表单和组件；<br> 4、重写代码生成器自定义模板，优化了模板结构和元素；<br> 5、前端系统整体重构升级，新增了一系列诸多功能；<br> 6、新增多语言切换的功能，英文、中文和简体中文等等；<br> 7、重新设计系统登录页背景图；</p> 
<div> 
 <div> 
  <h2>📚 项目介绍</h2> 
