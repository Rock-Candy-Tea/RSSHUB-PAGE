...
---
title: 'Java 进程管理、调试平台 Jarboot v1.1.2 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sat, 13 Nov 2021 09:17:00 GMT
...
<div class="content">
                                                                                            <p>本次更新修复了大量已知的问题。</p> 
<p>可通过Gitee和GitHub下载最新的安装包，使用Docker的请更新下Jarboot的Docker镜像。</p> 
...
<p>更新内容：</p> 
<ul> 
 <li>修复VM options编辑界面偶尔出现的显示异常问题</li> 
 <li>修复JDK 11及以上版本，在线调试无法Attach自己的问题</li> 
 <li>修复当服务列表为空或者未选中服务时，点击上传按钮界面崩掉的问题</li> 
 <li>修复提交服务配置时，400错误的问题</li> 
</ul> 
<p> </p>
                                        </div>
