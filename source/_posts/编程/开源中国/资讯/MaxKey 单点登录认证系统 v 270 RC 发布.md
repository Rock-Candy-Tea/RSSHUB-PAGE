...
---
title: 'MaxKey 单点登录认证系统 v 2.7.0 RC 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 29 Mar 2021 09:41:00 GMT
...
<p style="text-align:left">QQ交流群：<strong>434469201</strong></p> 
...
<p style="text-align:left">代码托管 <a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2Fdromara%2FMaxKey" target="_blank"><strong>GitHub</strong></a> | <a href="https://gitee.com/dromara/MaxKey" target="_blank"><strong>码云(Gitee)</strong></a></p> 
...
<table cellspacing="0" style="width:835px"> 
 ...
 <tbody> 
  <tr> 
   <td style="border-color:#dfe2e5">v 2.6.0 GA</td> 
   <td style="border-color:#dfe2e5">2021/03/05</td> 
   <td style="border-color:#dfe2e5"><a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fpan.baidu.com%2Fs%2F1q5hzNeWweu4cpVOO-VopIw" target="_blank">链接下载</a></td> 
   <td style="border-color:#dfe2e5"><strong>0x24</strong></td> 
  </tr> 
 </tbody> 
</table> 
<h1>Roadmap</h1> 
...
<h2>版本说明</h2> 
<p><span style="background-color:#ffffff; color:#24292e">MaxKey v 2.7.0 GA    2021/03/27<br>     *(MAXKEY-210301)  加入Dromara开源组织，官方网站的优化，文档优化<br>     *(MAXKEY-210302)  BootJar，Docker，Standard三种打包方式的配置优化<br>     *(MAXKEY-210303)  openldap,activedirectory密码验证支持<br>     *(MAXKEY-210304)  数据库访问注释由@Service改为<a href="https://my.oschina.net/u/3055569" target="_blank">@Repository</a><br>     *(MAXKEY-210305)  cas logout优化支持<br>     *(MAXKEY-210306)  CAS单点注销及返回数据类型适配器的优化<br>     *(MAXKEY-210307)  CAS返回数据类重构<br>     *(MAXKEY-210308)  ExtendApi标准优化<br>     *(MAXKEY-210309)  增加基于时间签名的ExtendApi适配器<br>     *(MAXKEY-210310)  返回数据Constants整合<br>     *(MAXKEY-210311)  扩展数据配置优化<br>     *(MAXKEY-210312)  LDAP和MS AD固定属性Constants<br>     *(MAXKEY-210313)  SpringSecurity OAuth 2客户端登录适配<br>     *(MAXKEY-210314)  移除Desktop的支持，后续可以开发FormBase的适配器定制<br>     *(MAXKEY-210315)  application.properties profiles的优化，不同环境启动更加简单<br>     *(MAXKEY-210316)  删除maxkey.properties，配置整合到 application.properties<br>     *(MAXKEY-210317)  增加适配器注册功能，在配置应用时只需选择对应的适配器<br>     *(MAXKEY-210318)  增加Synchronizer接口同步的功能<br>     *(MAXKEY-210319)  增加TimeBased OTP接口支持<br>     *(MAXKEY-210320)  XSS安全防护功能<br>     *(MAXKEY-210321)  禅道项目管理系统单点登录适配<br>     *(MAXKEY-210322)  GitLab单点登录适配<br>     *(MAXKEY-210323)  云速邮箱单点登录适配<br>     *(MAXKEY-210324)  JumpServer开源堡垒机单点登录适配<br>     *(MAXKEY-210325)  华为云单点登录适配<br>     *(MAXKEY-210326)  Jenkins单点登录适配<br>     *(MAXKEY-210227)  通知公告简单功能实现<br>     *(MAXKEY-210228)  查询参数优化<br>     *(MAXKEY-210229)  依赖jar引用、更新和升级<br>         log4j         2.14.1<br>         spring        5.3.5<br>         springBoot  2.4.4<br>         tomcat        9.0.44</span></p>
                                        </div>
