...
---
title: 'novel-plus v3.5.2发布，原创文学 CMS 系统'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 ...
 <li style="text-align:justify">[优化]修改404页面自动跳转时间</li> 
 <li style="text-align:justify">[优化]修改作家专区跳转方式</li> 
 <li style="text-align:justify">[优化]使用图片懒加载提高网站加载速度</li> 
 <li style="text-align:justify">[优化]图片压缩提高加载速度</li> 
</ul> 
...
<div style="text-align:start"> 
 <div> 
  <pre style="text-align:left">novel-plus <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 父工程</span></span></span></span></span>
├── novel-common <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 通用模块</span></span></span></span></span>
├── novel-front <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 前台门户&作家后台管理子系统（可拆分）</span></span></span></span></span>
├── novel-crawl <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 爬虫管理子系统</span></span></span></span></span>
├── novel-admin <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 平台后台管理子系统</span></span></span></span></span>
└── templates <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 前端模版</span></span></span></span></span></pre> 
 </div> 
</div> 
...
<p><span style="color:#000000">Gitee仓库地址：https://gitee.com/novel_dev_team/novel-plus</span></p> 
