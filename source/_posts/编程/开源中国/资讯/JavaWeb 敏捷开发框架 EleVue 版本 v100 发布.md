...
---
title: 'JavaWeb 敏捷开发框架 EleVue 版本 v1.0.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
headimg: 'https://oscimg.oschina.net/oscnet/up-fe173cc0f2194d468661389735513585b84.png'
author: 开源中国
comments: false
date: Mon, 23 May 2022 02:12:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-fe173cc0f2194d468661389735513585b84.png'
---

<div>   
<div class="content">
                                                                    
                                                        <p>v1.0.0 更新内容：<br> 1、基于 SpringBoot2.x、Vue、ElementUI 搭建核心框架；<br> 2、搭建后端服务架构，采用前后端分离多模块的架构设计模式；<br> 3、编写底层工具类库，如Excel导出、短信、邮件等等；<br> 4、编写项目底层基类，包括控制器、模型、服务类、Dto、Vo等等；<br> 5、编写系统权限架构代码，包括用户、角色、菜单等等；</p> 
<h2>项目介绍</h2> 
...
<h2>系统演示</h2> 
<p>演示地址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fmanage.vue.pro.javaweb.vip" target="_blank">点击查看演示地址</a></p> 
<table> 
 <thead> 
  <tr> 
   <th>账号</th> 
...
<h2>模块展示</h2> 
<p><img alt height="1080" src="https://oscimg.oschina.net/oscnet/up-fe173cc0f2194d468661389735513585b84.png" width="1920" referrerpolicy="no-referrer"></p>
                                        </div>
