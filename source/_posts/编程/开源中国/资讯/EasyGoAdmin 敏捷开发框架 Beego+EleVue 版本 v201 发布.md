...
---
title: 'EasyGoAdmin 敏捷开发框架 Beego+EleVue 版本 v2.0.1 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 27 Jun 2022 08:55:00 GMT
...
<div class="content">
                                                                                            <div> 
 <div> 
  <p>v2.0.1 更新内容：<br> 1、优化系统路由配置文件，实行模块路由分组；<br> 2、优化模块变量名，规范变量名和方法名；<br> 3、修复近期用户使用过程中反馈的 BUG；</p> 
  <h2>项目介绍</h2> 
  ...
  <h2>软件信息</h2> 
  <ul> 
   <li>软件名称：EasyGoAdmin敏捷开发框架Beego+EleVue版本</li> 
...
<span>|<span><span>-- conf</span></span></span>
<span>|   `<span><span>-- app.conf</span></span></span>
<span>|<span><span>-- controllers</span></span></span>
<span>|   `<span><span>-- default.go</span></span></span>
<span>|<span><span>-- main.go</span></span></span>
<span>|<span><span>-- models</span></span></span>
<span>|<span><span>-- routers</span></span></span>
<span>|   `<span><span>-- router.go</span></span></span>
<span>|<span><span>-- static</span></span></span>
<span>|   |<span><span>-- css</span></span></span>
<span>|   |<span><span>-- img</span></span></span>
<span>|   `<span><span>-- js</span></span></span>
<span>|<span><span>-- tests</span></span></span>
<span>|   `<span><span>-- default_test.go</span></span></span>
<span>`<span><span>-- views</span></span></span>
<span>    `<span><span>-- index.tpl</span></span></span></pre> 
   </div> 
  </div> 
  <div> 
   <h2>路由注册</h2> 
