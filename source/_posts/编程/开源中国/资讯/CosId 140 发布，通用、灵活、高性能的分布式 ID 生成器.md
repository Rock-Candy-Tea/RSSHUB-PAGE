...
---
title: 'CosId 1.4.0 发布，通用、灵活、高性能的分布式 ID 生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 06 Dec 2021 07:21:00 GMT
...
<h2 style="margin-left:0; margin-right:0; text-align:left">更新内容（v1.4.0） 🎉 🎉 🎉</h2> 
<ul> 
 <li>增强：添加<span> </span><a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2FAhoo-Wang%2FCosId%2Ftree%2Fmain%2Fcosid-shardingsphere" target="_blank">cosid-shardingsphere</a><span> </span>模块<span> </span><code>CosIdKeyGenerateAlgorithm</code><span> </span>支持<span> </span><code>org.apache.shardingsphere.sharding.spi.KeyGenerateAlgorithm</code></li> 
</ul> 
<blockquote> 
 <p style="margin-left:12px; margin-right:0">Kotlin DSL</p> 
</blockquote> 
<pre style="text-align:left"><code>    implementation("me.ahoo.cosid:cosid-shardingsphere:$&#123;cosidVersion&#125;")
</code></pre> 
<pre style="text-align:left"><code>spring:
  shardingsphere:
    rules:
      sharding:
        key-generators:
...
<h3 style="margin-left:0; margin-right:0; text-align:left">CosIdKeyGenerateAlgorithm (shardingsphere-分布式主键)</h3> 
<blockquote> 
 <p style="margin-left:0; margin-right:0">Kotlin DSL</p> 
</blockquote> 
<div style="text-align:left"> 
