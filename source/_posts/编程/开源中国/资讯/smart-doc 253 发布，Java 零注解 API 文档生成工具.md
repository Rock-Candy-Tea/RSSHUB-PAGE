...
---
title: 'smart-doc 2.5.3 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 14 Sep 2022 09:41:00 GMT
...
<pre><span style="color:#cc7832">1. </span>jsr<span>校验注解支持常量替换，</span><span style="color:#287bde">[#334]</span>(<em>https://github.com/smart-doc-group/smart-doc/issues/334</em>)
<span style="color:#cc7832">2. 使用@see指向非枚举类错误</span><span>，</span><span style="color:#287bde">[#340]</span>(<em>https://github.com/smart-doc-group/smart-doc/issues/340</em>)
</pre> 
<p> </p> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"> smart-doc 可基于以前的版本平滑升级。建议用新的版本</p> 
