...
---
title: 'EasyTrans 1.2.6 发布，Mybatis Plus 多表关联外键翻译组件'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 <li>字典翻译缓存支持放到redis中</li> 
 <li>添加使用map的实现类包装vo 进行翻译(比如ruoyi的AjaxResult)</li> 
</ul> 
...
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 ...
 <li>  跨微服务翻译   比如 order 集合 user 是 2 个微服务，但是 order 要展示创建人姓名，表里只有 id  可以使用跨微服务翻译</li> 
