...
---
title: 'Sa-Token v1.21.1 更新，最全单点登录框架'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 08 Jul 2021 01:27:00 GMT
...
<p style="text-align:left">Sa-Token v1.21.1  版本更新包括以下内容：</p> 
<ul> 
 <li style="text-align:left">新增：SaSsoConfig 部分属性增加set连缀风格 </li> 
 <li style="text-align:left">新增：新增 `SaSsoHandle` 大幅度简化单点登录整合步骤 </li> 
 <li style="text-align:left">优化：大幅度优化文档示例 </li> 
</ul> 
...
<p style="text-align:left"><img alt height="1838" src="https://color-test.oss-cn-qingdao.aliyuncs.com/sa-token/x/sa-token-js2.png" width="3464" referrerpolicy="no-referrer"></p>
                                        </div>
