...
---
title: 'go-carbon 1.5.1 版本发布， 修复已知 bug 和新增土耳其翻译文件'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 <li>修复EndOfCentury()逻辑错误</li> 
 <li>规范代码注释格式</li> 
 <li>规范单元测试格式</li> 
 <li>优化错误提示文案</li> 
 <li>单元测试覆盖率提升到100%</li> 
 <li>新增土耳其语翻译文件lang/tr.json，由 <a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2Femresenyuva" target="_blank">emresenyuva</a> 翻译</li> 
</ul>
                                        </div>
