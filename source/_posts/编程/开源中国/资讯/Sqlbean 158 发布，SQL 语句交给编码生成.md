...
---
title: 'Sqlbean 1.5.8 发布，SQL 语句交给编码生成'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<span><version>1.5.8</version></span>
...
<p>本次更新内容：</p> 
<p>1：修复@SqlJoin连表查询指定查询字段失效问题；<br> 2：修改获取全部字段的顺序，父类字段显示在前面；<br> 3：修复只有一个小写字母时驼峰转下划线失效问题；<br> 4：修复连表查询VO类没有标识注解或继承类时导致的问题；<br> 5：修复如果有连表查询时自动生成的where条件没有生成全名导致异常的问题；<br> 6：修复其他内容；</p>
                                        </div>
