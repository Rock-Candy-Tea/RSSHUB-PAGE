...
---
title: 'PHP 开源工作流引擎 Tpflow V5.0.6 正式版发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 27 Apr 2021 07:28:00 GMT
...
<div class="content">
 ...
 <div style="text-align:left"> 
  ...
  <h2 style="text-align:start">欢迎使用 Tpflow V5.0.6 工作流引擎</h2> 
  ...
  <p style="text-align:left"><span style="color:#525252">这次版本主要是向上兼容，上个版本在开启PHP强模式后，出现不少BUG，我们紧急修复了，并全面兼容了PHP8.0版本，建议更新。</span></p> 
  ...
  <h3 style="text-align:start"><strong>关于5.0.6版本更新内容</strong></h3> 
  <ul> 
   <li><span style="background-color:#ffffff; color:#333333">【兼容】Thinkphp6.0.8最新版；</span></li> 
   <li><span style="background-color:#ffffff; color:#333333">【优化】支持PHP8.0版本；</span></li> 
   ...
   <li><span style="background-color:#ffffff; color:#333333">【完善】统一消息返回接口处理</span><span style="background-color:#ffffff; color:#333333">；</span></li> 
   <li><span style="background-color:#ffffff; color:#333333">【调整】全局代码优化，格式化整理</span></li> 
   <li><span style="background-color:#ffffff; color:#333333">【新增】消息接口 msg_api</span></li> 
  </ul> 
  <p style="text-align:left"><span style="color:#e74c3c"><strong>官方全新出品整合Tpflow5.0.4 Gadmin 3.0企业级低代码开发平台</strong></span></p> 
...
<div style="text-align:start"> 
 <div> 
  ...
  <div> 
   <ul> 
    <li>Tpflow 的详细介绍：<a href="https://www.oschina.net/p/tpflow" target="_blank">点击查看</a></li> 
    <li>Tpflow 的下载地址：<a href="https://gitee.com/ntdgg/tpflow" target="_blank">点击下载</a></li> 
   </ul> 
  </div> 
 </div> 
</div>
