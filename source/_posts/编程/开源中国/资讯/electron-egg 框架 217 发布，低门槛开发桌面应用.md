...
---
title: 'electron-egg 框架 2.1.7 发布，低门槛开发桌面应用'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 02 Aug 2022 10:39:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-910a330c702bcede62e6ad78526d2e34276.png'
---

<div>   
<div class="content">
                                                                                            <p style="color:#333333; margin-left:0; margin-right:0; text-align:center"><img src="https://oscimg.oschina.net/oscnet/up-910a330c702bcede62e6ad78526d2e34276.png" referrerpolicy="no-referrer"></p> 
...
<div style="text-align:left"> 
 <ol> 
  <li>增加ssl，支持https</li> 
  <li>优化http服务的路由写法</li> 
  <li>优化utils部分函数 && 修复错误。</li> 
  <li>优化http返回状态码</li> 
  <li>去除ee-core中延迟加载功能</li> 
  <li>去除ee-core中无效代码</li> 
 </ol> 
</div> 
...
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 <li> <p style="margin-left:0; margin-right:0">windows 平台</p> <p><img height="986" src="https://oscimg.oschina.net/oscnet/up-2a139cc82c2ee95161e0255761c62f8cd91.png" width="1468" referrerpolicy="no-referrer"></p> </li> 
