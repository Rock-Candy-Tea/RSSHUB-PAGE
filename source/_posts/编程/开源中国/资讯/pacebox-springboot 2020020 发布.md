...
---
title: 'pacebox-springboot 2020.0.2.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<p style="text-align:left"><strong>代码调整</strong></p> 
<pre style="text-align:left">代码格式化使用方式</pre> 
<p style="text-align:left"><strong>组件更新</strong></p> 
<pre style="text-align:left">1：<span style="color:#d73a49">spring</span> <span style="color:#d73a49">cloud</span> 2020<span style="color:#6f42c1">.0</span><span style="color:#6f42c1">.1</span>升级到2020<span style="color:#6f42c1">.0</span><span style="color:#6f42c1">.2</span> 
2：<span style="color:#d73a49">spring</span> <span style="color:#d73a49">boot</span> 2<span style="color:#6f42c1">.4</span><span style="color:#6f42c1">.3</span>升级到2<span style="color:#6f42c1">.4</span><span style="color:#6f42c1">.5</span>  
3：<span style="color:#d73a49">pacebox-sms </span>1<span style="color:#6f42c1">.0</span><span style="color:#6f42c1">.0</span>升级到1<span style="color:#6f42c1">.0</span><span style="color:#6f42c1">.1</span>   </pre>
                                        </div>
