...
---
title: 'PHP 开源工作流引擎 Tpflow V5.0.8 正式版发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<h2 style="text-align:start">欢迎使用 Tpflow V5.0.8 工作流引擎</h2> 
...
<p style="text-align:left"><span style="color:#525252">本次更新主要更新的是协同工作模式=>详细可以看 <a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fwww.cojz8.com%2Farticle%2F172" target="_blank">协同模式的解释</a></span></p> 
...
<h3 style="text-align:start"><strong>关于5.0.7版本更新内容</strong></h3> 
<ul> 
 <li><span style="background-color:#ffffff; color:#333333">【修复】修复取消流程错误；</span></li> 
 <li><span style="background-color:#ffffff; color:#333333">【优化】对表名优化支持；</span></li> 
 <li><span style="background-color:#ffffff; color:#333333">【新增】</span><span style="color:inherit">优化界面设计</span><span style="background-color:#ffffff; color:#333333">；</span></li> 
 <li><span style="background-color:#ffffff; color:#333333">【完善】保存布局，SFDP多参数支持</span><span style="background-color:#ffffff; color:#333333">；</span></li> 
 <li><span style="background-color:#ffffff; color:#333333">【调整】过滤表名未_bak</span></li> 
 <li><span style="background-color:#ffffff; color:#333333">【新增】表名支持</span></li> 
</ul> 
