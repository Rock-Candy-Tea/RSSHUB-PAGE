...
author: 开源中国
comments: false
date: Wed, 31 Mar 2021 07:25:00 GMT
...
<ul> 
 ...
 <li>Bugfix: 修复当与 gRPC 后端搭配使用时，可能出现"upstream sent response body larger than indicated content length"错误。这个问题出现在 1.19.1 中</li> 
