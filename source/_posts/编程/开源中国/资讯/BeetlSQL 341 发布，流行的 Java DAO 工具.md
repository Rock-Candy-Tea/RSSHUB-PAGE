...
---
title: 'BeetlSQL 3.4.1 发布，流行的 Java DAO 工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 19 May 2021 22:38:00 GMT
...
<div class="content">
                                                        ...
                                                        <p>本次发布做了微调</p> 
<ul> 
 <li>修复内置Update语句表名没有经过KeywordHandler处理</li> 
 <li>删除了sql-spring集成对spring-test的依赖</li> 
</ul> 
...
<p> </p> 
<p style="text-align:left">BeetlSQL 研发自2015年，目标是提供开发高效，维护高效，运行高效的数据库访问框架，它适用范围广，定制性强，写起数据库访问代码特别顺滑。目前支持的数据库如下</p> 
<ul> 
