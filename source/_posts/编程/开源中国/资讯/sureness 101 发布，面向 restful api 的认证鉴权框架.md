...
---
title: 'sureness 1.0.1 发布，面向 restful api 的认证鉴权框架'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 29 Mar 2021 21:38:00 GMT
...
<ul> 
 <li>支持xss，sql注解防护过滤</li> 
 <li>支持忽略url请求类型匹配，即用 <strong>* </strong>作请求类型(get post delete put....)全匹配</li> 
 <li>文档更新，样例更新，sample-tom完善api样例</li> 
</ul> 
<p><strong>BugFix    </strong></p> 
<p>no security module in sureness-core the latest version bug #75 </p> 
