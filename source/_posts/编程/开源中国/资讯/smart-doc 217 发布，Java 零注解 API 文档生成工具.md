...
---
title: 'smart-doc 2.1.7 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 13 May 2021 09:31:00 GMT
...
<pre style="text-align:left">1<span style="color:#032f62"><span style="color:#032f62">.</span></span> 添加推送接口作者信息到torna数据错误的bug。
2<span style="color:#032f62"><span style="color:#032f62">.</span></span> <span style="color:#032f62">修复空参数curl命令多余？号问题，github 。</span>
</pre> 
