...
---
title: 'Restful Fast Request 2.1.1 发布，基于 IDEA 的 Postman 插件'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 10 Jan 2022 23:51:00 GMT
...
<h3 style="margin-left:0; margin-right:0; text-align:left">Restful Fast Request 2.1.1正式发布,具体更新内容如下：</h3> 
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 <li>SearchEveryWhere支持</li> 
 <li>增加一个最新按钮可以随时查看最新版本</li> 
 <li>优化枚举的解析</li> 
 <li>增加对http重定向的支持</li> 
</ul> 
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><strong>1.SearchEveryWhere support</strong></p> 
<pre style="margin-left:.85rem; margin-right:.85rem; text-align:left"><code>输入案例
/url              (查询指定url)
get /list         (指定get方式指定url)
post /save        (指定post方式指定url)
</code></pre> 
<p><img alt src="https://oscimg.oschina.net/oscnet/up-62cab059bfc658c0dbd7f8df43cfb6330a2.gif" referrerpolicy="no-referrer"></p> 
<p> </p> 
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><strong>2.最新版本快速查看</strong></p> 
<p><img height="450" src="https://oscimg.oschina.net/oscnet/up-1ce799adafedf034af925749107ed83964f.png" width="1032" referrerpolicy="no-referrer"></p> 
<p> </p> 
