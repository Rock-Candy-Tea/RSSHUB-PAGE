...
---
title: 'Android Studio Bumblebee Canary 3 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sat, 10 Jul 2021 07:03:00 GMT
...
<div class="content">
                                                        ...
                                                        <p>Android Studio Bumblebee Canary 3 现已发布，此次更新主要修复了以下问题。</p> 
<ul> 
 <li>Android Gradle 插件 
  <ul> 
   <li>采用默认 res 支持 (false) 的测试装置仍然有 resvalue 生成的文件夹</li> 
   <li>在 gradle-api 中需要一个 Version 接口</li> 
   <li>AGP 4.2.0 会生成缺少类的测试 APK，可能是由混合的 java/kotlin 源代码集所致</li> 
 ...
 <li>Wear 与 Google 助理配对 
  <ul> 
   <li>无法从 IJ 启动 Wear 与 Google 助理的配对</li> 
  </ul> </li> 
</ul> 
<p>详情请查看<a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fandroidstudio.googleblog.com%2F2021%2F07%2Fandroid-studio-bumblebee-canary-3.html" target="_blank">更新公告</a>。</p>
                                        </div>
