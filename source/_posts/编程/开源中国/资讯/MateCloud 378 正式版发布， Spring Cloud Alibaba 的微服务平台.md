...
---
title: 'MateCloud 3.7.8 正式版发布， Spring Cloud Alibaba 的微服务平台'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sat, 19 Jun 2021 15:05:00 GMT
...
<ul> 
 <li>#32 优化mate-starter-lock分布式锁的bug @aaronuu</li> 
 <li>新增自定义验证框架 @aaronuu</li> 
 <li>#I3UFXE 修复消息消费多个的bug @madi</li> 
</ul> 
<h3 style="text-align:left">1.2、依赖升级</h3> 
<ul> 
 <li>升级至RocketMQ 4.9.0</li> 
 <li>升级至 Seata 1.4.2</li> 
 <li>升级至Mybatis Plus 3.4.3.1</li> 
 <li>升级至elasticsearch 7.13.2</li> 
</ul> 
