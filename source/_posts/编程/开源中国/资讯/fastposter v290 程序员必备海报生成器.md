...
---
title: 'fastposter v2.9.0 程序员必备海报生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 15 Jul 2022 09:05:00 GMT
...
<div class="content">
                                                        ...
                                                        <h2>fastposter v2.9.0 程序员必备海报生成器</h2> 
...
<p>现已服务众多电商类项⽬，多个项⽬有<code>49W+</code>⽤户，通过多年⽣产环境的考验，稳定可靠。广泛应用于各类电商、分销系统、电商海报、电商主图等海报生成和制作场景。</p> 
<h3>社区版 v2.9.0 发布</h3> 
<ul> 
 <li>支持在同一个海报中存在相同名称的参数</li> 
 <li>升级依赖 <code>requests==2.28.1</code></li> 
 <li>完善开发文档</li> 
</ul> 
<h3>专业版 v2.0.10 发布</h3> 
<ul> 
 <li>批量生成海报功能 
  <ul> 
   <li>选择海报 > 下载模板 > 导入数据(excel) > 生成海报 > 打包下载</li> 
   <li>支持文件类型选择 <code>jpeg</code> <code>png</code> <code>pdf</code></li> 
  </ul> </li> 
 <li>增加画布透明背景效果图层</li> 
 <li>调整默认文本组件 
  <ul> 
   <li>添加文本时，设置好默认字体</li> 
   <li>对于不自动换行的文本，支持动态改变文本字体大小</li> 
  </ul> </li> 
 <li>优化isEmpty组件</li> 
 <li>同一个海报支持重复的参数</li> 
 <li>解决海报背景色设置，透明度小于0.03无法正常回显的问题</li> 
 <li>解决拖拽组件unactive后无法立即激活问题</li> 
</ul> 
<h3>相关地址</h3> 
<ul> 
 ...
 <li>在线演示：<a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fposter.prodapi.cn%2F%23from%3Dpush-v2.9.0" target="_blank">https://poster.prodapi.cn/</a></li> 
 <li>专业版Python在线演示：<a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fposter.prodapi.cn%2Fpro%2F%23from%3Dpush-v2.9.0" target="_blank">https://poster.prodapi.cn/pro/</a></li> 
 <li>专业版Java在线演示：<a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fposter.prodapi.cn%2Fpro%2Fjava%2F%23from%3Dpush-v2.9.0" target="_blank">https://poster.prodapi.cn/pro/java/</a></li> 
</ul> 
<h3>只需三步，即可完成海报开发</h3> 
<h4>一、启动服务</h4> 
