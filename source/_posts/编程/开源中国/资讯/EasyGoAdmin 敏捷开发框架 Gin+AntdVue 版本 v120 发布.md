...
---
title: 'EasyGoAdmin 敏捷开发框架 Gin+AntdVue 版本 v1.2.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 18 Jul 2022 15:20:00 GMT
...
<h2>软件信息</h2> 
<ul> 
 <li>软件名称：EasyGoAdmin 敏捷开发框架 Gin+AntdVue 版本</li> 
 <li>官网网址：<a href="https://gitee.com/link?target=http%3A%2F%2Fwww.easygoadmin.vip">http://www.easygoadmin.vip</a></li> 
 <li>文档网址：<a href="https://gitee.com/link?target=http%3A%2F%2Fdocs.gin.antdvue.easygoadmin.vip">http://docs.gin.antdvue.easygoadmin.vip</a></li> 
</ul> 
<h2>系统演示</h2> 
<ul> 
 <li>演示地址：<a href="https://gitee.com/link?target=http%3A%2F%2Fmanage.gin.antdvue.easygoadmin.vip">http://manage.gin.antdvue.easygoadmin.vip</a></li> 
</ul> 
<h2>版本说明</h2> 
<table> 
 <thead> 
...
<span>│   ├── dto         <span>// DTO层</span></span>
<span>│   ├── middleware  <span>// 中间件层</span></span>
<span>│   ├── model       <span>// 模型层</span></span>
<span>│   └── service     <span>// 服务层</span></span>
<span>│   └── vo          <span>// VO视图层</span></span>
<span>├── boot</span>
...
<span>├── templates       <span>// 自定义模板</span></span>
<span>├── utils           <span>// 工具类库</span></span>
...
<h2>特别鸣谢</h2> 
<p>感谢<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fgin-gonic.com" target="_blank">Gin</a>、<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fxorm.io" target="_blank">Xorm</a>、<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fcn.vuejs.org" target="_blank">Vue</a>、<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2F2x.antdv.com%2Fdocs%2Fvue%2Fintroduce-cn%2F" target="_blank">AntDesign</a>等优秀开源项目。</p>
                                        </div>
