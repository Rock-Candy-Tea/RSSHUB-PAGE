...
---
title: 'CosId 1.3.9 发布，通用、灵活、高性能的分布式 ID 生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<h2 style="text-align:left">更新内容（1.3.9） 🎉 🎉 🎉</h2> 
<ul> 
 <li>增强： 新增 <strong>CosIdAnnotationSupport </strong>，支持基于<code>@CosId</code>注解的ID自动注入。 
  <ul> 
   <li> <pre style="text-align:start"><code>@Target(&#123;ElementType.FIELD&#125;)
@Documented
@Retention(RetentionPolicy.RUNTIME)
<strong>public</strong> @interface CosId &#123;
    String <strong>value</strong>() <strong>default</strong> IdGeneratorProvider.SHARE;

    <strong>boolean</strong> <strong>friendlyId</strong>() <strong>default</strong> <strong>false</strong>;
&#125;
</code></pre> <pre style="text-align:start"><code><strong>public</strong> <strong>class</strong> <strong>Entity</strong> &#123;

    @CosId
    <strong>private</strong> <strong>long</strong> id;

    @CosId
    <strong>private</strong> String stringId;

    @CosId(friendlyId = <strong>true</strong>)
    <strong>private</strong> String friendlyId;

    @CosId(value = <span style="color:#dd1144">"bizC"</span>)
    <strong>private</strong> <strong>long</strong> bizId;
...
&#125;
   ...
   <li> <pre style="text-align:start">cosIdAnnotationSupport<span style="color:var(--color-prettylights-syntax-keyword)">.</span>ensureId(entity);</pre> </li> 
  </ul> </li> 
 <li>增强： 新增 <strong>CosIdPlugin</strong> (cosid-mybatis) ，支持通过注解的方式自动注入分布式ID。 
  <ul> 
   <li> <pre style="text-align:start"><code>@Mapper
<strong>public</strong> <strong>interface</strong> <strong>EntityRepository</strong> &#123;
    @Insert(<span style="color:#dd1144">"insert into t_entity (id,string_id,friendly_id,biz_id) value (#&#123;id&#125;,#&#123;stringId&#125;,#&#123;friendlyId&#125;,#&#123;bizId&#125;);"</span>)
    <strong>void</strong> <strong>insert</strong>(Entity entity);

    @Insert(&#123;
            <span style="color:#dd1144">"<script>"</span>,
            <span style="color:#dd1144">"insert into t_entity</span><span style="color:#dd1144"> (id,string_id,friendly_id,biz_id)"</span>,
            <span style="color:#dd1144">"VALUES"</span> +
                    <span style="color:#dd1144">"<foreach item='item' collection='list' open='' separator=',' close=''>"</span> +
                    <span style="color:#dd1144">"(#&#123;item.id&#125;,#&#123;item.stringId&#125;,#&#123;item.friendlyId&#125;,#&#123;item.bizId&#125;)"</span> +
                    <span style="color:#dd1144">"</foreach>"</span>,
            <span style="color:#dd1144">"</script>"</span>&#125;)
    <strong>void</strong> <strong>insertList</strong>(List<Entity> entityList);
&#125;
</code></pre> <pre style="text-align:start"><code>        Entity entity=<strong>new</strong> Entity();
         ...
         * &#125;
         */
        <strong>return</strong> entity;</code></pre> </li> 
  </ul> </li> 
</ul> 
...
<table cellspacing="0" style="width:1142px"> 
 <thead> 
  <tr> 
   <th>分布式ID</th> 
   <th>全局唯一性</th> 
