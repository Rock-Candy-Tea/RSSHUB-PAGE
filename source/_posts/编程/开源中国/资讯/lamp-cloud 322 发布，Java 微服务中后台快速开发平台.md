...
---
title: 'lamp-cloud 3.2.2 发布，Java 微服务中后台快速开发平台'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 26 May 2021 08:21:00 GMT
...
<div class="content">
                                                        ...
                                                        <h1 style="text-align:left"><a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fwww.kancloud.cn%2Fzuihou%2Fzuihou-admin-cloud%2F1465302" target="_blank">3.2.2 版本更新详情:</a></h1> 
<ul> 
 <li>fix(core):  枚举值传""和 null时报错的bug</li> 
 <li>fix(lamp-file): 修复附件下载报错</li> 
 <li>fix(lamp-generator): 修复代码生成器生成树型页面重复字段的问题</li> 
 <li>refactor(boot): 优化PoiController，导出和导出预览功能，使得子类更容易重写导出数据</li> 
 <li>refactor(authority): 完善用户、岗位管理导入、导出功能， 支持下载模板、导出预览、直接导出</li> 
 <li>refactor: 组织名、岗位名、用户账号唯一性校验</li> 
 <li>feat(lamp-web-plus): 完善组织、岗位、用户模块页面的CRUD功能，并优化导入、导出组件</li> 
 <li>feat(lamp-samples): 新增示例项目，提供常见用法的示例。（如： None模式多数据源配置、分布式事务解决方案、缓存使用、数据回显、前后端统一验证等） </li> 
</ul> 
<p>    </p> 
