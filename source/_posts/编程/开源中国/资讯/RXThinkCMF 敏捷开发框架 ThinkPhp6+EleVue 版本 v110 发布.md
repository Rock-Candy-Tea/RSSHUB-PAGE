...
---
title: 'RXThinkCMF 敏捷开发框架 ThinkPhp6+EleVue 版本 v1.1.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 27 May 2022 13:21:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-adacb6d0d3eb392dd7b206d2598e2394a09.png'
---

<div>   
<div class="content">
                                                                                            <p>v1.1.0 更新内容：<br> 1、新增CMS模块富文本图文处理功能；<br> 2、新增动态匹配富文本图文处理正则匹配工具；<br> 3、新增CMS图集文章发布功能，编写支持多图上传的Vue组件；</p> 
<h2>项目介绍</h2> 
