...
---
title: 'RXThinkCMF 敏捷开发框架 ThinkPhp6.x+EleVue 版本 v1.3.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 09 Jun 2022 09:11:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-adacb6d0d3eb392dd7b206d2598e2394a09.png'
---

<div>   
<div class="content">
                                                                                            <p>v1.3.0 更新内容：<br> 1、解决用户编辑页日期有时显示异常的问题；<br> 2、完善字典管理模块，拆分为字典表和字典项表；<br> 3、修复近期用户反馈的BUG；</p> 
<h2>项目介绍</h2> 
