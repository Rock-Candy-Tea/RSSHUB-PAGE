...
---
title: 'Jeepay 1.6.0 发布：聚合支付增加转账接口（微信零钱入账和支付宝转账）'
categories: 
 - 编程
 - 开源中国
 - 资讯
