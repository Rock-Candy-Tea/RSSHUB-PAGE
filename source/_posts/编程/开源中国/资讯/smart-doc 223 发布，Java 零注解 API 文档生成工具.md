...
---
title: 'smart-doc 2.2.3 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 19 Jul 2021 01:49:00 GMT
...
<ul> 
 <li> 增加pathPrefix配置项用于配置上下文，引入该配置项后serverUrl仅用于配置服务器地址。</li> 
 <li>支持请求头常量设置解析。</li> 
 <li>支持使用JsonIgnoreProperties和JSONType注解去忽略多字段。</li> 
 <li>修改部分文档设置allInOneDocFileName无效的bug,#131 。</li> 
 <li> 修复dubbo rpc文档模板格式错误 #https://gitee.com/smart-doc-team/smart-doc/issues/I40ZGE .</li> 
 <li>支持配置添加拦截器中设置全局请求参数，#https://github.com/smart-doc-group/smart-doc/issues/132 .</li> 
 <li>修复部分类型mock未推送到torna的bug。</li> 
</ul> 
<h1 style="text-align:left">debug 页面效果</h1> 
