...
---
title: 'RXThinkCMF 敏捷开发框架 ThinkPhp6.x+EleVue 版本 v1.5.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 23 Jun 2022 08:48:00 GMT
...
<div class="content">
                                                                                            <div> 
 <div> 
  <p>v1.5.0 更新内容：<br> 1、新增网站配置模块，可以动态维护管理配置信息；<br> 2、新增功能节点鉴权中间件；<br> 3、修复近期用户反馈的 BUG；</p> 
  <h2>项目介绍</h2> 
