...
---
title: 'lamp-cloud 3.5.8 发布，Java 微服务 SaaS 多租户解决方案'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 20 Jan 2022 01:21:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-efe2e1b81fc35dab6f6bea8082cd6503f57.png'
---

<div>   
<div class="content">
                                                                                            <h1 style="margin-left:0; margin-right:0; text-align:left"><a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fwww.kancloud.cn%2Fzuihou%2Fzuihou-admin-cloud%2F1465302" target="_blank">3.5.8 版本更新详情:</a></h1> 
<h2>build</h2> 
<pre><code>spring-boot-admin.version>2.6.1
hutool.version>5.7.19
fastjson.version>1.2.79
lombok.version>1.18.22
caffeine.version>2.9.3</code></pre> 
<h2 style="margin-left:0px; margin-right:0px; text-align:left">refactor</h2> 
<ul> 
 <li style="text-align:left">优化feign拦截器</li> 
 <li style="text-align:left">优化注释</li> 
</ul> 
<h2 style="margin-left:0px; margin-right:0px; text-align:left">fix</h2> 
<ul> 
 <li style="text-align:left">无默认值导致查询租户数据报错</li> 
 <li style="text-align:left">字符串常量写错</li> 
</ul> 
