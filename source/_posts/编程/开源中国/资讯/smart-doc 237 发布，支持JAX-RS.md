...
---
title: 'smart-doc 2.3.7 发布，支持JAX-RS'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 18 Jan 2022 02:27:00 GMT
...
<p>1. 支持JAX-RS。Quarkus这些实现了JAX-RS规范的框架可以生成文档。<br> 2. 优化对项目文件的加载。<br> 3. 解决文件数据未获取到是数据错误的bug。</p> 
<p> </p> 
