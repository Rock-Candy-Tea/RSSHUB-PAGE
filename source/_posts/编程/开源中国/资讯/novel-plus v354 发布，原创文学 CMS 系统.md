...
---
title: 'novel-plus v3.5.4 发布，原创文学 CMS 系统'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div class="content">
                                                        ...
                                                        <p style="text-align:left">novel-plus v3.5.4发布了，主要改进包括：</p> 
<ul> 
 <li style="text-align:justify">[修复]修复前台部分接口的XSS攻击。</li> 
 <li style="text-align:justify">[优化]管理后台设置登录后才能查看Druid监控。</li> 
 <li style="text-align:justify">[修复]修复管理后台重启后会出现`Public Key Retrieval is not allowed`的错误。</li> 
</ul> 
...
<div style="text-align:start"> 
 <div> 
  <pre style="text-align:left">novel-plus <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 父工程</span></span></span></span></span></span></span>
├── novel-common <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 通用模块</span></span></span></span></span></span></span>
├── novel-front <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 前台门户&作家后台管理子系统（可拆分）</span></span></span></span></span></span></span>
├── novel-crawl <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 爬虫管理子系统</span></span></span></span></span></span></span>
├── novel-admin <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 平台后台管理子系统</span></span></span></span></span></span></span>
└── templates <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 前端模版</span></span></span></span></span></span></span></pre> 
 </div> 
</div> 
