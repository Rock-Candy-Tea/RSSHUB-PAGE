...
---
title: 'JavaWeb 敏捷开发框架 EleVue 版本 v1.2.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 27 Jun 2022 09:00:00 GMT
thumbnail: 'https://picsum.photos/400/300?random=5241'
---

<div>   
<div class="content">
                                                                                            <p>v1.2.0 更新内容：<br> 1、新增配置管理模块和系统配置模块；<br> 2、编写系统常规工具类，ExcelUtils,ZipUtils等等；<br> 3、修复近期用户反馈的问题；</p> 
<h2>项目介绍</h2> 
...
<h2>开发者信息</h2> 
<ul> 
 <li>软件名称：JavaWeb敏捷开发框架EleVue版本</li> 
