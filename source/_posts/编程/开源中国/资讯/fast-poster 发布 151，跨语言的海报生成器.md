...
---
title: 'fast-poster 发布 1.5.1，跨语言的海报生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div>   
<div class="content">
                                                                                            <h2 style="text-align:start">fastposter发布1.5.1 跨语言的海报生成器</h2> 
<p style="text-align:start">v1.5.1 更换放大缩小组件，解决右键复制、粘贴、删除操作的BUG</p> 
<blockquote> 
...
<ul> 
 <li> <p>更换放大缩小组件</p> </li> 
 <li> <p>二维码兼容任意图片（包括小程序码）</p> </li> 
</ul> 
<h3 style="text-align:start">fixbug:</h3> 
<ul> 
 <li> <p>解决右键复制、粘贴、删除操作的BUG</p> </li> 
</ul> 
...
<ul> 
 ...
 <li> <p>在线体验：<a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fposter.prodapi.cn%2F%23from%3Dv1.5.1%2Bo" target="_blank">https://poster.prodapi.cn/</a></p> </li> 
