...
---
title: 'Proxy-Go v10.7 发布，新增 update 功能，轻松升级！'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 03 Jun 2021 12:27:00 GMT
...
<ol> 
 <li style="text-align:left">使用go mod管理依赖。</li> 
 <li style="text-align:left">新增更新功能，执行`proxy update`就可以更新了，升级更加方便。还能用`proxy update -f`强制更新。</li> 
</ol> 
