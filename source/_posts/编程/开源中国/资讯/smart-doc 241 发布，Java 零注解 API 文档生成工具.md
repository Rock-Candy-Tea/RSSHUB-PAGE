...
---
title: 'smart-doc 2.4.1 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<p>  1. customResponseFields新增replaceName配置支持替换字段名。<br>   2. 修复获取非@param注释tag值错误bug。<br>   3. 支持静态常量自动解析，无需再使用apiConstants来配置。<br>   4. 修复dubbo rpc文档模板的一些格式错误。</p> 
