...
---
title: 'CotEditor 4.3.1 发布，Mac 文本编辑器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 06 Jul 2022 07:19:00 GMT
...
<p style="color:#000000; margin-left:0; margin-right:0; text-align:start">CotEditor 4.3.1 正式发布，该版本更新内容如下：</p> 
...
<ul style="margin-left:0; margin-right:0"> 
 <li>在 Text > Lines 子菜单中增加新的 Shuffle 命令</li> 
</ul> 
<h3 style="margin-left:.6em; margin-right:0; text-align:start">改进</h3> 
<ul style="margin-left:0; margin-right:0"> 
 <li>优化编辑器拆分的性能</li> 
 <li>避免大文件中增量搜索的迟缓</li> 
 <li>优化高亮显示选定文本实例的性能</li> 
 <li>移除高亮显示大量选定文本实例的限制</li> 
 <li>通过 Move Line Up/Down 的命令滚动编辑器，使移动线可见</li> 
 <li>改变文本搜索的正则表达式中元字符<span> </span><code>\\v</code><span> </span>的行为，以确认当前的 ICU 规范。</li> 
 <li>更新 Swift 语法样式，增加关键词</li> 
</ul> 
<h3 style="margin-left:.6em; margin-right:0; text-align:start">修复</h3> 
<ul style="margin-left:0; margin-right:0"> 
 <li>修复关闭文档时内存泄漏的问题</li> 
</ul> 
