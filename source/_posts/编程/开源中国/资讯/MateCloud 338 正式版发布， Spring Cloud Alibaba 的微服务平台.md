...
---
title: 'MateCloud 3.3.8 正式版发布， Spring Cloud Alibaba 的微服务平台'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 <li>修改mate-uaa swagger文档</li> 
 <li>生产环境不打印sql日志</li> 
 <li>订单消息消费者模式优化</li> 
 <li>优化RedisLockUtil Bean注入方式，解决可能Spring会初始化两次</li> 
</ul> 
<h2 style="text-align:start">依赖升级</h2> 
<ul> 
 <li>升级至Spring Boot 2.5.0</li> 
 <li>升级至Dubbo 2.7.11</li> 
 <li>升级至Spring Boot Admin 2.4.1</li> 
 <li>升级xxl-job至2.3.0版本</li> 
</ul> 
<h2>平台说明</h2> 
...
<p style="text-align:left"><img alt height="1381" src="https://static.oschina.net/uploads/space/2021/0108/094441_zv5H_2744687.jpg" width="2000" referrerpolicy="no-referrer"></p> 
...
<table cellspacing="0" style="width:634px"> 
 <tbody> 
  <tr> 
   <td style="border-color:#dfe2e5"><img height="968" src="https://oscimg.oschina.net/oscnet/up-870ac81e0d010de81d9655924d5dc6f6002.png" width="1404" referrerpolicy="no-referrer"></td> 
