...
---
title: 'smart-doc 2.2.9 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 01 Nov 2021 01:57:00 GMT
...
<ul> 
 <li>  修复生成openapi文件上传错误问题。</li> 
 <li> 修复文件上传接口推送到torna参数被放置到query参数列表的问题。</li> 
 <li> 修改List<T>类型参数推送到torna错误的问题</li> 
 <li> 优化outPath配置，只使用torna推送时可以不再要求配置outPath项。</li> 
</ul> 
...
<h1 style="margin-left:0; margin-right:0; text-align:left">maven或gradle插件</h1> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"> smart-doc 本次主要是修复了推送数据到torna的一些问题，使用torna的建议升级。</p> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left">在今年8月smart-doc也新增了一些外海的用户。</p> 
<h1 style="margin-left:0; margin-right:0; text-align:left">鸣谢</h1> 
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left">smart-doc也是利用一些开源技术构建起来的，我在这里对下列开源项目表示感谢。</p> 
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
