...
---
title: 'sqltoy-orm 4.18.8 发版，强化 Clickhouse 和 DorisDB 支持'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<p>1、<span style="color:#40485b">clickhouse支持update，并优化delete和批量delete 功能</span></p> 
<p><span style="color:#40485b">2、支持dorisdb数据库的查询、增加、删除等操作。</span></p> 
<p><span style="color:#40485b">3、配套clickhouse和dorisdb完善quickvo工具</span></p> 
<ul> 
 <li>致谢</li> 
</ul> 
<p>感谢广大网络用户的支持和反馈，让sqltoy功能越来越完备可靠</p> 
<p> </p>
                                        </div>
