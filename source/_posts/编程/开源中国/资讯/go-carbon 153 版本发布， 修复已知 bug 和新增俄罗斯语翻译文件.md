...
---
title: 'go-carbon 1.5.3 版本发布， 修复已知 bug 和新增俄罗斯语翻译文件'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 <li> <p>修复已知bug</p> </li> 
 <li> <p>优化性能</p> </li> 
 <li> <p>新增俄罗斯语翻译文件lang/ru.json，由 <a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2Fzemlyak" target="_blank">zemlyak</a> 翻译</p> </li> 
</ul>
                                        </div>
