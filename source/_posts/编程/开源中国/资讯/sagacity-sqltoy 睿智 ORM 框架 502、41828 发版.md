...
---
title: 'sagacity-sqltoy 睿智 ORM 框架 5.0.2、4.18.28 发版'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 09 Jul 2021 14:34:00 GMT
...
<p style="text-align:left">1. 查询参数findBySql(String sql,Map paramsMap,Class resultType) map支持多层子对象属性</p> 
<pre><code class="language-java">String sql="select * from table where id=:staff.id and name like :staff.name"
Map paramMap=new HashMap();
paramsMap.put("staff",new StaffInfo().setId("10000").setName("xxxx"))</code></pre> 
<p style="text-align:left">2、SqlToyDaoSupport中增加分页Map传参方法：</p> 
<pre><code class="language-java">findPageBySql(final Page page, final String sqlOrNamedSql,
            final Map<String, Object> paramsMap, Class<T> voClass)</code></pre> 
<h1><span style="color:#c0392b"><strong>sqltoy特点介绍：</strong></span></h1> 
<ul> 
