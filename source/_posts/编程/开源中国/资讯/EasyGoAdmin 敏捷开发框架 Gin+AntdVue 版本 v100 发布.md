...
---
title: 'EasyGoAdmin 敏捷开发框架 Gin+AntdVue 版本 v1.0.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
headimg: 'https://oscimg.oschina.net/oscnet/up-25439dbf6f4f5e7d0eef4afc8c3fd244ed8.png'
author: 开源中国
comments: false
date: Thu, 19 May 2022 08:50:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-25439dbf6f4f5e7d0eef4afc8c3fd244ed8.png'
---

<div>   
<div class="content">
                                                                    
                                                        <p>v1.0.0 更新内容：<br> 1、搭建基于Go语言，采用Gin、Xorm、Vue、AntDesign等框架；<br> 2、本框架采用前后端分离的软件架构设计，采用主流的编写方式；<br> 3、采用xorm辅助工具生成表结构对应的model文件，提高了开发效率；<br> 4、框架本身集成了代码生成器，可以根据表结构一键生成模块的增删改查功能及前端Vue文件；</p> 
<h2>项目介绍</h2> 
...
<h2>软件信息</h2> 
<ul> 
 <li>软件名称：EasyGoAdmin敏捷开发框架Gin+AntdVue版本</li> 
 <li>软件作者：@半城风雨</li> 
 ...
 <li>文档网址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fdocs.gin.antdvue.easygoadmin.vip" target="_blank">文档地址</a></li> 
</ul> 
<h2>系统演示</h2> 
<ul> 
 <li>演示地址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fmanage.gin.antdvue.easygoadmin.vip" target="_blank">点击查看演示环境</a></li> 
</ul> 
<table> 
 <thead> 
  <tr> 
...
<h2>模块展示</h2> 
<p><img alt height="1080" src="https://oscimg.oschina.net/oscnet/up-25439dbf6f4f5e7d0eef4afc8c3fd244ed8.png" width="1920" referrerpolicy="no-referrer"></p> 
<p> </p>
                                        </div>
