...
---
title: 'EasyGoAdmin 敏捷开发框架 Beego+EleVue 版本 v2.0.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
headimg: 'https://oscimg.oschina.net/oscnet/up-55be2fb967b6ed4384a4b34566ade457b4f.png'
author: 开源中国
comments: false
date: Wed, 01 Jun 2022 08:45:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-55be2fb967b6ed4384a4b34566ade457b4f.png'
---

<div>   
<div class="content">
                                                                                            <p>v2.0.0 更新内容：<br> 1、调整后端服务注册目录boot,启动项目时自动注册；<br> 2、变成自定义模块目录，统一放在templdates目录下；<br> 3、解决数据列表日期格式无法正常显示的问题；<br> 4、优化用户管理模块和会员管理模块的城市选择功能；<br> 5、修复近期用户使用过程中反馈的BUG；</p> 
<h2>项目介绍</h2> 
...
<h2>模块展示</h2> 
<p><img alt height="1080" src="https://oscimg.oschina.net/oscnet/up-55be2fb967b6ed4384a4b34566ade457b4f.png" width="1920" referrerpolicy="no-referrer"></p>
                                        </div>
