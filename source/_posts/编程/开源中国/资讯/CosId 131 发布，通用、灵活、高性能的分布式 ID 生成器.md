...
---
title: 'CosId 1.3.1 发布，通用、灵活、高性能的分布式 ID 生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<h2 style="text-align:left">更新内容（1.3.1） 🎉 🎉 🎉</h2> 
<ol> 
 <li>新增： <code>cosid-spring-redis</code> 模块， 支持 <code>spring-data-redis</code> 免去 <code>redis</code> 重复配置。thx <a href="https://gitee.com/bitfoolbear">@bitfoolbear </a>反馈建议</li> 
 <li>修复： <code>PrefetchWorker</code> 应用首次启动时执行俩次预取操作</li> 
 <li>修复： <code>PrefetchWorker</code> 日志信息输出错误</li> 
</ol> 
...
<div style="text-align:left"> 
 <div> 
  <pre>    <strong>val</strong> <strong>cosidVersion</strong> <span style="color:#eeeeee">=</span> <span style="background-color:transparent; color:#00aadd">"1.3.1"</span><span style="color:#eeeeee">;</span>
...
<span style="color:#ffcc55"><project</span> <span style="color:#008080">xmlns=</span><span style="background-color:transparent; color:#00aadd">"http://maven.apache.org/POM/4.0.0"</span>
    ...
    <span style="color:#ffcc55"><properties></span>
        <span style="color:#ffcc55"><cosid.version></span>1.3.1<span style="color:#ffcc55"></cosid.version></span>
    <span style="color:#ffcc55"></properties></span>
...
<em># or</em>
java <span style="color:#ffcc55">-jar</span> cosid-core/build/libs/cosid-core-1.3.1-jmh.jar <span style="color:#ffcc55">-bm</span> thrpt <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<em># or</em>
java <span style="color:#ffcc55">-jar</span> cosid-redis/build/libs/cosid-redis-1.3.1-jmh.jar <span style="color:#ffcc55">-bm</span> thrpt <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1 RedisChainIdBenchmark</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<div style="text-align:left"> 
 <div> 
  <pre>java <span style="color:#ffcc55">-jar</span> cosid-redis/build/libs/cosid-redis-1.3.1-jmh.jar <span style="color:#ffcc55">-bm</span> sample <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1 <span style="color:#ffcc55">-tu</span> us step_1000</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<em># or</em>
java <span style="color:#ffcc55">-jar</span> cosid-jdbc/build/libs/cosid-jdbc-1.3.1-jmh.jar <span style="color:#ffcc55">-bm</span> thrpt <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1 MySqlChainIdBenchmark</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<div style="text-align:left"> 
 <div> 
  <pre>java <span style="color:#ffcc55">-jar</span> cosid-jdbc/build/libs/cosid-jdbc-1.3.1-jmh.jar <span style="color:#ffcc55">-bm</span> sample <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1 <span style="color:#ffcc55">-tu</span> us step_1000</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
