...
---
title: 'DBShop 商城系统 V3.1 Release 220419 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 21 Apr 2022 02:28:00 GMT
...
<div class="content">
 ...
 <div> 
  <div style="text-align:left"> 
   ...
   <p><strong>更新日志：</strong><br> 新增 后台模板管理，加入对于自适应的设置<br> 新增 在线新安装的模板首页提示信息<br> 优化 对官方新发布的模板支持<br> 优化 后台商品列表显示<br> 优化 图片上传<br> 优化 后台商品分类添加分类链接复制<br> 优化 后台系统设置的提示信息<br> 优化 缩微图处理</p> 
   ...
   <p style="color:#333333; margin-left:0; margin-right:0; text-align:start"><strong>下载地址：<a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fdownload.loongdom.com.cn%2Fdbshop%2FV3.1%2FDBShopV3.1_Release220419.tar.gz" target="_blank"><span> </span>https://download.loongdom.com.cn/dbshop/V3.1/DBShopV3.1_Release220419.tar.gz</a></strong></p> 
  </div> 
 </div> 
</div> 
<div style="text-align:start"> 
