...
---
title: 'Java 17 可以从 Solon 开始入手，v1.10.0'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 <li>插件 beetlsql-solon-plugin 升级 beetlsql 为 3.17.1-RELEASE</li> 
 <li>插件 dbvisitor-solon-plugin 升级 dbvisitor 为 5.1.0</li> 
 <li>插件 sentinel-solon-plugin 升级 sentinel 为 1.8.4</li> 
 <li>调整 org.noear.solon.ext.* 的工具类到 org.noear.solon.core.util.*</li> 
 <li>增加 国际化配置 转 map,list,entity 的支持</li> 
</ul> 
