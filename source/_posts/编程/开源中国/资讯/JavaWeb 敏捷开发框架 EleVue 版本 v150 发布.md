...
---
title: 'JavaWeb 敏捷开发框架 EleVue 版本 v1.5.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div class="content">
                                                                                            <div> 
 <div> 
  <p>v1.5.0更新内容：<br> 1、更新优化城市管理模块；<br> 2、升级文件上传公共文件uploadFile;<br> 3、新增导出Excel功能，自定义注解实现；<br> 4、新增AOP切换日志，使用方法如：“@Log(title = "岗位管理", logType = LogType.INSERT)”<br> 5、从国家地理信息往重新采集国家城市列表最新数据，涉及数据表"sys_city";</p> 
  <h2>项目介绍</h2> 
