...
---
title: 'smart-doc 2.1.5 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 06 May 2021 09:22:00 GMT
...
<pre style="text-align:left">1<span style="color:#032f62">.</span> 修复requestBodyAdvice请求样例丢问题。
2<span style="color:#032f62">.</span> 添加dubbo文档到torna的推送。
</pre> 
