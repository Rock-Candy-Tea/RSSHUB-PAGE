...
---
title: '《灯灯》多租户快速开发平台 4.10.0-beta.0 发布，适配 SQL Server'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div class="content">
 ...
 <div style="text-align:left"> 
  <h2 style="margin-left:0; margin-right:0; text-align:left"><a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Ftangyh.top%2Fpages%2Flog_4%2F" target="_blank">4.10.0-beta.0 - 公测版 更新详情:</a></h2> 
  <h2 style="margin-left:0; margin-right:0">feat</h2> 
  <ul> 
   <li>适配SQL Server</li> 
   <li>去除表名和字段中的转义字符</li> 
   <li>新增租户时，根据使用数据库读取不同数据库的脚本进行租户数据初始化</li> 
   <li>代码生成器中生成的SQL语句适配SQL Server</li> 
   <li>去除代码中使用的LIMIT语法</li> 
   <li>XML 中的SQL true 改成 1 ，false 改成 0</li> 
   <li>now()、sysdate() 等函数替换为java程序获取当前日期</li> 
  </ul> 
  <h2>fix</h2> 
  <ul> 
   <li>代码生成器模板 和 动态替换变量模板不能共用一个配置</li> 
   <li>调整def_interface_property表的key字段为key_ ，避免关键字</li> 
  </ul> 
