...
---
title: 'JavaWeb 敏捷开发框架 Layui 版本 v1.2.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 01 Aug 2022 09:28:00 GMT
thumbnail: 'https://picsum.photos/400/300?random=7757'
---

<div>   
<div class="content">
                                                                                            <p>v1.2.0 更新内容：<br> 1、新增图标选择组件；<br> 2、新增开关选择组件；<br> 3、新增复选框组件；<br> 4、新增下拉选择组件；<br> 5、新增行政区划选择组件；</p> 
<h2>项目介绍</h2> 
