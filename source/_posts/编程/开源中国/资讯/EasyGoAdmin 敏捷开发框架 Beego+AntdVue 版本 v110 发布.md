...
---
title: 'EasyGoAdmin 敏捷开发框架 Beego+AntdVue 版本 v1.1.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
headimg: 'https://oscimg.oschina.net/oscnet/up-8cdd8931af26a8a5d8dd738a00ab5a7c384.png'
author: 开源中国
comments: false
date: Tue, 07 Jun 2022 08:56:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-8cdd8931af26a8a5d8dd738a00ab5a7c384.png'
---

<div>   
<div class="content">
                                                                                            <p>v1.1.0 更新内容：<br> 1、优化框架底层核心自定义组件，扩展并做了功能性增强；<br> 2、完善系统管理配置模块，动态高可用解析配置信息，实现统一维护；<br> 3、修复近期用户使用过程中反馈的 BUG；</p> 
<h2>项目介绍</h2> 
...
<h2>软件信息</h2> 
<ul> 
 <li>软件名称：EasyGoAdmin敏捷开发框架Beego+AntdVue版本</li> 
 ...
 <li>文档网址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fdocs.beego.antdvue.easygoadmin.vip" target="_blank">http://docs.beego.antdvue.easygoadmin.vip</a></li> 
</ul> 
<h2>系统演示</h2> 
<ul> 
 <li>演示地址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fmanage.beego.antdvue.easygoadmin.vip" target="_blank">http://manage.beego.antdvue.easygoadmin.vip</a></li> 
</ul> 
<table> 
 <thead> 
  <tr> 
...
<span>|   `<span>-- app.conf</span></span>
<span>|<span>-- controllers</span></span>
<span>|   `<span>-- default.go</span></span>
<span>|<span>-- main.go</span></span>
<span>|<span>-- models</span></span>
<span>|<span>-- routers</span></span>
<span>|   `<span>-- router.go</span></span>
<span>|<span>-- static</span></span>
<span>|   |<span>-- css</span></span>
<span>|   |<span>-- img</span></span>
<span>|   `<span>-- js</span></span>
<span>|<span>-- tests</span></span>
<span>|   `<span>-- default_test.go</span></span>
<span>`<span>-- views</span></span>
<span>    `<span>-- index.tpl</span></span></pre> 
 </div> 
</div> 
<h2>模块展示</h2> 
<p><img alt height="1080" src="https://oscimg.oschina.net/oscnet/up-8cdd8931af26a8a5d8dd738a00ab5a7c384.png" width="1920" referrerpolicy="no-referrer"></p>
                                        </div>
