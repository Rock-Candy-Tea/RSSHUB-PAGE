...
---
title: 'EasyGoAdmin 敏捷开发框架 Gin+Layui 版本 v2.0.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
headimg: 'https://oscimg.oschina.net/oscnet/up-d20674c923bb59bf5184c30ba60e6ca6193.png'
author: 开源中国
comments: false
date: Mon, 23 May 2022 09:00:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-d20674c923bb59bf5184c30ba60e6ca6193.png'
---

<div>   
<div class="content">
                                                                    
                                                        <p>v2.0.0 更新内容：<br> 1、系统架构重构，优化组件并存放在app应用目录下；<br> 2、优化和完善系统设置模块，增强了性能；<br> 3、修复左侧菜单第三方URL地址无法打开的问题；<br> 4、新增批量删除功能，所有模块全部新增批量删除操作；<br> 5、升级前端JS底层架构，匹配批量删除请求地址；<br> 6、代码生成器新增批量生成模块的功能；<br> 7、完善个人中心页面，优化页面样式呈现方式；<br> 8、修复和完善近期用户使用过程中反馈的BUG；</p> 
<h2>项目介绍</h2> 
...
<h2>软件信息</h2> 
<ul> 
 <li>软件名称：EasyGoAdmin敏捷开发框架Gin+Layui版本</li> 
 ...
 <li>文档网址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fdocs.gin.layui.easygoadmin.vip" target="_blank">文档地址</a></li> 
</ul> 
<h2>系统演示</h2> 
<ul> 
 <li>演示地址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fmanage.gin.layui.easygoadmin.vip" target="_blank">点击查看演示地址</a></li> 
</ul> 
<table> 
 <thead> 
  <tr> 
...
<h2>模块展示</h2> 
<p><img alt height="1080" src="https://oscimg.oschina.net/oscnet/up-d20674c923bb59bf5184c30ba60e6ca6193.png" width="1920" referrerpolicy="no-referrer"></p> 
<p> </p>
                                        </div>
