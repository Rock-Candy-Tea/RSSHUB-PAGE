...
---
title: 'Sa-plus v1.26.0 更新，基于 Spring Boot 的快速开发框架'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 25 Oct 2021 01:54:00 GMT
...
<p>本次更新版本 v1.26.0 主要包括以下内容：</p> 
<ul> 
 <li>优化：优化前端样式，删除不必要的<span> </span><code>size="mini"</code><span> </span>配置</li> 
 <li>修复：修复部分页面表单校验抛出异常未能处理的情况</li> 
 <li>重构：重构代码生成器，更简洁的代码结构</li> 
 <li>升级：升级表单封装，增加日期、时间、slot等多种适配</li> 
 <li>升级：部分依赖升级至最新版本</li> 
 <li>更换：更换logo</li> 
 <li> <p>升级：升级在线演示版本</p> </li> 
</ul> 
