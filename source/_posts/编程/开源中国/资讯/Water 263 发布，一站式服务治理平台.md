...
author: 开源中国
comments: false
date: Thu, 05 May 2022 18:12:00 GMT
...
<ul> 
 <li>[控制台] 所有导入功能统一为插入或替换（之前有些插入，有些是替换）</li> 
 <li>[控制台] 调整部分列表删除后，跳转到同状态列表</li> 
 <li>[控制台] 修复定时任务监控无数据的问题</li> 
 <li>[控制台] UI优化</li> 
 <li>HttpUtils 工具类，支持超时设置</li> 
 <li>runJob，超时改为：60*5秒</li> 
 <li>runStatus，超时改为：10秒</li> 
 <li>solon 升级为：1.7.5（项目地址：<a href="https://gitee.com/noear/solon">https://gitee.com/noear/solon</a>）</li> 
 <li>redisx 升级为：1.4.3（项目地址：<a href="https://gitee.com/noear/redisx">https://gitee.com/noear/redisx</a>）</li> 
 <li>snack3 升级为：3.2.22（项目地址：<a href="https://gitee.com/noear/snack3">https://gitee.com/noear/snack3</a>）</li> 
</ul> 
