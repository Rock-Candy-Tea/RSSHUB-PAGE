...
---
title: 'RXThinkCMF 敏捷开发框架 Laravel5.8+Layui 版本 v1.0.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
headimg: 'https://oscimg.oschina.net/oscnet/up-d7936ed6b4be7de56e98a7d0b89b17f6e88.png'
author: 开源中国
comments: false
date: Wed, 25 May 2022 09:06:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-d7936ed6b4be7de56e98a7d0b89b17f6e88.png'
---

<div>   
<div class="content">
                                                                    
                                                        <p>v1.0.0 更新内容：<br> 1、基于 Laravel5.8、Layui 搭建核心框架；<br> 2、编写框架核心组件，包括图片上传、日期、开关、选择单选、复选框、单选按钮、图片裁剪、富文本等等核心组件；<br> 3、编写基于权限RBAC架构的核心代码；<br> 4、编写权限基础模块；<br> 5、设计基于Layout的布局模板；</p> 
<h2>项目介绍</h2> 
...
<h2>开发者信息</h2> 
<ul> 
 <li>软件名称：RXThinkCMF敏捷开发框架Laravel+Layui旗舰版本</li> 
 <li>软件作者：@牧羊人</li> 
 <li>软件出处：南京RXThinkCMF研发中心</li> 
 <li>软件协议：LGPL-3.0</li> 
 <li>官网网址：<a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fwww.rxthink.cn" target="_blank">http://www.rxthink.cn</a></li> 
 <li>文档网址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fdocs.lv5.8.rxthink.cn" target="_blank">http://docs.lv5.8.rxthink.cn</a></li> 
</ul> 
<h2>系统演示</h2> 
<ul> 
 <li>演示地址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fmanage.lv5.8.pro.rxthink.cn" target="_blank">http://manage.lv5.8.pro.rxthink.cn</a></li> 
</ul> 
<table> 
 <thead> 
  <tr> 
...
<h2>模块展示</h2> 
<p><img alt height="1080" src="https://oscimg.oschina.net/oscnet/up-d7936ed6b4be7de56e98a7d0b89b17f6e88.png" width="1920" referrerpolicy="no-referrer"></p>
                                        </div>
