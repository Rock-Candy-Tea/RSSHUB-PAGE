...
---
title: 'CoSky 1.2.9 发布 - 高性能、低成本微服务治理平台'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 03 Aug 2021 09:30:00 GMT
...
<h2 style="text-align:left">更新内容（1.2.9） 🎉 🎉 🎉</h2> 
<ol> 
 <li> 
  <div style="text-align:start"> 
   <p>修复 <code>Redis 5.0</code> 以下版本不兼容的问题。</p> 
  </div> </li> 
</ol> 
...
<div style="text-align:left"> 
 <div> 
  <pre>    <strong>val</strong> <strong>coskyVersion</strong> <span style="color:#eeeeee">=</span> <span style="background-color:transparent; color:#00aadd">"1.2.9"</span><span style="color:#eeeeee">;</span>
...
<span style="color:#ffcc55"><project</span> <span style="color:#008080">xmlns=</span><span style="background-color:transparent; color:#00aadd">"http://maven.apache.org/POM/4.0.0"</span>
  ...
  <span style="color:#ffcc55"><properties></span>
    <span style="color:#ffcc55"><cosky.version></span>1.2.9<span style="color:#ffcc55"></cosky.version></span>
  <span style="color:#ffcc55"></properties></span>
...
<blockquote> 
 <p>下载 <a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2FAhoo-Wang%2Fcosky%2Freleases%2Fdownload%2F1.2.9%2Fcosky-rest-api-1.2.9.tar" target="_blank">rest-api-server</a></p> 
</blockquote> 
<blockquote> 
 <p>解压 <em>cosky-rest-api-1.2.9.tar</em></p> 
</blockquote> 
<div style="text-align:left"> 
 <div> 
  <pre><span style="color:#0086b3">cd </span>cosky-rest-api-1.2.9
<em># 工作目录: cosky-rest-api-1.2.9</em>
...
<div style="text-align:left"> 
 <div> 
  <pre>docker pull ahoowang/cosky-rest-api:1.2.9
docker run <span style="color:#ffcc55">--name</span> cosky-rest-api <span style="color:#ffcc55">-d</span> <span style="color:#ffcc55">-p</span> 8080:8080 <span style="color:#ffcc55">--link</span> redis <span style="color:#ffcc55">-e</span> <span style="color:#ffaa44">COSKY_REDIS_URI</span>=redis://redis:6379  ahoowang/cosky-rest-api:1.2.9</pre> 
 </div> 
</div> 
    ...
    <span style="color:#008080">spec</span>:
      <span style="color:#008080">containers</span>:
        - <span style="color:#008080">env</span>:
          ...
          <span style="color:#008080">image</span>: <span style="background-color:transparent; color:#00aadd">ahoowang/cosky-rest-api:1.2.9</span>
          <span style="color:#008080">name</span>: <span style="background-color:transparent; color:#00aadd">cosky-rest-api</span>
...
<h4 style="text-align:left">审计日志</h4> 
<p style="text-align:left"><img alt="dashboard-audit-log" src="https://gitee.com/AhooWang/CoSky/raw/main/docs/dashboard-audit-log.png" referrerpolicy="no-referrer"></p> 
...
<em># or</em>
java <span style="color:#ffcc55">-jar</span> cosky-config/build/libs/cosky-config-1.2.9-jmh.jar <span style="color:#ffcc55">-bm</span> thrpt <span style="color:#ffcc55">-t</span> 25 <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<em># or</em>
java <span style="color:#ffcc55">-jar</span> cosky-discovery/build/libs/cosky-discovery-1.2.9-jmh.jar <span style="color:#ffcc55">-bm</span> thrpt <span style="color:#ffcc55">-t</span> 25 <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
