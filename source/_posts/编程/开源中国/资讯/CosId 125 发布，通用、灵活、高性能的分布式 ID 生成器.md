...
---
title: 'CosId 1.2.5 发布，通用、灵活、高性能的分布式 ID 生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sat, 10 Jul 2021 07:54:00 GMT
...
<ol> 
 <li>增强：<code>PrefetchWorker</code>支持基于饥饿状态的安全距离（<code>safeDistance</code>）动态扩缩容，持续提升性能。</li> 
 <li>新增：添加 <code>cosid-jdbc</code>，支持使用关系型数据库作为 <code>IdSegmentDistributor</code>。</li> 
 <li>变更：修改默认 <code>SegmentIdProperties.Mode</code> 为 <code>CHAIN</code> （号段链模式，<strong>推荐</strong>）。</li> 
</ol> 
...
<h2 style="text-align:left">JdbcIdSegmentDistributor (使用关系型数据库<code>Db</code>作为号段分发后端存储)</h2> 
<div style="text-align:left"> 
 <div> 
...
<div style="text-align:left"> 
 <div> 
  <pre>    <strong>val</strong> <strong>cosidVersion</strong> <span style="color:#eeeeee">=</span> <span style="background-color:transparent; color:#00aadd">"1.2.5"</span><span style="color:#eeeeee">;</span>
...
<span style="color:#ffcc55"><project</span> <span style="color:#008080">xmlns=</span><span style="background-color:transparent; color:#00aadd">"http://maven.apache.org/POM/4.0.0"</span>
    ...
    <span style="color:#ffcc55"><properties></span>
        <span style="color:#ffcc55"><cosid.version></span>1.2.5<span style="color:#ffcc55"></cosid.version></span>
    <span style="color:#ffcc55"></properties></span>
...
<em># or</em>
java <span style="color:#ffcc55">-jar</span> cosid-core/build/libs/cosid-core-1.2.5-jmh.jar <span style="color:#ffcc55">-bm</span> thrpt <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<em># or</em>
java <span style="color:#ffcc55">-jar</span> cosid-redis/build/libs/cosid-redis-1.2.5-jmh.jar <span style="color:#ffcc55">-bm</span> thrpt <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1 RedisChainIdBenchmark</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<h4 style="text-align:left">Sample (us/op)</h4> 
...
<div style="text-align:left"> 
 <div> 
  <pre>java <span style="color:#ffcc55">-jar</span> cosid-redis/build/libs/cosid-redis-1.2.5-jmh.jar <span style="color:#ffcc55">-bm</span> sample <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1 <span style="color:#ffcc55">-tu</span> us step_1000</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<em># or</em>
java <span style="color:#ffcc55">-jar</span> cosid-jdbc/build/libs/cosid-jdbc-1.2.5-jmh.jar <span style="color:#ffcc55">-bm</span> thrpt <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1 MySqlChainIdBenchmark</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
...
<div style="text-align:left"> 
 <div> 
  <pre>java <span style="color:#ffcc55">-jar</span> cosid-jdbc/build/libs/cosid-jdbc-1.2.5-jmh.jar <span style="color:#ffcc55">-bm</span> sample <span style="color:#ffcc55">-wi</span> 1 <span style="color:#ffcc55">-rf</span> json <span style="color:#ffcc55">-f</span> 1 <span style="color:#ffcc55">-tu</span> us step_1000</pre> 
 </div> 
</div> 
<div style="text-align:left"> 
 <div> 
