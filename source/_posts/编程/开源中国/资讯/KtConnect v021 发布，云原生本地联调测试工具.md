...
---
title: 'KtConnect v0.2.1 发布，云原生本地联调测试工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 <li>修复connect命令使用共享shadow pod时的错误</li> 
 <li>新增--context全局参数，支持切换kubeconfig内的上下文</li> 
 <li>默认使用本地kubeconfig文件当前上下文配置的namespace</li> 
</ul> 
