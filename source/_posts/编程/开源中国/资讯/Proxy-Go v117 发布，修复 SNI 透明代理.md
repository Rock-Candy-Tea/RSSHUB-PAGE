...
---
title: 'Proxy-Go v11.7 发布，修复 SNI 透明代理'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 14 Apr 2022 02:18:00 GMT
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left">1、tcp代理新增tcp和单向tls互转。</p> 
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left">2、修复读取http代理头部，没有正确处理sni的问题。</p> 
