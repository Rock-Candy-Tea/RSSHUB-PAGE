...
---
title: 'Proxy-Go v11.0 发布，新增网站反向代理，支持 http_https 相互转换！'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div>   
<div class="content">
                                                                                            <p style="text-align:left"><img height="374" src="https://oscimg.oschina.net/oscnet/up-af1e0af7e1e19350f9d86dbc9f0ca05203e.png" width="546" referrerpolicy="no-referrer"></p> 
...
<p style="text-align:left"><span style="background-color:#ffffff; color:#24292e">1.新增http/https反向代理，支持http和https相互转换，负载均衡，高可用，目录映射转发，路径保护，别名，</span><br> <span style="background-color:#ffffff; color:#24292e">具体使用可以参考配置文件rhttp.toml，里面有完整配置说明。</span></p> 
