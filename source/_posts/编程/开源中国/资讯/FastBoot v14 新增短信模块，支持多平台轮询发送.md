...
---
title: 'FastBoot v1.4 新增短信模块，支持多平台轮询发送'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 <li>新增短信模块，支持阿里云、腾讯云短信平台</li> 
 <li>新增短信轮询发送，支持多家短信平台轮询发送</li> 
 <li>新增短信发送记录，可查看短信发送详情</li> 
 <li>新增常用数据字典，避免新建重复数据</li> 
 <li>升级springboot到2.7.3</li> 
 <li>升级element-plus到2.2.13</li> 
 <li>升级vite到2.0.8</li> 
</ul> 
