...
---
title: 'Eurynome Cloud 2.6.2.40 发布，Spring Boot 版本升级至 2.6.2'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 22 Dec 2021 13:44:00 GMT
thumbnail: 'https://oscimg.oschina.net/oscnet/up-3152a26db51892c35a11ed4efdab72056ad.jpg'
---

<div>   
<div class="content">
                                                                                            <p><strong>Eurynome Cloud</strong> 是一款企业级微服务架构和服务能力开发平台。基于Spring Boot 2.6.2、Spring Cloud 2021.0.0、Spring Cloud Alibaba 2021.1、Nacos 2.0.3 等最新版本开发，遵循SpringBoot编程思想，高度模块化和可配置化。具备服务发现、配置、熔断、限流、降级、监控、多级缓存、分布式事务、工作流等功能</p> 
