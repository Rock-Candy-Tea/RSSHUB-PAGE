...
---
title: 'novel-plus v3.6.0 发布，新增小说内容 TXT 文本存储方案'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 18 Aug 2021 08:16:00 GMT
thumbnail: 'https://s3.ax1x.com/2020/12/27/r5400A.png'
---

<div>   
<div class="content">
                                                                                            <p style="text-align:left">novel-plus v3.6.0发布了，主要改进包括：</p> 
<ul> 
 <li style="text-align:justify">[新增]增加<span style="color:#444444">小说内容TX</span><span style="color:#444444">T文本存储方案（一行配置切换）</span>。</li> 
 <li style="text-align:justify">[新增]<span style="color:#444444">新闻模块</span><span style="color:#333333">增加新闻阅读数和发布时间</span>。</li> 
 <li style="text-align:justify">[优化]<span style="color:#444444">首页优化</span>。</li> 
 <li style="text-align:justify">[修复]Bug修复。</li> 
</ul> 
...
<div style="text-align:start"> 
 <div> 
  <pre style="text-align:left">novel-plus <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 父工程</span></span></span></span></span></span></span></span>
├── novel-common <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 通用模块</span></span></span></span></span></span></span></span>
├── novel-front <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 前台门户&作家后台管理子系统（可拆分）</span></span></span></span></span></span></span></span>
├── novel-crawl <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 爬虫管理子系统</span></span></span></span></span></span></span></span>
├── novel-admin <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 平台后台管理子系统</span></span></span></span></span></span></span></span>
└── templates <span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d"><span style="color:#6a737d">-- 前端模版</span></span></span></span></span></span></span></span></pre> 
 </div> 
</div> 
