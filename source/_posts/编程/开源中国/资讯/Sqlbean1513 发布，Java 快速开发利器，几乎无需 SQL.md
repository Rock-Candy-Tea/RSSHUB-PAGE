...
---
title: 'Sqlbean1.5.13 发布，Java 快速开发利器，几乎无需 SQL'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<span><version>1.5.13</version></span>
...
<p>本次更新内容：</p> 
<p><span style="background-color:#ffffff; color:#40485b">1：移除guava包依赖；</span><br> <span style="background-color:#ffffff; color:#40485b">2：移除过时方法；</span><br> <span style="background-color:#ffffff; color:#40485b">3：升级pom依赖包版本；</span><br> <span style="background-color:#ffffff; color:#40485b">4：完善并移除SqlInsertTime和SqlUpdateTime注解；</span></p>
                                        </div>
