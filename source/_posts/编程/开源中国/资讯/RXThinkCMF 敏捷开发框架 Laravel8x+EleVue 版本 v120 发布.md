...
---
title: 'RXThinkCMF 敏捷开发框架 Laravel8.x+EleVue 版本 v1.2.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 08 Jul 2022 08:53:00 GMT
thumbnail: 'https://picsum.photos/400/300?random=3433'
---

<div>   
<div class="content">
                                                                                            <p>v1.2.0 更新内容：<br> 1、优化后端服务CROS跨域处理组件；<br> 2、完善后端路由转发功能，丰富路由匹配规则；<br> 3、修复近期用户使用过程中反馈的 BUG；</p> 
<h2>项目介绍</h2> 
