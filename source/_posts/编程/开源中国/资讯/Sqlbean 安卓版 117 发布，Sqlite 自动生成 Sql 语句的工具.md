...
---
title: 'Sqlbean 安卓版 1.1.7 发布，Sqlite 自动生成 Sql 语句的工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 01 Aug 2022 09:50:00 GMT
...
<div style="text-align:left"> 
 <div> 
  <pre><span>implementation 'cn.vonce:vonce-sqlbean-android:1.1.7'</span>
<span>annotationProcessor 'cn.vonce:vonce-sqlbean-android:1.1.7'</span></pre> 
...
<p>本次更新内容：</p> 
<p><span style="background-color:#ffffff; color:#40485b">1：移除过时方法；</span><br> <span style="background-color:#ffffff; color:#40485b">2：删除安卓api的反射；</span><br> <span style="background-color:#ffffff; color:#40485b">3：移除guava包依赖；</span><br> <span style="background-color:#ffffff; color:#40485b">4：修复已知bug；</span><br> <span style="background-color:#ffffff; color:#40485b">5：重载xxxByCondition方法为xxxBy；</span></p>
                                        </div>
