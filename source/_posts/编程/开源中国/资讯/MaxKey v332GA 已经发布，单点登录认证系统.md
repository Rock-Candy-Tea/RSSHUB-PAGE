...
---
title: 'MaxKey v3.3.2GA 已经发布，单点登录认证系统'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div>   
<div class="content">
                                                                                            <p>MaxKey v3.3.2GA 已经发布，单点登录认证系统</p> 
<p>此版本更新内容包括：</p> 
<p>MaxKey v 3.3.2 GA 2022/02/17</p> 
<div> 
 <pre><code>*(MAXKEY-220301) 统一界面色调
...
<p>详情查看：<a href="https://gitee.com/dromara/MaxKey/releases/v3.3.2GA">https://gitee.com/dromara/MaxKey/releases/v3.3.2GA</a></p>
                                        </div>
