...
---
title: 'Proxy-Go v11.8 发布，修复几处内存泄漏，DNS 代理性能大幅提升！'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 28 Apr 2022 10:37:00 GMT
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><span style="background-color:#ffffff; color:#24292f">1、修复dns/socks5代理的几处某些情况下存在的内存泄漏问题。</span><br> <span style="background-color:#ffffff; color:#24292f">2、优化了dns代理的查询,性能大幅度提升。</span></p> 
