...
---
title: 'go-fastdfs 分布式文件系统 v1.4.2 发布，修复图片缩放过大服务出现退出问题'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 14 May 2021 11:04:00 GMT
...
<div class="content">
                                                        ...
                                                        <p style="text-align:start">go-fastdfs 是一个基于 http 协议的分布式文件系统，它基于大道至简的设计理念，一切从简设计，使得它的运维及扩展变得更加简单，它具有高性能、高可靠、无中心、免维护等优点。</p> 
<p style="text-align:start"><strong>修复下载时&符号被转义，断点续传同一文件无回调</strong><br> 注意：使用前请认真阅读 使用文档 或 视频教程。</p> 
<p style="text-align:start">优点</p> 
<ul> 
 <li>支持curl命令上传</li> 
 <li>支持浏览器上传</li> 
 <li>支持HTTP下载</li> 
...
<p style="text-align:start">更新历史</p> 
<ul> 
