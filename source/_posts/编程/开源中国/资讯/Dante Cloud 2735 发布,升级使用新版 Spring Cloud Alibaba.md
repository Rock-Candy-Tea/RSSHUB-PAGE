...
---
title: 'Dante Cloud 2.7.3.5 发布,升级使用新版 Spring Cloud Alibaba'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sat, 17 Sep 2022 11:28:00 GMT
...
<ul> 
 <li>重要更新 
  <ul> 
   ...
   <li>自主封装 Oracle JDK Docker 基础镜像版本升级至 8u333, 系统所涉及的所有 Docker 均已修改为使用该版本。该镜像已经上传至 Docker Hub，可以直接使用。</li> 
   <li>自主封装 Sentinel Dashboard Docker 镜像基于 Sentinel 1.8.5 进行了全面升级。 
    <ul> 
