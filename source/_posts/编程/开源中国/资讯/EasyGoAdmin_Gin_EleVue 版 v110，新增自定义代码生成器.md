...
---
title: 'EasyGoAdmin_Gin_EleVue 版 v1.1.0，新增自定义代码生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div>   
<div class="content">
                                                                                            <p>v1.1.0 更新内容：<br> 1、搭建基于Go语言，采用Gin、Xorm、Vue、ElementUI等框架；<br> 2、本框架采用前后端分离的软件架构设计，采用主流的编写方式；<br> 3、采用xorm辅助工具生成表结构对应的model文件，提高了开发效率；<br> 4、框架本身集成了代码生成器，可以根据表结构一键生成模块的增删改查功能及前端Vue文件；<br> 5、修复系统的BUG及功能模块优化；</p> 
<h2>项目介绍</h2> 
