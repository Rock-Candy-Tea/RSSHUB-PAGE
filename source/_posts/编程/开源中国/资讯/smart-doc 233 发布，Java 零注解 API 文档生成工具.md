...
---
title: 'smart-doc 2.3.3 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 30 Nov 2021 09:42:00 GMT
...
<ol> 
 <li> 支持OffsetDateTime。</li> 
 <li> 修复html文档搜索清空后目录显示不全的bug。</li> 
 <li> 修复非分组使用时html文档目录序号错乱问题。</li> 
 <li> 修复英文请求头转义问题</li> 
</ol> 
