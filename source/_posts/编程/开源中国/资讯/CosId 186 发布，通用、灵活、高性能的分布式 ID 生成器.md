...
---
title: 'CosId 1.8.6 发布，通用、灵活、高性能的分布式 ID 生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 25 Jan 2022 23:43:00 GMT
thumbnail: 'https://gitee.com/AhooWang/CosId/raw/main/document/docs/.vuepress/public/logo.png'
---

<div>   
<div class="content">
                                                                                            <p style="color:#40485b; margin-left:0em; margin-right:0em; text-align:center"><img src="https://gitee.com/AhooWang/CosId/raw/main/document/docs/.vuepress/public/logo.png" width="300" referrerpolicy="no-referrer"></p> 
<h1 style="margin-left:0; margin-right:0; text-align:center"><a href="https://gitee.com/link?target=https%3A%2F%2Fcosid.ahoo.me%2F">CosId</a><span> </span>通用、灵活、高性能分布式 ID 生成器</h1> 
<p style="color:#40485b; margin-left:0; margin-right:0; text-align:left"><a href="https://gitee.com/link?target=https%3A%2F%2Fwww.apache.org%2Flicenses%2FLICENSE-2.0.html"><img alt="License" src="https://img.shields.io/badge/license-Apache%202-4EB1BA.svg" referrerpolicy="no-referrer"></a><span> </span><a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2FAhoo-Wang%2FCosId%2Freleases"><img alt="GitHub release" src="https://img.shields.io/github/release/Ahoo-Wang/CosId.svg" referrerpolicy="no-referrer"></a><span> </span><a href="https://gitee.com/link?target=https%3A%2F%2Fapp.codacy.com%2Fgh%2FAhoo-Wang%2FCosId%3Futm_source%3Dgithub.com%26utm_medium%3Dreferral%26utm_content%3DAhoo-Wang%2FCosId%26utm_campaign%3DBadge_Grade_Settings"><img alt="Codacy Badge" src="https://api.codacy.com/project/badge/Grade/dfd1d6237a1644409548ebfbca300dc1" referrerpolicy="no-referrer"></a></p> 
<h2 style="margin-left:0; margin-right:0; text-align:left">更新内容（v1.8.6） 🎉 🎉 🎉</h2> 
<h2 style="margin-left:0em; margin-right:0em; text-align:start"><img alt="⭐" height="14" src="https://assets.gitee.com/assets/emoji/star-1862a7dd379953410da6c9a141e8d95e.png" width="14" referrerpolicy="no-referrer"> 新特性</h2> 
<ul> 
 <li>新增<span> </span><code>CosIdScanner</code><span> </span>支持扫描包自动注册<span> </span><code>CosIdAccessor</code><span> </span>。</li> 
</ul> 
<div style="text-align:start"> 
 <pre><code>        CosIdAccessorRegistry registry = <strong style="color:#333333">new</strong> DefaultAccessorRegistry(<strong style="color:#333333">new</strong> DefaultAccessorParser(AnnotationDefinitionParser.INSTANCE));
        DefaultCosIdScanner scanner =
            <strong style="color:#333333">new</strong> DefaultCosIdScanner(<strong style="color:#333333">new</strong> String[] &#123;<span style="color:#dd1144">"me.ahoo.cosid.accessor.scanner.entity"</span>&#125;, <strong style="color:#333333">new</strong> NamedDefinitionParser(<span style="color:#dd1144">"id"</span>), registry);
        scanner.scan();</code></pre> 
</div> 
<ul> 
 <li><span>新增 </span><code>CosIdAccessorParser</code><span> </span>interface</li> 
 <li><span>新增 </span><code>CosIdAccessorRegistry</code><span> </span>interface</li> 
 <li>新增<span> </span><code>IntegerIdGenerator</code><span> </span>支持生成<span> </span><code>int</code><span> </span>类型ID</li> 
 <li>增强<span> </span><code>CosIdAccessor</code><span> </span>支持生成<span> </span><code>int</code><span> </span>类型ID</li> 
 <li>增强<span> </span><code>@CosId</code><span> </span>to support Target<span> </span><code>ElementType.TYPE</code>.</li> 
</ul> 
<pre style="text-align:start"><code>    <strong style="color:#333333">public</strong> <strong style="color:#333333">abstract</strong> <strong style="color:#333333">static</strong> <span><strong style="color:#333333">class</strong> <strong style="color:#445588">AbstractId</strong> </span>&#123;
        <strong style="color:#333333">private</strong> <strong style="color:#333333">long</strong> id;

        <span><strong style="color:#333333">public</strong> <strong style="color:#333333">long</strong> <strong style="color:#990000">getId</strong><span>()</span> </span>&#123;
            <strong style="color:#333333">return</strong> id;
        &#125;

        <span><strong style="color:#333333">public</strong> <strong style="color:#333333">void</strong> <strong style="color:#990000">setId</strong><span>(<strong style="color:#333333">long</strong> id)</span> </span>&#123;
            <strong style="color:#333333">this</strong>.id = id;
        &#125;
    &#125;
    <span>@CosId</span>
    <strong style="color:#333333">public</strong> <strong style="color:#333333">static</strong> <span><strong style="color:#333333">class</strong> <strong style="color:#445588">ClassIdInheritedType</strong> <strong style="color:#333333">extends</strong> <strong style="color:#445588">AbstractId</strong> </span>&#123;

    &#125;</code></pre> 
<ul> 
 <li>增强<span> </span><code>CosIdAccessor</code><span> </span>支持自动识别范型基类ID字段类型。</li> 
</ul> 
<pre style="text-align:start"><code><span>    @CosId</span>
    <strong style="color:#333333">public</strong> <strong style="color:#333333">abstract</strong> <strong style="color:#333333">static</strong> <span><strong style="color:#333333">class</strong> <strong style="color:#445588">AbstractGenericCosId</strong><<strong style="color:#445588">T</strong>, <strong style="color:#445588">N</strong>> </span>&#123;
        <strong style="color:#333333">private</strong> T id;
        <strong style="color:#333333">private</strong> N name;

        <span><strong style="color:#333333">public</strong> T <strong style="color:#990000">getId</strong><span>()</span> </span>&#123;
            <strong style="color:#333333">return</strong> id;
        &#125;

        <span><strong style="color:#333333">public</strong> <strong style="color:#333333">void</strong> <strong style="color:#990000">setId</strong><span>(T id)</span> </span>&#123;
            <strong style="color:#333333">this</strong>.id = id;
        &#125;

        <span><strong style="color:#333333">public</strong> N <strong style="color:#990000">getName</strong><span>()</span> </span>&#123;
            <strong style="color:#333333">return</strong> name;
        &#125;

        <span><strong style="color:#333333">public</strong> <strong style="color:#333333">void</strong> <strong style="color:#990000">setName</strong><span>(N name)</span> </span>&#123;
            <strong style="color:#333333">this</strong>.name = name;
        &#125;
    &#125;</code></pre> 
<h2 style="margin-left:0; margin-right:0; text-align:start">⛏️ 重构</h2> 
<ul> 
 <li>重命名<span> </span><code>CosIdDefinition</code><span> </span>为<span> </span><code>IdDefinition</code></li> 
 <li>移除<span> </span><code>@CosId#friendlyId</code></li> 
 <li>重命名<span> </span><code>SnowflakeIntervalShardingAlgorithm</code><span> </span>为<span> </span><code>CosIdSnowflakeIntervalShardingAlgorithm</code></li> 
 <li>移除<span> </span><code>DateIntervalShardingAlgorithm</code>/<span> </span><code>LocalDateTimeIntervalShardingAlgorithm</code><span> </span>/<span> </span><code>SnowflakeFriendlyIntervalShardingAlgorithm</code><span> </span>/<span> </span><code>StringIntervalShardingAlgorithm</code><span> </span>/<span> </span><code>TimestampIntervalShardingAlgorithm</code><span> </span>/<span> </span><code>TimestampOfSecondIntervalShardingAlgorithm</code><span> </span>,<span style="background-color:#ffffff; color:#40485b">使用<span> </span></span><code>CosIdIntervalShardingAlgorithm</code><span style="background-color:#ffffff; color:#40485b">/</span><code>CosIdSnowflakeIntervalShardingAlgorithm</code><span style="background-color:#ffffff; color:#40485b"><span> </span>代替.</span></li> 
 <li>修改默认值<span> </span><code>DEFAULT_BROKEN_THRESHOLD=500</code>/<code>DEFAULT_SPIN_THRESHOLD=1</code></li> 
</ul> 
...
<h2 style="margin-left:0; margin-right:0; text-align:left"><a href="https://gitee.com/link?target=https%3A%2F%2Fcosid.ahoo.me%2Fguide%2Fgetting-started.html">快速开始</a></h2> 
...
<p style="color:#40485b; margin-left:0; margin-right:0; text-align:center"><img alt="雪花算法" src="https://gitee.com/AhooWang/CosId/raw/main/document/docs/.vuepress/public/assets/design/Snowflake-identifier.png" referrerpolicy="no-referrer"></p> 
<blockquote> 
...
<p style="color:#40485b; margin-left:0; margin-right:0; text-align:center"><img alt="RedisMachineIdDistributor" src="https://gitee.com/AhooWang/CosId/raw/main/document/docs/.vuepress/public/assets/design/RedisMachineIdDistributor.png" referrerpolicy="no-referrer"></p> 
...
<p style="color:#40485b; margin-left:0; margin-right:0; text-align:center"><img alt="SegmentId" src="https://gitee.com/AhooWang/CosId/raw/main/document/docs/.vuepress/public/assets/design/SegmentId.png" referrerpolicy="no-referrer"></p> 
...
<p style="color:#40485b; margin-left:0; margin-right:0; text-align:left"><a href="https://gitee.com/link?target=https%3A%2F%2Fcosid.ahoo.me%2Fguide%2Fsegment-chain.html">分布式ID(CosId)之号段链模式性能(1.2亿/s)解析</a></p> 
<p style="color:#40485b; margin-left:0; margin-right:0; text-align:center"><img alt="SegmentChainId" src="https://gitee.com/AhooWang/CosId/raw/main/document/docs/.vuepress/public/assets/design/SegmentChainId.png" referrerpolicy="no-referrer"></p> 
...
<p style="color:#40485b; margin-left:0; margin-right:0; text-align:center"><img alt="CosIdIntervalShardingAlgorithm" src="https://gitee.com/AhooWang/CosId/raw/main/document/docs/.vuepress/public/assets/design/CosIdIntervalShardingAlgorithm.png" referrerpolicy="no-referrer"></p> 
<ul> 
...
<blockquote> 
 <p style="margin-left:0; margin-right:0"><a href="https://gitee.com/link?target=https%3A%2F%2Fzh.wikipedia.org%2Fwiki%2F%25E7%2599%25BE%25E5%2588%2586%25E4%25BD%258D%25E6%2595%25B0">百分位数</a><span> </span>，统计学术语，若将一组数据从小到大排序，并计算相应的累计百分点，则某百分点所对应数据的值，就称为这百分点的百分位数，以Pk表示第k百分位数。百分位数是用来比较个体在群体中的相对地位量数。</p> 
</blockquote> 
<p style="color:#40485b; margin-left:0em; margin-right:0em; text-align:center"><img alt="Percentile-Sample-Of-SegmentChainId" src="https://gitee.com/AhooWang/CosId/raw/main/document/docs/.vuepress/public/assets/perf/Percentile-Sample-Of-SegmentChainId.png" referrerpolicy="no-referrer"></p>
                                        </div>
