...
---
title: 'lamp-cloud 3.5.6 发布，Java SaaS 多租户解决方案'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 14 Dec 2021 09:13:00 GMT
...
<h2 style="margin-left:0; margin-right:0; text-align:justify"><br> build: 3.5.6</h2> 
<ul> 
 <li style="text-align:justify">hutool.version>5.7.17</li> 
 <li style="text-align:justify">aliyun-java-sdk-core.version>4.5.30</li> 
 <li style="text-align:justify">qiniu-java-sdk.version>7.9.0</li> 
</ul> 
<p> </p> 
<h2>fix</h2> 
<p> </p> 
<ul> 
 <li>lamp-cloud: 排除第三方依赖的log4j</li> 
 <li>lamp-boot: 排除第三方依赖的log4j</li> 
 <li>lamp-cloud: 修复 dozer 转换实体报错   （感谢 @一刻 提交的issues）</li> 
 <li>lamp-boot: 修复 dozer 转换实体报错   （感谢 @一刻 提交的issues）</li> 
 <li>lamp-boot:  swagger配置文件默认值错误  （感谢 @一刻 提交的issues）</li> 
 <li>lamp-job: 修复漏提静态文件导致的页面显示不全  （感谢 @一刻 提交的issues）</li> 
</ul> 
<p> </p> 
