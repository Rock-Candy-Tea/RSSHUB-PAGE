...
<ul> 
 ...
 <li>当请求没有连接 header 时，服务器 h2c 升级失败；</li> 
 ...
 <li>JdkZlibDecoder 在 GZIP 页脚碎片化时可能会损坏数据；</li> 
 <li>公开 DnsNameResolver.cnameCache() 可见性；</li> 
 <li>当 SslHandler 不存在时，移除 ApplicationProtocolNegotiationHandler；</li> 
