...
---
title: 'smart-doc 2.3.6 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ol style="list-style-type:decimal; margin-left:0; margin-right:0"> 
 <li> 导出postman时serverUrl不再强制要求设置协议</li> 
 <li> 修改设置responseBodyAdvice后推送torna数据错误。</li> 
 <li> 解决gradle插件不能在kts脚本中添加include和exclude的问题。 <p> </p> </li> 
</ol> 
