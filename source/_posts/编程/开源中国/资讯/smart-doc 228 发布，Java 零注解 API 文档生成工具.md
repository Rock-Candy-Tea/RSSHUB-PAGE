...
---
title: 'smart-doc 2.2.8 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sat, 09 Oct 2021 01:42:00 GMT
...
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 <li> 修复html文档无接口注释时锚点跳转错误的问题。</li> 
 <li>修复导出postman时服务端口配置成变量报错的问题。</li> 
</ul> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"> smart-doc 可以平滑升级。</p> 
