...
<ul> 
 <li>采用 Linux 5.11 稳定版内核</li> 
 <li>采用 GNOME 3.38 作为默认桌面环境</li> 
 <li>Mesa 21.0 提供最新的开源图形驱动</li> 
 <li>采用 GCC 10 作为默认代码编译器</li> 
 <li>启用 LTO 优化</li> 
 <li>支持使用独立 XWayland</li> 
 <li>更好的 Wayland 支持，Ubuntu 默认桌面环境已启用 Wayland</li> 
 <li>升级软件包，如 LibreOffice 7.1</li> 
</ul> 
<p>按照发布计划，Ubuntu 21.04 应该会在4月22日正式发布，而 RC 版本则定于4月15日，内核冻结时间为下周。</p>
                                        </div>
