...
---
title: 'Eurynome Cloud 2.6.7.20 发布，Nacos 版本升级至 2.1.0'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 ...
 <li>其它更新 
  <ul> 
   <li>删除 commons-beanutils 依赖，并重构该依赖涉及的代码，解决由其依赖的 commons-collections 3.X 包引起的安全漏洞。</li> 
   <li>删除 h2 database 依赖，解决由于 Spring Boot 默认依赖版本 h2 driver 引起的安全漏洞问题。</li> 
  </ul> </li> 
 <li>依赖更新 
  <ul> 
   <li>Minio 版本升级至 8.4.0</li> 
   <li>Okhttps 版本升级至 3.5.1</li> 
