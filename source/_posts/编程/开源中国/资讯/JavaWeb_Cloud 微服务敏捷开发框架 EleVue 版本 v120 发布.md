...
---
title: 'JavaWeb_Cloud 微服务敏捷开发框架 EleVue 版本 v1.2.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div>   
<div class="content">
                                                                                            <p>v1.2.0更新内容：<br> 1、新增配合Jenkins多环境发布的功能与POM配置；<br> 2、新增ExcelUtils导出工具类，并在职级管理模块写了导出Excel数据案例；<br> 3、职级管理、岗位管理、登录日志集成导出Excel功能；<br> 4、完善个人中心头像上传功能，完善Base64Utils转换工具类；</p> 
<div> 
 <div> 
  <div> 
   <h2>项目介绍</h2> 
