...
---
title: '一个 WordPress 国产替代版，JPress v4.1.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 23 Jul 2021 01:52:00 GMT
...
<ul> 
 <li>优化：升级 Jboot、Jfinal 等到最新版本</li> 
 <li>修复：文章输入多个标签的时候，存入数据库保存的标签错误的问题</li> 
 <li>修复：文章、商品新建时，若保存两次会导致创建日期被清空的问题</li> 
 <li>修复：页面二次编辑时，状态设置错误的问题</li> 
</ul> 
<p style="text-align:left"> </p> 
...
<div style="text-align:start"> 
 <div style="text-align:left"> 
  <div> 
   <pre><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5">wget</span></span></span></span></span></span></span> https://gitee.com/JPressProjects/jpress/raw/master/install.sh && bash install.sh 8080</pre> 
  </div> 
...
<div style="text-align:left"> 
 <div> 
  <pre><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5"><span style="color:#005cc5">curl</span></span></span></span></span></span></span> -O https://gitee.com/JPressProjects/jpress/raw/master/docker-compose.yml && docker-compose up -d</pre> 
 </div> 
</div> 
