...
---
title: 'Proxy-Go v10.6 发布，Socks5 重构 UDP 支持 FullCone，完美支持 GV 打电话！'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 05 May 2021 12:46:00 GMT
...
<div style="text-align:left"> 
 <ul> 
  <li>socks5代理UDP重构，sps的socks5代理UDP重构，sps的ss代理UDP重构，支持FullCone，完美支持GoogleVoice，链式代理后依然支持FullCone。</li> 
  <li>socks5代理、sps代理的socks5，支持指定固定UDP端口，支持随机一个固定端口，支持握手协议指定端口，支持缓存端口大大提高性能。</li> 
  <li>socks5代理、sps代理的socks5、sps代理的socks5默认关闭udp功能。socks可以通过--udp 开启，sps可以通过--udp --ssudp开启。</li> 
  <li>重构sps的代理直连，sps独立服务时不再依赖内部本地开启的一个上级，性能大幅度提速。</li> 
  <li>sps的ss udp支持单独开启，并指定地址。</li> 
 </ul> 
</div> 
<p style="text-align:left"><strong>特色功能</strong></p> 
<ul> 
