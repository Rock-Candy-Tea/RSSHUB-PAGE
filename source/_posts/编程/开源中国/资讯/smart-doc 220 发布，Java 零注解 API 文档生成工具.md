...
---
title: 'smart-doc 2.2.0 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 21 Jun 2021 09:52:00 GMT
...
<p style="text-align:left">从 2.0.0 版本开始，smart-doc 完全支持生成 debug 调试页面。从2.1.0版本起，smart-doc 的对接了torna企业级的接口文档管理平台。本次发布内容如下:</p> 
<p style="text-align:left"> </p> 
<pre style="text-align:left">1. 修复参数多行注释时，注释提取错误，gitee #I3TYYP.
2. 修复部分代码可能出现的空指针问题。
