...
---
title: 'RXThinkCMF 敏捷开发框架 ThinkPhp6.x+EleVue 版本 v2.0.0 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div class="content">
                                                                                            <div> 
 <div> 
  <p>v2.0.0 更新内容：<br> 1、重构上传图片组件，解决第一次上传图片无法显示的问题；<br> 2、完善网站配置模块，解决上传图片后清除不生效的问题；<br> 3、解决近期用户使用过程中返回的 BUG 以及细节优化；</p> 
  <h2>项目介绍</h2> 
