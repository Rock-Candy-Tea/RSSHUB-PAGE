...
---
title: 'zorm 1.5.9 发布，程序员都是这样过七夕的吗_'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 04 Aug 2022 19:29:00 GMT
 ...
 <li> 
  <div> 
   <div>
    hptx已合并@小口天的pr,
    <span> </span>
    <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2FCECTC%2Fhptx-samples%2Ftree%2Fmain%2Fhttp_proxy_zorm">hptx代理模式zorm使用示例</a>
    <span> </span>和
    <span> </span>
    <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2FCECTC%2Fhptx-samples%2Ftree%2Fmain%2Fhttp_zorm">zorm事务托管hptx示例</a>
   </div> 
  </div> </li> 
 <li> 
  <div> 
