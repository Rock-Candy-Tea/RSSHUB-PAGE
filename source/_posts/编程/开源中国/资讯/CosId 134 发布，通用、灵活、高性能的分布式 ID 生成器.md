...
---
title: 'CosId 1.3.4 发布，通用、灵活、高性能的分布式 ID 生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 30 Jul 2021 08:32:00 GMT
...
<h2 style="text-align:left">更新内容（1.3.4） 🎉 🎉 🎉</h2> 
<ul> 
 <li><span style="background-color:#ffffff; color:#333333">新增：</span>添加默认实用方法<code>IdGenerator.generateAsString</code>。</li> 
 <li>wiki：更新 README，提升可读性。</li> 
</ul> 
