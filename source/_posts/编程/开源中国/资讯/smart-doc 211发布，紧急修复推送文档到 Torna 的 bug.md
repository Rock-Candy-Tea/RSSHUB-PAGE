...
---
title: 'smart-doc 2.1.1发布，紧急修复推送文档到 Torna 的 bug'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Thu, 25 Mar 2021 09:44:00 GMT
...
<p style="text-align:left">从 2.0.0 版本开始，smart-doc 完全支持生成 debug 调试页面。从本次发布的 2.1.1版本起，smart-doc 的对接了企业级的接口文档管理平台。</p> 
<pre><span style="color:#cc7832">1. </span>修复Map嵌套在某些结构体中栈溢出问题，gitee #I3CCLY。
<span style="color:#cc7832">2. </span>修复Torna数据推送问题。</pre> 
...
<p style="text-align:left"> smart-doc 这个版本最大的变更是对接了Torna企业级接口文档管理系统。</p> 
