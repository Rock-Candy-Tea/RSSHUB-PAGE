...
---
title: 'DBShop 商城系统 V3.1 Release 211021 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 22 Oct 2021 10:20:00 GMT
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:start"><strong>更新日志：</strong><br> 新增 发货单导出功能<br> 新增 后台商品列表加入批量上下架功能<br> 新增 插件安装页面，显示珑大会员VIP可免费安装的插件标记<br> 修正 标签商品<br> 修正 后台货到付款订单取消时的错误<br> 优化 未安装fileinfo扩展，后台首页显示对应提示<br> 优化 在线更新、模板安装、插件安装与更新<br> 优化 取消系统对于ZIP扩展的使用<br> 优化 安装前的提示说明<br> 优化 后台商品列表显示积分购买<br> 优化 删除商品时，同时删除会员收藏的该商品<br> 优化 在线更新显示，提供手动下载提醒<br> 优化 后台商品列表加入预览，订单内商品加入前台列表<br> 优化 系统安装可选择是否安装演示数据<br> 优化 后台在线客服加入管理员组权限</p> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:start"><strong>下载地址：<a href="https://www.oschina.net/action/GoToLink?url=%20https://download.loongdom.com.cn/dbshop/V3.1/DBShopV3.1_Release211021.tar.gz" target="_blank"> https://download.loongdom.com.cn/dbshop/V3.1/DBShopV3.1_Release211021.tar.gz</a></strong></p> 
<p> </p>
                                        </div>
