...
---
title: 'Proxy-Go v12.0 发布，新增 SPS_HTTP_SOCKS5 代理每秒连接数限制！'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 02 Aug 2022 14:58:00 GMT
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><strong>更新内容</strong><br> <span style="background-color:#ffffff; color:#24292f">1、新增API认证控制用户/IP维度，每秒可以建立连接的最大数。</span><br> <span style="background-color:#ffffff; color:#24292f">2、调整默认的每秒最大连接数，由默认20改为默认0无限制。</span><br> <span style="background-color:#ffffff; color:#24292f">3、修复了sps模式，-Z -M 不生效的问题。</span></p> 
