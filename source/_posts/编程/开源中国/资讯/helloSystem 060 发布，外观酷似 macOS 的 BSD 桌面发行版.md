...
---
title: 'helloSystem 0.6.0 发布，外观酷似 macOS 的 BSD 桌面发行版'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sun, 03 Oct 2021 00:14:00 GMT
...
<p>helloSystem 昨天发布了最新的 0.6.0 版本，此版本基于 FreeBSD 12.2，主要更新内容如下：</p> 
<ul> 
 <li>改进窗口管理</li> 
 <li>引入新的窗口动画</li> 
 <li>增强文件管理功能</li> 
 <li>从 Openbox 窗口管理器切换到 KDE 的 KWin 窗口管理器</li> 
 <li>其他大量的桌面改进和错误修复</li> 
</ul> 
<p><a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2FhelloSystem%2FISO%2Freleases%2Ftag%2Fr0.6.0" target="_blank">详情查看 release notes</a>。</p>
                                        </div>
