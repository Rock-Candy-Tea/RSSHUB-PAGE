...
---
title: 'BeetlSQL 3.4.0 发布，Stream 查询支持'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sun, 16 May 2021 15:13:00 GMT
...
<div class="content">
                                                        ...
                                                        <p>本次发布对Stream查询进行支持，避免查询大量对象导致内存益处</p> 
<ul> 
 <li>新增StreamData对象和stream查询方法</li> 
 <li>代码生成，对使用LocalDate方式做了调整，支持LocalDateTime</li> 
 <li>删除Spring Boot集成自带代码生成REST API</li> 
</ul> 
<p>StreamData例子</p> 
<pre><code class="language-java">StreamData<User> streamData = dao.queryBySql(99999);
...
<p style="text-align:left"><strong>Maven</strong></p> 
<pre style="text-align:left"><code><span style="color:#333333"><<span style="color:#22863a">dependency</span>></span>
  ...
  <span style="color:#333333"><<span style="color:#22863a">version</span>></span>3.4.0-RELEASE<span style="color:#333333"></<span style="color:#22863a">version</span>></span>
