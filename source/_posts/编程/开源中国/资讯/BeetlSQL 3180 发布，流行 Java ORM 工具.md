...
---
title: 'BeetlSQL 3.18.0 发布，流行 Java ORM 工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<div class="content">
                                                                                            <ul> 
 <li>新增AbsolutePathLoader，允许从绝对路径夹加载 sql文件</li> 
 <li> <p>SQLManager添加customizedSQLLoader，customizedStyle 方便的自己扩展loader和style</p> </li> 
</ul> 
