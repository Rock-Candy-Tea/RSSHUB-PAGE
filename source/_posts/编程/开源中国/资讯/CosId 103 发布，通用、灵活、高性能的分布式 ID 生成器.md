...
---
title: 'CosId 1.0.3 发布，通用、灵活、高性能的分布式 ID 生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 30 Jun 2021 23:28:00 GMT
...
<h2 style="text-align:left">更新内容（1.0.3） 🎉 🎉 🎉</h2> 
<ol> 
 <li>变更：修改 <strong>cosid-redis</strong> 为可选依赖（spring-boot-starter-cosid）。</li> 
 <li>修复：导出 MachineId 实例失败（spring-boot-starter-cosid）。</li> 
 <li>增强：<strong>RedisMachineIdDistributor</strong>/<strong>RedisIdGenerator</strong> 支持 <strong>Redis-Cluster</strong> 模式。</li> 
</ol> 
...
<div style="text-align:left"> 
 <div> 
  <pre>    <strong>val</strong> <strong>cosidVersion</strong> <span style="color:#eeeeee">=</span> <span style="background-color:transparent; color:#00aadd">"1.0.3"</span><span style="color:#eeeeee">;</span>
...
<span style="color:#ffcc55"><project</span> <span style="color:#008080">xmlns=</span><span style="background-color:transparent; color:#00aadd">"http://maven.apache.org/POM/4.0.0"</span>
    ...
    <span style="color:#ffcc55"><properties></span>
        <span style="color:#ffcc55"><cosid.version></span>1.0.3<span style="color:#ffcc55"></cosid.version></span>
    <span style="color:#ffcc55"></properties></span>
