...
---
title: 'sagacity-sqltoy 睿智 ORM 框架 5.0.9 和 4.18.33 版本发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<p style="text-align:left"><span style="background-color:#ffffff; color:#40485b">1、支持impalajdbc，主要针对kudu进行了集成，进一步增强大数据体系下的应用</span><br> <span style="background-color:#ffffff; color:#40485b">2、findEntity的EntityQuery增加了groupBy()和having() 参数设置</span><br> <span style="background-color:#ffffff; color:#40485b">3、优化支持elasticsearch原生sql取top记录的sql组织方式</span><br> <span style="background-color:#ffffff; color:#40485b">4、优化sql文件加载日志提示</span></p> 
