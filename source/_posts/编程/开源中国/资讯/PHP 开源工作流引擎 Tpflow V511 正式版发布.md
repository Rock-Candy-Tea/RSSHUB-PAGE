...
---
title: 'PHP 开源工作流引擎 Tpflow V5.1.1 正式版发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<h2 style="text-align:start">欢迎使用 Tpflow V5.1.1 工作流引擎</h2> 
...
<p style="text-align:left"><span style="color:#525252">本次更新主要对流程事件进行更新，同时新增了工作流结束节点</span></p> 
<p style="text-align:left"><strong><span style="color:#e67e22">坚持这么多年，都在开发工作流，你还不来点个赞吗 </span><a href="https://gitee.com/ntdgg/tpflow">https://gitee.com/ntdgg/tpflow</a><span style="color:#e67e22"><a href="https://gitee.com/ntdgg/tpflow%C2%A0"> </a>支持下我们吧！</span></strong></p> 
<p style="text-align:left"><span style="color:#e74c3c"><strong>持续开源： <span style="background-color:#ffffff">即日起：凡在tpflow开源软件上提交BUG修复，PR（2个以上）、我们将VIP权限双手奉上，参与开源，共同进步！</span></strong></span></p> 
<h3 style="text-align:start"><strong>关于5.1.1 版本更新内容</strong></h3> 
<ul> 
...
<p style="text-align:left"><span style="color:#525252">特别注意：本次升级需手动增加一张数据表：</span></p> 
<pre><code class="language-sql">CREATE TABLE `t_wf_event`  (
...
<p style="text-align:left"><span style="color:#525252">特别注意：本次升级可无缝升级到新版</span></p> 
