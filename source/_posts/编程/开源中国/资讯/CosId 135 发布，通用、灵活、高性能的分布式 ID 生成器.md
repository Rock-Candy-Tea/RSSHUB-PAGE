...
---
title: 'CosId 1.3.5 发布，通用、灵活、高性能的分布式 ID 生成器'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sat, 31 Jul 2021 12:45:00 GMT
...
<h2 style="text-align:left">更新内容（1.3.5） 🎉 🎉 🎉</h2> 
<ul> 
 <li>依赖更新 : <a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2FAhoo-Wang%2FCoSky" target="_blank">CoSky</a> -> 1.2.8。</li> 
 <li>模块名变更: <code>spring-boot-starter-cosid</code> -> <code>cosid-spring-boot-starter</code> (遵守 spring-boot-starter 外部项目命名约定) .感谢 <a href="https://gitee.com/fxbin">@fxbin </a>的PR。</li> 
</ul> 
