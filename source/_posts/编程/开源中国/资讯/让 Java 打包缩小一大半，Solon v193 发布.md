...
---
title: '让 Java 打包缩小一大半，Solon v1.9.3 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Tue, 26 Jul 2022 09:26:00 GMT
...
<ul> 
 <li>解决 solon.web.staticfiles 扩展仓库的文件被读取后不能删除的问题</li> 
 <li>插件 solon.validation 增加分组验证支持</li> 
 <li>插件 aws-s3-solon-plugin 升级 aws-java-sdk-s3 为 1.12.261</li> 
 <li>插件 sqltoy-solon-plugin 升级 sqltoy 为 5.2.3</li> 
 <li>插件 water-solon-plugin 升级 water 为 2.8.1</li> 
</ul> 
