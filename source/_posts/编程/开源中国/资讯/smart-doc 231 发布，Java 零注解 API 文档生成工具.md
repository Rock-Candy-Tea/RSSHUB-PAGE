...
---
title: 'smart-doc 2.3.1 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 <li>修复debug调试不支持请求头设置中文值的bug。</li> 
 <li>修复response自定义tag设置返回未格式化换行问题。</li> 
 <li>修复枚举类型字段指定mock不生效的问题。</li> 
 <li>新增对@SessionAttribute参数做忽略。</li> 
 <li>支持controller实现接口，并使用default方法。 <p> </p> </li> 
</ul> 
