...
---
title: '【派盾：Meter.io跨链桥遭遇黑客攻击，损失约430万美元】2 月 6 日消息，安全机构PeckShield派盾发推文称，Meter.io 跨链桥遭遇黑客攻击，损失约 430 万美元（包...'
categories: 
 - 新媒体
 - 金色财经
 - 快讯
...
Meter.io 官方表示，Meter Passport 具有自动打包和解包 Gas Token（如 ETH 和 BNB）的功能，以方便用户使用。然而，合约并没有阻止封装的 ERC20 Token 与原生 Gas Token 的直接交互，也没有正确转移和验证从调用者地址转移的 WETH 的正确数量。  
</div>
