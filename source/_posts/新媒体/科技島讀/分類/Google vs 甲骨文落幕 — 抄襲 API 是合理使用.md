...
<p>在第 3 要點上，法官認為 Google 抄襲的 API 僅佔總程式碼的 0.4%。而且 Google 不是為了 API 的「創意或美麗」而抄襲，而是為了讓開發者能更快上手，不算實質性的（substsantively）抄襲。這有點類似我製作一個同樣使用 QWERTY 介面的鍵盤，不是因為這樣的排列特別美麗或好用，而是因為大家都習慣了。</p>
