...
---
title: 'Apple will let developers redirect users to sign up for services outside the App Store'
categories: 
 - 新媒体
 - 9To5
 - 9To5 分站
headimg: 'https://i1.wp.com/9to5mac.com/wp-content/uploads/sites/6/2020/12/app-store-hero.jpg?resize=1200%2C628&ssl=1'
author: 9To5
comments: false
date: Thu, 02 Sep 2021 00:07:46 GMT
thumbnail: 'https://i1.wp.com/9to5mac.com/wp-content/uploads/sites/6/2020/12/app-store-hero.jpg?resize=1200%2C628&ssl=1'
---
...
<p>The App Store guidelines will be updated in early 2022, when changes to subscription and in-app purchases rules will take effect. The company will continue to promote its own payment system as the most efficient and secure for developers and users, but it will no longer prevent apps from linking users to “an external website to make purchases.”</p>



<p>It’s worth noting that, at least for now, the changes do not apply to regular in-app purchases or apps. This means that developers will still have to offer their apps and content through the App Store, but now subscriptions can be made using other payment methods.</p>
