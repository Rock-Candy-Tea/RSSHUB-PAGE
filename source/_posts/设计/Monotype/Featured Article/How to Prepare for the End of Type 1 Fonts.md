...
---
title: 'How to Prepare for the End of Type 1 Fonts.'
categories: 
 - 设计
 - Monotype
 - Featured Article
...
<div class="social-sharing-buttons">
    <!-- Facebook share button -->
            <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.monotype.com/resources/expertise/how-prepare-end-type-1-fonts&title=How%20to%20Prepare%20for%20the%20End%20of%20Type%201%20Fonts." target="_blank" title="Share to Facebook" aria-label="Share to Facebook" class="social-sharing-buttons__button" rel="noopener">
    ...
    <!-- Twitter share button -->
            <a href="http://twitter.com/intent/tweet?text=How%20to%20Prepare%20for%20the%20End%20of%20Type%201%20Fonts.+https://www.monotype.com/resources/expertise/how-prepare-end-type-1-fonts" target="_blank" title="Share to Twitter" aria-label="Share to Twitter" class="social-sharing-buttons__button" rel="noopener">
            <svg width="30px" height="30px" style="border-radius:3px;">
    ...
    <!-- Linkedin share button -->
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://www.monotype.com/resources/expertise/how-prepare-end-type-1-fonts" target="_blank" title="Share to Linkedin" aria-label="Share to Linkedin" class="social-sharing-buttons__button" rel="noopener">
            <svg width="30px" height="30px" style="border-radius:3px;">
...
<p>Working on a Mac? Open Spotlight search by pressing <strong>Command + Spacebar,</strong> then type <strong>FontBook</strong> in the search field. Click the <strong>magnifying glass</strong>, select <strong>Kind</strong>, and enter <strong>Type 1</strong> in the search field. That should generate a list of all the PostScript Type 1 fonts on your machine. </p>
