...
<p>从那以后的几个月里，Adobe 对该服务进行了一些更新，并且它也开始在协作用例之外开放它。以前，必须有人从桌面应用程序将文档共享到网络，但现在，任何 Photoshop 订阅者都可以直接从网络登录并开始一个新文档。</p>
<p>Adobe 的目标是让应用程序更易于访问，并可能吸引想要为完整版本付费的用户。该公司在其许多移动应用程序中也采取了类似的做法，包括 Fresco 和 Express。Photoshop 的网络版本是一项特别重要的产品，因为PS是公司最强大的工具之一，并可借助Chromebook被广泛用于学校教学。</p>
