...
---
title: '可立克：公司研发的300KW以上大功率光伏逆变器用升压电感和逆变电感的设计方案和工艺也'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          可立克：公司研发的300KW以上大功率光伏逆变器用升压电感和逆变电感的设计方案和工艺也可以用于储能产品
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=002782" data-stock-code="002782" class="typeTag tagColor1">可立克 <abbr class="lows">-2.3%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，可立克（002782.SZ）8月12日在投资者互动平台表示，您好，公司研发的300KW以上大功率光伏逆变器用升压电感和逆变电感的设计方案和工艺也可以用于储能产品。谢谢关注！</p>
