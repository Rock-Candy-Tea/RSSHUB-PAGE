...
---
title: '国民技术：公司的通用MCU芯片、可信计算芯片产品与华为有合作'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          国民技术：公司的通用MCU芯片、可信计算芯片产品与华为有合作
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300077" data-stock-code="300077" class="typeTag tagColor1">国民技术 <abbr class="highs">+0.8%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p class="hdy-question">每经AI快讯，有投资者在投资者互动平台提问：目前公司与华为合作在哪些领域？有共同研发的产品吗？详细介绍一下......</p>
<p class="hdy-answer">国民技术（300077.SZ）10月29日在投资者互动平台表示，公司的通用MCU芯片、可信计算芯片产品与华为有合作。相关合作产品均为公司自主研发，没有共同研发的产品。</p>
