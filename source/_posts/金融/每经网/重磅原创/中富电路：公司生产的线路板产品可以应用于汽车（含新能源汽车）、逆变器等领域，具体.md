...
---
title: '中富电路：公司生产的线路板产品可以应用于汽车（含新能源汽车）、逆变器等领域，具体'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          中富电路：公司生产的线路板产品可以应用于汽车（含新能源汽车）、逆变器等领域，具体应用场景根据下游客户的需求确定
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300814" data-stock-code="300814" class="typeTag tagColor1">C中富 <abbr class="highs">+1.9%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，中富电路（300814.SZ）8月17日在投资者互动平台表示，公司生产的线路板产品可以应用于汽车（含新能源汽车）、逆变器等领域，具体应用场景根据下游客户的需求确定。</p>
