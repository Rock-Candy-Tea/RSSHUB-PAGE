...
---
title: '电科院：公司是独立第三方检测机构，可提供光伏逆变器、储能逆变器、储能控制器、储能'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          电科院：公司是独立第三方检测机构，可提供光伏逆变器、储能逆变器、储能控制器、储能电池等产品的检测服务
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300215" data-stock-code="300215" class="typeTag tagColor1">电科院 <abbr class="highs">+2.2%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，有投资者在投资者互动平台提问：董秘您好，能说说你们家的光伏逆变器在储能方面的应用？</p>
<p>电科院（300215.SZ）8月3日在投资者互动平台表示，您好！公司是独立第三方检测机构，可提供光伏逆变器、储能逆变器、储能控制器、储能电池等产品的检测服务。谢谢关注！</p>
