...
---
title: '万顺新材：目前电池铝箔主要应用于电池软包、电池正极，可应用于钠离子电池正负极，具'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          万顺新材：目前电池铝箔主要应用于电池软包、电池正极，可应用于钠离子电池正负极，具体的应用视下游客户需求而定
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300057" data-stock-code="300057" class="typeTag tagColor1">万顺新材 <abbr class="highs">+0.1%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，万顺新材（300057.SZ）8月19日在投资者互动平台表示，目前电池铝箔主要应用于电池软包、电池正极，可应用于钠离子电池正负极，具体的应用视下游客户需求而定。</p>
