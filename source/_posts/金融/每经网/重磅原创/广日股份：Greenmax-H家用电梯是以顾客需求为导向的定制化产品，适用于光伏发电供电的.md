...
---
title: '广日股份：Greenmax-H家用电梯是以顾客需求为导向的定制化产品，适用于光伏发电供电的'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          广日股份：Greenmax-H家用电梯是以顾客需求为导向的定制化产品，适用于光伏发电供电的场景
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=600894" data-stock-code="600894" class="typeTag tagColor1">广日股份 <abbr class="highs">+0.4%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，广日股份（600894.SH）7月12日在投资者互动平台表示，Greenmax-H家用电梯是以顾客需求为导向的定制化产品，适用于光伏发电供电的场景。</p>
