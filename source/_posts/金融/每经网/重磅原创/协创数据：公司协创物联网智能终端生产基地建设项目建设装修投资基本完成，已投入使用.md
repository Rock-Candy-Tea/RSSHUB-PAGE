...
---
title: '协创数据：公司协创物联网智能终端生产基地建设项目建设装修投资基本完成，已投入使用'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          协创数据：公司协创物联网智能终端生产基地建设项目建设装修投资基本完成，已投入使用，处于竣工决算阶段
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300857" data-stock-code="300857" class="typeTag tagColor1">协创数据 <abbr class="highs">+0.2%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p class="hdy-question">每经AI快讯，有投资者在投资者互动平台提问：您好！公司首发募投项目按比例进展到什么程度了？谢谢！</p>
<p class="hdy-answer">协创数据（300857.SZ）9月23日在投资者互动平台表示，公司协创物联网智能终端生产基地建设项目建设装修投资基本完成，已投入使用，处于竣工决算阶段；协创物联网研发中心建设项目目前正在按计划建设中。</p>
