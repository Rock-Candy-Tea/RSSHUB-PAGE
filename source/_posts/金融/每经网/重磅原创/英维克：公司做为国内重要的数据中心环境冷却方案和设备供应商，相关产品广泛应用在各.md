...
---
title: '英维克：公司做为国内重要的数据中心环境冷却方案和设备供应商，相关产品广泛应用在各'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          英维克：公司做为国内重要的数据中心环境冷却方案和设备供应商，相关产品广泛应用在各类数据中心
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=002837" data-stock-code="002837" class="typeTag tagColor1">英维克 <abbr class="lows">-1.3%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，英维克（002837.SZ）9月3日在投资者互动平台表示，公司做为国内重要的数据中心环境冷却方案和设备供应商，相关产品广泛应用在各类数据中心。</p>
