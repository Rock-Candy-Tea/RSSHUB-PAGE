...
---
title: '连城数控增著作权：连城数控硅方数控磨床控制系统软件'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          新三板精选层公司连城数控新增软件著作权信息：“连城数控硅方数控磨床控制系统软件”
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p><span style="font-weight: bold;">每经讯，</span>据启信宝，新三板精选层公司连城数控（835368）新增著作权信息，登记批准日期为2021年10月27日，该作品名称为“连城数控硅方数控磨床控制系统软件”，作品类别为软件著作权证书，登记号为2021SR1575677。</p>
