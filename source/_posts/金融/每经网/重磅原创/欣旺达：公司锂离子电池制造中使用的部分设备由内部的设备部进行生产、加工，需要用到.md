...
---
title: '欣旺达：公司锂离子电池制造中使用的部分设备由内部的设备部进行生产、加工，需要用到'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          欣旺达：公司锂离子电池制造中使用的部分设备由内部的设备部进行生产、加工，需要用到工业自动化零部件
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，欣旺达（300207.SZ）8月14日在投资者互动平台表示，公司锂离子电池制造中使用的部分设备由内部的设备部进行生产、加工，需要用到工业自动化零部件。</p>
