...
---
title: '拉卡拉：公司手机POS产品功能完全兼容鸿蒙系统，可以正常使用'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          拉卡拉：公司手机POS产品功能完全兼容鸿蒙系统，可以正常使用
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300773" data-stock-code="300773" class="typeTag tagColor1">拉卡拉 <abbr class="highs">+1.5%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，有投资者在投资者互动平台提问：请问贵公司的手机pos是否已经完成对华为鸿蒙系统的升级，可以正常使用了吗？</p>
<p>拉卡拉（300773.SZ）6月18日在投资者互动平台表示，您好，公司手机POS产品功能完全兼容鸿蒙系统，可以正常使用，谢谢！</p>
