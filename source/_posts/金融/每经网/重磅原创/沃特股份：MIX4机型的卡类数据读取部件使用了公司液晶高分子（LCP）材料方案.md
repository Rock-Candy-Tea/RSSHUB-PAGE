...
---
title: '沃特股份：MIX4机型的卡类数据读取部件使用了公司液晶高分子（LCP）材料方案'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          沃特股份：MIX4机型的卡类数据读取部件使用了公司液晶高分子（LCP）材料方案
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，沃特股份（002886.SZ）8月16日在投资者互动平台表示，MIX4机型的卡类数据读取部件使用了公司液晶高分子（LCP）材料方案。</p>
