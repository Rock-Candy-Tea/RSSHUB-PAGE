...
---
title: '东北证券给予赛微电子买入评级：MEMS业务实现量产，加速布局GaN产业链'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          东北证券给予赛微电子买入评级：MEMS业务实现量产，加速布局GaN产业链
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300456" data-stock-code="300456" class="typeTag tagColor1">赛微电子 <abbr class="highs">+1.0%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p class="announce-summary" style="line-height: 1.6; margin-bottom: 15px;"><span style="white-space: pre-wrap;"><span style="font-weight: bold;">每经AI快讯，</span>东北证券06月12日发布研报称，给予赛微电子（300456.SZ）买入评级。评级理由主要包括：1）并购整合MEMS业务，资本投入扩张产能向量产工厂转型；2）加速布局GaN产业链，市场空间巨大；3）优化产业结构，盈利能力高于行业平均水平。风险提示：产能爬坡不及预期、资产折旧、产品验证周期较长。</span></p>
<p style="line-height: 1.6; margin-bottom: 15px;">AI点评：赛微电子近一个月获得1份券商研报关注，买入1家，平均目标价为35元。</p>
