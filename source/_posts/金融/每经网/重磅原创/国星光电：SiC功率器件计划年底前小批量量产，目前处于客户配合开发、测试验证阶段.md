...
---
title: '国星光电：SiC功率器件计划年底前小批量量产，目前处于客户配合开发、测试验证阶段'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          国星光电：SiC功率器件计划年底前小批量量产，目前处于客户配合开发、测试验证阶段
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=002449" data-stock-code="002449" class="typeTag tagColor1">国星光电 <abbr class="highs">+1.9%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，有投资者在投资者互动平台提问：国星光电SiC功率器件小而轻便，反向恢复快、抗浪涌能力强、雪崩耐压高，拥有优越的性能与极高的工作效率。目前SiC功率器件开始生产了嘛？</p>
<p>国星光电（002449.SZ）6月21日在投资者互动平台表示，您好，计划年底前小批量量产，目前处于客户配合开发、测试验证阶段。谢谢！</p>
