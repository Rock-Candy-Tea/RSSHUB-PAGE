...
---
title: '达瑞电子：公司供货的有T客户的家用储能设备和S客户（SUNGROW）的储能设备'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          达瑞电子：公司供货的有T客户的家用储能设备和S客户（SUNGROW）的储能设备
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300976" data-stock-code="300976" class="typeTag tagColor1">达瑞电子 <abbr class="lows">-0.2%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，达瑞电子（300976.SZ）7月20日在投资者互动平台表示，公司供货的有T客户的家用储能设备和S客户（SUNGROW）的储能设备。</p>
