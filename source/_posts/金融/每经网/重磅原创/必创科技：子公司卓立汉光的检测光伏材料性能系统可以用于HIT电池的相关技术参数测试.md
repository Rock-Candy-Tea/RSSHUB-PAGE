...
---
title: '必创科技：子公司卓立汉光的检测光伏材料性能系统可以用于HIT电池的相关技术参数测试'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          必创科技：子公司卓立汉光的检测光伏材料性能系统可以用于HIT电池的相关技术参数测试
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=300667" data-stock-code="300667" class="typeTag tagColor1">必创科技 <abbr class="highs">+5.8%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，必创科技（300667.SZ）8月23日在投资者互动平台表示，子公司卓立汉光的检测光伏材料性能系统可以用于HIT电池的相关技术参数测试。</p>
