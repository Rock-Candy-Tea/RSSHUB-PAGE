...
---
title: '拓日新能：目前薄膜电池主要用于应用消费类产品的订单，产能基本满足公司的订单需求'
categories: 
 - 金融
 - 每经网
 - 重磅原创
...
<div class="g-article-top">
        <h1>
          ...
          拓日新能：目前薄膜电池主要用于应用消费类产品的订单，产能基本满足公司的订单需求
        </h1>
        <!--发布 时间-->
        <p class="u-time">
          <span class="source">
        ...
        <div class="typeTags">
              ...
              <a href="http://www.nbd.com.cn/articles/index_for_stock_tag?tag_type=stock&tag_value=002218" data-stock-code="002218" class="typeTag tagColor1">拓日新能 <abbr class="lows">-2.2%</abbr> </a>
      ...
      <div class="g-articl-text">
        ...
        <!-- 正文 -->
        <p>每经AI快讯，拓日新能（002218.SZ）7月8日在投资者互动平台表示，目前薄膜电池主要用于应用消费类产品的订单，产能基本满足公司的订单需求，</p>
